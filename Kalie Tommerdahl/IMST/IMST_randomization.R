...
temp <- blockrand(n=nrow(male_hypertension), levels = c(0:1), block.sizes = 1)
...
temp <- blockrand(n=nrow(male_no_hypertension), levels = c(0:1), block.sizes = 1)
...
temp <- blockrand(n=nrow(female_hypertension), levels = c(0:1), block.sizes = 1)
...
temp <- blockrand(n=nrow(female_no_hypertension), levels = c(0:1), block.sizes = 1)
...
temp <- blockrand(n=nrow(other_hypertension), levels = c(0:1), block.sizes = 1)
...
temp <- blockrand(n=nrow(other_no_hypertension), levels = c(0:1), block.sizes = 1)

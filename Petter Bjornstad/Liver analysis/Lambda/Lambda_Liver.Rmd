...
bucket <- "harmonized.dataset" # bucket name in Kopah
temp_file <- tempfile(fileext = ".rds") # need to create a temporary file
s3$download_file(bucket, "analyte_info.rds", temp_file)
...
bucket <- "harmonized.dataset" # bucket name in Kopah
temp_file <- tempfile(fileext = ".rds") # need to create a temporary file
s3$download_file(bucket, "df.rds", temp_file)
...
#Gene Proteins
genes <- rownames(so_liver_sn)
gene_proteins <- key$AptName[which(key$EntrezGeneSymbol %in% genes)] #7112 proteins
length(gene_proteins) #7112
...
write.csv(alt_results,"/home/hhampson/Results/TeenLABS_ALT_Adj_Results_Proteomics_FDR_01.csv")
...
ast_results <- ast_results %>%
  dplyr::rename(Gene=EntrezGeneSymbol)
# write.csv(ast_results,"/home/hhampson/Results/TeenLABS_AST_Adj_Results_Proteomics_FDR_01.csv")
...
# volcano_plot_ast
png("/home/hhampson/Results/AST_Proteins_TeenLabs_Adjusted_FDR_01.png", width = 2200, height = 2000,res=300)
print(volcano_plot)
dev.off()

...
#Filter to celltype 
LR_celltypes <- unique(so_liver_sn$celltype_LR)[1]
clinical_variables <- c("alt","ast","ggt","bmi","a1c","hepatocyte_ballooning_score","lobular_inflammation_grade","steatosis_grade","fibrosis_stage","fibrosis_cat","steatosis_grade")
#Filter to celltype 
...
cell_name <- LR_celltypes
  ...
  for (var in clinical_variables[10:11]) {
  # var <- clinical_variables[4]

...
sig_carb <- total_results %>% 
  mutate(sig = ifelse(fdr<0.05,"*","")) %>% 
  filter(sig=="*")

sig_carb <- sig_carb %>% 
  mutate(Parameter = case_when(variable=="carbp_m" ~ "State 2 PM",
                               variable=="carb_adp" ~ "State 3 PM",
                               variable=="carb_s" ~ "State 3 PMGS",
                               variable=="carb_omy" ~ "State 4 PMGS",
                               variable=="carbfccp" ~ "ETS PMGS"))
...
# Respiratory States & Substrates	TCA Cycle Genes	LogFC	FDR	Subtype	Cell Type	Direction of #Association
sig_carb <- sig_carb %>% 
  dplyr::select(c("Parameter","Gene","logFC","fdr","Celltype")) %>% 
  dplyr::rename(LogFC=logFC) %>% 
  dplyr::rename(FDR=fdr) %>% 
  mutate(Direction=ifelse(LogFC>0,"(+)","(-)")) %>% 
  mutate(Parameter = factor(Parameter, levels = c("State 2 PM", 
                                                  "State 3 PM", 
                                                  "State 3 PMGS", 
                                                  "State 4 PMGS", 
                                                  "ETS PMGS"))) %>% 
...
write.csv(sig_carb,"/home/hhampson/Results/Carb_Oro_Hepatocytes_DEGs_Sig_TCA.csv")

lipid_vars <- oro_vars[c(16,17,20:22)]
total_results <- data.frame()
# for (cell_name2 in HR_celltypes){
...
sig_lipid <- total_results %>% 
  mutate(sig = ifelse(fdr<0.05,"*","")) %>% 
  filter(sig=="*")

sig_lipid <- sig_lipid %>% 
  mutate(Parameter = case_when(variable=="lipidpc_m" ~ "State 2 FAM",
                               variable=="lipid_adp" ~ "State 3 FAM",
                               variable=="lipid_s" ~ "State 3 FAMGS",
                               variable=="lipid_omy" ~ "State 4 FAMGS",
                               variable=="lipidfccp" ~ "ETS FAMGS")) %>% 
  ...
  mutate(Direction=ifelse(LogFC>0,"(+)","(-)")) %>% 
  arrange(Parameter)
write.csv(sig_lipid,"/home/hhampson/Results/Lipid_Oro_Hepatocytes_DEGs_Sig_TCA.csv")
# # }
# # "carbp_m"             "carb_adp"            "carb_g"              "carb_cytoc"          "carb_s"              "carb_omy"
...
# Respiratory States & Substrates	ox_phos Cycle Genes	LogFC	FDR	Subtype	Cell Type	Direction of #Association
sig_carb <- sig_carb %>% 
  dplyr::select(c("Parameter","Gene","logFC","fdr","Celltype")) %>% 
  dplyr::rename(LogFC=logFC) %>% 
  dplyr::rename(FDR=fdr) %>% 
...
write.csv(sig_carb,"/home/hhampson/Results/Carb_Oro_Hepatocytes_DEGs_Sig_OX_PHOS.csv")
...
sig_lipid <- sig_lipid %>% 
  ...
  mutate(Direction=ifelse(LogFC>0,"(+)","(-)")) %>% 
  arrange(Parameter)
write.csv(sig_lipid,"/home/hhampson/Results/Lipid_Oro_Hepatocytes_DEGs_Sig_OX_PHOS.csv")
...
# HR_celltypes <- unique(so_Hep$celltype)
HR_celltypes <- unique(so_Hep$celltype)
...
for (cell_name in HR_celltypes){
  for (oro in oro_vars) {
    ...
    so_celltype <- subset(so_Hep,celltype==cell_name)
    DefaultAssay(so_celltype) <- "RNA" 
    StartGenes <- nrow(so_celltype) #28964 genes
    Nuclei <- ncol(so_celltype) #    Nuclei nuclei
    ...
    cell_name2 <- str_replace_all(cell_name,"/","_")
    cell_name2 <- str_replace_all(cell_name2,"-","_")
    write.csv(full_results,paste0("/home/hhampson/Results/NEBULA_",oro,"_",cell_name2,"_tca.csv"))
  }
}
...
# HR_celltypes <- str_replace_all(unique(so_liver_sn$celltype),"/","_")
# HR_celltypes <- str_replace_all(HR_celltypes,"-","_")
HR_celltypes <- str_replace_all(unique(so_Hep$celltype),"/","_")
HR_celltypes <- str_replace_all(HR_celltypes,"-","_")
# cell_name2 <- "B_Plasma"
# cell_name2
...
for (cell_name2 in HR_celltypes){
  for (oro in carb_vars) {
    full_results <- read.csv(paste0("/home/hhampson/Results/NEBULA_",oro,"_",cell_name2,"_tca.csv"))
    full_results <- full_results %>% 
      clean_names() %>% 
      dplyr::rename(logFC=log_fc) %>% 
      dplyr::rename(Gene=gene)
...
write.csv(sig_carb,"/home/hhampson/Results/Carb_Oro_Hep_DEGs_Sig_TCA.csv")
...
sig_lipid <- sig_lipid %>% 
  ...
  mutate(Direction=ifelse(LogFC>0,"(+)","(-)")) %>% 
  arrange(Parameter)
write.csv(sig_lipid,"/home/hhampson/Results/Lipid_Oro_Hep_DEGs_Sig_TCA.csv")
...
for (cell_name in HR_celltypes){
  for (oro in oro_vars) {
    ...
    cell_name2 <- str_replace_all(cell_name,"/","_")
    cell_name2 <- str_replace_all(cell_name2,"-","_")
    write.csv(full_results,paste0("/home/hhampson/Results/NEBULA_",oro,"_",cell_name2,"_ox_phos.csv"))
  }
}
...
for (cell_name2 in HR_celltypes){
  for (oro in carb_vars) {
    full_results <- read.csv(paste0("/home/hhampson/Results/NEBULA_",oro,"_",cell_name2,"_ox_phos.csv"))
    full_results <- full_results %>% 
      clean_names() %>% 
      dplyr::rename(logFC=log_fc) %>% 
      dplyr::rename(Gene=gene)
...
write.csv(sig_carb,"/home/hhampson/Results/Carb_Oro_Hep_DEGs_Sig_OX_PHOS.csv")
...
sig_lipid <- sig_lipid %>% 
  ...
  mutate(Direction=ifelse(LogFC>0,"(+)","(-)")) %>% 
  arrange(Parameter)
write.csv(sig_lipid,"/home/hhampson/Results/Lipid_Oro_Hep_DEGs_Sig_OX_PHOS.csv")

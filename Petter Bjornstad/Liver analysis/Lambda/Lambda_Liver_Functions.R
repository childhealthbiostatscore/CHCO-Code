...
bg_path <- c("/Users/hhampson/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Biostatistics Core Shared Drive/GSEA")
list.files(bg_path)
...
#   cellchat <- aggregateNet(cellchat)
# 
#   saveRDS(cellchat, file = paste0("/home/hhampson/Results/cellchat_", group_name, ".rds"))
#   return(cellchat)
# }
# 

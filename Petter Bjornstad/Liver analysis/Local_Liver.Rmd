...
png(fs::path(dir.results,"Carb_Oroboros_Boxplots_Substrates.png"), 
    width = 3000, 
    height = 2000, 
    res = 300)
print(g)
...
# Save using png() device
png(fs::path(dir.results,"Lipid_Oroboros_Boxplots_Substrates.png"), 
    width = 3000, 
    height = 2000, 
    res = 300)
print(g)

...
#Number of participants
length(unique(harm_meta_data$record_id)) #60 CRC people, 211 including RH and RH2
...
#                    .by = c(mrn, visit)) %>%
  arrange(mrn)
length(unique(pet_dat$record_id)) #178
length(unique(pet_dat$mrn)) #178
...
#                   "p2_ffa_suppression","p2_gc_leanm","p2_gc_m","p2_raw_leanm","p2_raw_m",
#                   "p2_steady_state_ffa")
insulin_vars <- c("homa_ir","gir_190","gir_200")
# pet_dat4 <- pet_dat3 %>%
...
# Save combined box plots
png(fs::path(dir.results, "Boxplots_Liver_Pet_by_Group_with_Stats.png"), 
...
png(fs::path(dir.results, "Heatmap_Pearson_Faceted_by_Group.png"), 
    width = 4000, height = 3000, res = 300)

...
# meta_gene_hvg <- so_celltype_hvg@meta.data
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hepatocytes_Steatosis_unadjusted_2000_offset_new.csv"))
full_results <- read.csv(fs::path(dir.results,"NEBULA_Hepatocytes_Steatosis_unadjusted_2000_offset_new.csv")) %>%
...
# print(volcano_plot)
# dev.off()
png(fs::path(dir.results, "Plot_NEBULA_Hepatocytes_Steatosis_unadjusted_2000_offset_new.ong"),
...
volcano_plot <- ggplot(full_results, aes(x = `logFC_steatosis_catHigh Steatosis (2+3)`, y = PValue10, color = color)) +
  ...
  # With this:C
  # geom_label(data = significant_df, aes(label = gene),
  #            vjust = 1, hjust = 1, size = 3, color = "black",fontface="bold", fill = "white", alpha = 0.8, label.size = 0.2)
   # Use geom_label_repel instead of geom_label to avoid overlaps
 # # Repelling labels without connector lines
 #  geom_label_repel(
 #    data = significant_df,
 #    aes(label = gene),
 #    size = 3,
 ...
 #  )
volcano_plot
png(fs::path(dir.results, "Plot_NEBULA_Hepatocytes_Steatosis_unadjusted_2000_poster_figure.png"),
...
volcano_plot <- ggplot(full_results, aes(x = `logFC_steatosis_catHigh Steatosis (2+3)`, y = PValue10, color = color)) +
  ...
  labs(
    title = "High Steatosis (2+3) vs. Low Steatosis (0+1)",
    subtitle = "Hepatocytes, Adjusted for HbA1c (REML,Log Normal,Offset)",
    x = "FC",
    y = "-log10(P-Value)",
    color = "FC Direction Direction",
    caption = paste0("FDR < 0.05, Genes = ",Genes,", Nuclei = ",Nuclei,", Non-Convergence Rate: ",Nonconvergence_Rate,", Genes Filtered out for Low Expression: ",low_exp)
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hep_1_Steatosis_unadjusted_2000_offset_new.csv"))
...
# print(volcano_plot)
# dev.off()
png(fs::path(dir.results, "Plot_NEBULA_Hep_1_Steatosis_unadjusted_2000_offset_new.ong"),
    width = 3000, height = 2100, res = 300)
print(volcano_plot)
dev.off()
```
...
```{r echo = F}
#Hep-1
full_results <- read.csv(fs::path(dir.results,"NEBULA_Hep_1_Steatosis_unadjusted_2000_offset_new.csv")) %>%
  clean_names() %>% 
  dplyr::select(-x) %>% 
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hep_2_Steatosis_unadjusted_2000_offset_new.csv"))
...
# print(volcano_plot)
# dev.off()
png(fs::path(dir.results, "Plot_NEBULA_Hep_2_Steatosis_unadjusted_2000_offset_new.ong"),
    width = 3000, height = 2100, res = 300)
print(volcano_plot)
dev.off()
```
...
### iii. GSEA
```{r echo = F}
full_results <- read.csv(fs::path(dir.results,"NEBULA_Hep_2_Steatosis_unadjusted_2000_offset_new.csv")) %>%
  clean_names() %>% 
  dplyr::select(-x) %>% 
  dplyr::rename(Gene=gene,LogFC=log_fc_steatosis_cat_high_steatosis_2_3)
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hep_3_Steatosis_unadjusted_2000_offset_new.csv"))
...
# print(volcano_plot)
# dev.off()
png(fs::path(dir.results, "Plot_NEBULA_Hep_3_Steatosis_unadjusted_2000_offset_new.ong"),
    width = 3000, height = 2100, res = 300)
print(volcano_plot)
dev.off()
```
...
### iii. GSEA
```{r echo = F}
full_results <- read.csv(fs::path(dir.results,"NEBULA_Hep_3_Steatosis_unadjusted_2000_offset_new.csv")) %>%
  clean_names() %>% 
  dplyr::select(-x) %>% 
  dplyr::rename(Gene=gene,LogFC=log_fc_steatosis_cat_high_steatosis_2_3)
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hep_4_Steatosis_unadjusted_2000_offset_new.csv"))
...
# print(volcano_plot)
# dev.off()
png(fs::path(dir.results, "Plot_NEBULA_Hep_4_Steatosis_unadjusted_2000_offset_new.ong"),
    width = 3000, height = 2100, res = 300)
print(volcano_plot)
dev.off()
```
...
### iii. GSEA
```{r echo = F}
full_results <- read.csv(fs::path(dir.results,"NEBULA_Hep_4_Steatosis_unadjusted_2000_offset_new.csv")) %>%
  clean_names() %>% 
  dplyr::select(-x) %>% 
  dplyr::rename(Gene=gene,LogFC=log_fc_steatosis_cat_high_steatosis_2_3)
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hep_5_Steatosis_unadjusted_2000_offset_new.csv"))
...
# print(volcano_plot)
# dev.off()
png(fs::path(dir.results, "Plot_NEBULA_Hep_5_Steatosis_unadjusted_2000_without_outlier.png"),
    width = 3000, height = 2100, res = 300)
print(volcano_plot)
dev.off()
```
...
### iii. GSEA
```{r echo = F}
full_results <- read.csv(fs::path(dir.results,"NEBULA_Hep_5_Steatosis_unadjusted_2000_offset_new.csv")) %>%
  clean_names() %>% 
  dplyr::select(-x) %>% 
  dplyr::rename(Gene=gene,LogFC=log_fc_steatosis_cat_high_steatosis_2_3)
...
write.csv(full_results,fs::path(dir.results,"NEBULA_dHep_Steatosis_unadjusted_2000_offset_new.csv"))
# full_results <- read.csv(fs::path(dir.results,"NEBULA_dHep_Steatosis_unadjusted_2000_offset_new.csv")) %>% 
#   dplyr::rename(`logFC_steatosis_catHigh Steatosis (2+3)`=logFC_steatosis_catHigh.Steatosis..2.3.)
...
# print(volcano_plot)
# dev.off()
png(fs::path(dir.results, "Plot_NEBULA_dHep_Steatosis_unadjusted_2000_without_outlier.png"),
    width = 3000, height = 2100, res = 300)
print(volcano_plot)
dev.off()
...
volcano_plot <- ggplot(full_results, aes(x = `logFC_steatosis_catHigh Steatosis (2+3)`, y = PValue10, color = color)) +
  ...
  labs(
    title = "Differentially Expressed Genes in High Steatosis vs. Low Steatosis",
    subtitle = "Degenerative Hepatocytes",
    x = "LogFC",
    y = "-log10(P-Value)",
    color = "LogFC Direction Direction",
    caption = paste0("FDR < 0.05, Genes = ",Genes,", Nuclei = ",Nuclei,", Non-Convergence Rate: ",Nonconvergence_Rate,", Genes Filtered out for Low Expression: ",low_exp)
 ...
 #  )
volcano_plot
png(fs::path(dir.results, "Plot_NEBULA_dHep_Steatosis_unadjusted_2000_poster_figure.png"),
    width = 1500, height = 1500, res = 300)
print(volcano_plot)
dev.off()
```

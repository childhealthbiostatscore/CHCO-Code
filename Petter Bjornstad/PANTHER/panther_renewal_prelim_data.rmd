...
```{r}
sim_power_int <- function(n = 90, intercept = 135, beta_time = -2, beta_Z = 1, beta_pred_time_int = 1, var_int = 2, resid_sd = 1) {
  # time, MRN, and variable being tested from PANTHER (Z)
  years <- 1:5
  set.seed(123)  # for reproducibility
  mrn <- replicate(n, paste0(sample(c(letters, LETTERS, 0:9), 8, replace = TRUE), collapse = ""))
...
sim_power_int(n = 90, intercept = 135, beta_time = -2, beta_pred_time_int = 0.5, var_int = 2, resid_sd = 5)
ps
```
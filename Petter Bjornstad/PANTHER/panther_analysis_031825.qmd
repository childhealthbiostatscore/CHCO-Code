...
bmi_percentile = ext_bmiz(data = subset(dat, 
  ...
  filter(!is.na(bmip))
dat <- dat %>%
  # left_join(dat, bmi_percentile, by = "record_id") %>%
...
# subset(panther, group == "Lean Control" & group_risk == "High")$hba1c
# subset(panther, group == "Lean Control" & group_risk == "High")$bmip
# subset(panther, group == "Lean Control" & group_risk == "High")$record_id
# subset(panther, group == "Lean Control" & group_risk == "High")$weight
# subset(panther, group == "Lean Control" & group_risk == "High")$height
```

```{r save-data, include = F}
# save(analytes,
#      file = file.path(root_path, "PANTHER/Data_Cleaned/panther_analytes_050925.RData"))
# save(dict,
#         file = file.path(root_path, "PANTHER/Data_Cleaned/panther_dict_050925.RData"))
# save(dat,
#         file = file.path(root_path, "PANTHER/Data_Cleaned/panther+rh+rh2+imp_data_050925.RData"))
# save(panther,
#         file = file.path(root_path, "PANTHER/Data_Cleaned/panther_data_050925.RData"))
# save(sens_dat,
#         file = file.path(root_path, "PANTHER/Data_Cleaned/panther_rh_rh2_imp_data_050925.RData"))
# save(cleanData_comb,
#         file = file.path(root_path, "PANTHER/Data_Cleaned/panther+rh+rh2+imp_data_soma_std_050925.RData"))
# save(cleanData_panther,
#         file = file.path(root_path, "PANTHER/Data_Cleaned/panther_data_soma_std_050925.RData"))
# save(cleanData_sens,
#         file = file.path(root_path, "PANTHER/Data_Cleaned/panther_data_rh_rh2_imp_std_050925.RData"))
```


```{r, include = F}
# load(file = file.path(root_path, "PANTHER/Data_Cleaned/panther_analytes_050925.RData"))
# load(file = file.path(root_path, "PANTHER/Data_Cleaned/panther_dict_050925.RData"))
# load(file = file.path(root_path, "PANTHER/Data_Cleaned/panther+rh+rh2+imp_data_050925.RData"))
# load(file = file.path(root_path, "PANTHER/Data_Cleaned/panther_data_050925.RData"))
# load(file = file.path(root_path, "PANTHER/Data_Cleaned/panther_rh_rh2_imp_data_050925.RData"))
# load(file = file.path(root_path, "PANTHER/Data_Cleaned/panther+rh+rh2+imp_data_soma_std_050925.RData"))
# load(file = file.path(root_path, "PANTHER/Data_Cleaned/panther_data_soma_std_050925.RData"))
# load(file = file.path(root_path, "PANTHER/Data_Cleaned/panther_data_rh_rh2_imp_std_050925.RData"))
```
...
panther_uacr <- (subset(panther, select = c(record_id, group_2, u24_mab, acr_u, creatinine_u, microalbumin_u))) %>%
  arrange(desc(u24_mab))
# write.csv(panther_uacr, file.path(root_path, "PANTHER/Data_Cleaned/panther_uacr.csv", row.names = F))
...
# write.csv(panther_uacr_wide, file.path(root_path, "PANTHER/Data_Cleaned/panther_uacr_allvisits.csv", row.names = F, na = ""))
...
kable(summary(tableby(group_risk ~ age + sex + height + weight + bmi + bmip +  bmiz + group + group_2 + eGFR_CKD_epi + eGFR_fas_cr+ eGFR_fas_cr_cysc + eGFR_CKiD_U25_CystatinC + eGFR_CKiD_U25_Creat + eGFR_CKiD_U25_avg+ sbp + dbp + hba1c + gotast_base + gptalt_base + kwt(acr_u, "medianq1q3") + uacr_cat + kwt(u24_mab, "medianq1q3") + kwt(lh, "medianq1q3") + kwt(estrad, "medianq1q3") + kwt(tot_test, "medianq1q3") + kwt(free_test, "medianq1q3") + bl_dheas + igf_1 + igf1_z_score + race_ethnicity_condensed + metformin_timepoint + insulin_med_timepoint + glp1_agonist_timepoint + sglti_timepoint + dexa_lean_mass + dexa_body_fat + dexa_fat_kg + dexa_trunk_mass + total_kidney_volume_ml + ht_adj_tkv + mm_si + mm_ir + mm_bcell + mm_di + gfr_raw_plasma + gfr_bsa_plasma + erpf_raw_plasma + erpf_bsa_plasma + ra + re + anova(rvr, digits = 3) + glomerular_pressure + cpeptide, data = panther,                      control = table_controls, test = T), 
      digits = 1))
```
...
# Descriptive tables
## By risk
kable(summary(tableby(group_risk ~ 
                        age + height + weight + bmi + bmiz + birthweight + group_2 + eGFR_CKD_epi + eGFR_fas_cr + sbp + dbp + hba1c + gotast_base + gptalt_base + kwt(acr_u, "medianq1q3") + kwt(lh, "medianq1q3") + kwt(estrad, "medianq1q3") + kwt(tot_test, "medianq1q3") + kwt(free_test, "medianq1q3") + bl_dheas + igf_1 + igf1_z_score + race_ethnicity_condensed + metformin_timepoint + insulin_med_timepoint + glp1_agonist_timepoint + sglti_timepoint + dexa_lean_mass + dexa_body_fat + dexa_fat_kg + dexa_trunk_mass + avg_c_r2 + avg_k_r2 + avg_c_t1 + avg_pcascl + avg_c_adc + total_kidney_volume_ml + ht_adj_tkv + mm_si + mm_ir + mm_bcell+ mm_di + gfr_raw_plasma + gfr_bsa_plasma + erpf_raw_plasma + erpf_bsa_plasma + ra + re + anova(rvr, digits = 3) + glomerular_pressure, data = panther,  
                      control = table_controls, test = T), 
      digits = 1))
```
...
# Descriptive tables
## By risk & sex
summary(tableby(sex_group_risk ~ age + height + weight + bmi + bmiz + birthweight + group_2 + eGFR_CKD_epi + eGFR_fas_cr  + sbp + dbp + hba1c + gotast_base + gptalt_base + acr_u + kwt(lh, "Nmiss", "medianq1q3", "range") + kwt(estrad, "Nmiss", "medianq1q3", "range") + kwt(tot_test, "Nmiss", "medianq1q3", "range") + kwt(free_test, "Nmiss", "medianq1q3", "range") + bl_dheas + igf_1 + igf1_z_score + race_ethnicity_condensed + metformin_timepoint + insulin_med_timepoint + glp1_agonist_timepoint + sglti_timepoint + dexa_lean_mass + dexa_body_fat + dexa_fat_kg + dexa_trunk_mass + avg_c_r2 + avg_k_r2 + avg_c_t1 + avg_pcascl + avg_c_adc + total_kidney_volume_ml + ht_adj_tkv + mm_si + mm_ir + mm_bcell+ mm_di + gfr_raw_plasma + gfr_bsa_plasma + erpf_raw_plasma + erpf_bsa_plasma + ra + re + rvr + glomerular_pressure, data = panther, total = T, test = F))
```
...
# Descriptive tables
## By risk
summary(tableby(sex ~ age + tanner_stage_comp + height + weight + bmi + bmiz + birthweight + group_2 + eGFR_CKD_epi + eGFR_fas_cr  + sbp + dbp + hba1c + gotast_base + gptalt_base + acr_u + kwt(lh, "Nmiss", "medianq1q3", "range") + kwt(estrad, "Nmiss", "medianq1q3", "range") + kwt(tot_test, "Nmiss", "medianq1q3", "range") + kwt(free_test, "Nmiss", "medianq1q3", "range") + bl_dheas + igf_1 + igf1_z_score + race_ethnicity_condensed + metformin_timepoint + insulin_med_timepoint + glp1_agonist_timepoint + sglti_timepoint + dexa_lean_mass + dexa_body_fat + dexa_fat_kg + dexa_trunk_mass + avg_c_r2 + avg_k_r2 + avg_c_t1 + avg_pcascl + avg_c_adc + total_kidney_volume_ml + ht_adj_tkv + mm_si + mm_ir + mm_bcell+ mm_di + gfr_raw_plasma + gfr_bsa_plasma + erpf_raw_plasma + erpf_bsa_plasma + ra + re + rvr + glomerular_pressure, data = subset(panther, group_risk == "Low"), total = T, test = F))
```
...
# Descriptive tables
## By risk
summary(tableby(sex ~ age + tanner_stage_comp + height + weight + bmi + bmiz + birthweight + group_2 + eGFR_CKD_epi + eGFR_fas_cr  + sbp + dbp + hba1c + gotast_base + gptalt_base + acr_u + kwt(lh, "Nmiss", "medianq1q3", "range") + kwt(estrad, "Nmiss", "medianq1q3", "range") + kwt(tot_test, "Nmiss", "medianq1q3", "range") + kwt(free_test, "Nmiss", "medianq1q3", "range") + bl_dheas + igf_1 + igf1_z_score + race_ethnicity_condensed + metformin_timepoint + insulin_med_timepoint + glp1_agonist_timepoint + sglti_timepoint + dexa_lean_mass + dexa_body_fat + dexa_fat_kg + dexa_trunk_mass + avg_c_r2 + avg_k_r2 + avg_c_t1 + avg_pcascl + avg_c_adc + total_kidney_volume_ml + ht_adj_tkv + mm_si + mm_ir + mm_bcell+ mm_di + gfr_raw_plasma + gfr_bsa_plasma + erpf_raw_plasma + erpf_bsa_plasma + ra + re + rvr + glomerular_pressure, data = subset(panther, group_risk == "High"), total = T, test = F))
```
...
# By tanner stage
# summary(tableby(tanner_stage_comp ~ age + height + weight + bmi + bmiz + birthweight + group_2 + eGFR_CKD_epi + eGFR_fas_cr  + sbp + dbp + hba1c + gotast_base + gptalt_base + acr_u + kwt(lh, "Nmiss", "medianq1q3", "range") + kwt(estrad, "Nmiss", "medianq1q3", "range") + kwt(tot_test, "Nmiss", "medianq1q3", "range") + kwt(free_test, "Nmiss", "medianq1q3", "range") + bl_dheas + igf_1 + igf1_z_score + race_ethnicity_condensed + metformin_timepoint + insulin_med_timepoint + glp1_agonist_timepoint + sglti_timepoint + dexa_lean_mass + dexa_body_fat + dexa_fat_kg + dexa_trunk_mass + avg_c_r2 + avg_k_r2 + avg_c_t1 + avg_pcascl + avg_c_adc + total_kidney_volume_ml + ht_adj_tkv + mm_si + mm_ir + mm_bcell+ mm_di + gfr_raw_plasma + gfr_bsa_plasma + erpf_raw_plasma + erpf_bsa_plasma + ra + re + rvr + glomerular_pressure, data = subset(panther, !is.na(group_risk)), total = T, test = F))
# 
summary(tableby(tanner_stage_comp ~ age + height + weight + bmi + bmiz + birthweight + group_2 + eGFR_CKD_epi + eGFR_fas_cr  + sbp + dbp + hba1c + gotast_base + gptalt_base + acr_u + kwt(lh, "Nmiss", "medianq1q3", "range") + kwt(estrad, "Nmiss", "medianq1q3", "range") + kwt(tot_test, "Nmiss", "medianq1q3", "range") + kwt(free_test, "Nmiss", "medianq1q3", "range") + bl_dheas + igf_1 + igf1_z_score + race_ethnicity_condensed + metformin_timepoint + insulin_med_timepoint + glp1_agonist_timepoint + sglti_timepoint + dexa_lean_mass + dexa_body_fat + dexa_fat_kg + dexa_trunk_mass + avg_c_r2 + avg_k_r2 + avg_c_t1 + avg_pcascl + avg_c_adc + total_kidney_volume_ml + ht_adj_tkv + mm_si + mm_ir + mm_bcell+ mm_di + gfr_raw_plasma + gfr_bsa_plasma + erpf_raw_plasma + erpf_bsa_plasma + ra + re + rvr + glomerular_pressure, data = panther, total = T, test = F))
```
...
# By tanner stage
summary(tableby(tanner_stage_comp_panther_cat ~ sex + age + height + weight + bmi + bmiz + birthweight + group_2 + group_risk + eGFR_CKD_epi + eGFR_fas_cr +  eGFR_CKiD_U25_CystatinC + sbp + dbp + hba1c + gotast_base + gptalt_base + kwt(acr_u, "Nmiss", "medianq1q3", "range") + kwt(lh, "Nmiss", "medianq1q3", "range") + kwt(estrad, "Nmiss", "medianq1q3", "range") + kwt(tot_test, "Nmiss", "medianq1q3", "range") + kwt(free_test, "Nmiss", "medianq1q3", "range") + bl_dheas + igf_1 + igf1_z_score + race_ethnicity_condensed + metformin_timepoint + insulin_med_timepoint + glp1_agonist_timepoint + sglti_timepoint + dexa_lean_mass + dexa_body_fat + dexa_fat_kg + dexa_trunk_mass + avg_c_r2 + avg_k_r2 + avg_c_t1 + avg_pcascl + avg_c_adc + total_kidney_volume_ml + ht_adj_tkv + mm_si + mm_ir + mm_bcell+ mm_di + gfr_raw_plasma + gfr_bsa_plasma + erpf_raw_plasma + erpf_bsa_plasma + ra + re + anova(rvr, digits = 3) + glomerular_pressure, data = subset(panther, !is.na(group_risk)), total = T, test = F, digits = 1))
```
...
walk(plots, print)
out_dir <- file.path(root_path, "PANTHER/Results/Figures/050925/IQR Pooled")
walk2(
  .x = plots,
  .y = vars,
  .f = ~ ggsave(
...
out_dir <- file.path(root_path, "PANTHER/Results/Figures/050925/IQR Risk")
walk2(
  .x = plots,
  .y = vars,
  .f = ~ ggsave(
...
out_dir <- file.path(root_path, "PANTHER/Results/Figures/050925/IQR Sex")
walk2(
  .x = plots,
  .y = vars,
  .f = ~ ggsave(
...
png(height = 1500, width = 1500, file = file.path(root_path, "PANTHER/Results/Figures/panther_cor1.png"), res = 170)
...
png(height = 1500, width = 1500, file = file.path(root_path, "PANTHER/Results/Figures/panther_cor2.png"), res = 170)
corr_plot_modified(panther, 
                   X = xvars, 
...
# png(height = 1500, width = 1500, file = file.path(root_path, "PANTHER/Results/Figures/panther_cor3.png"), res = 170)
# corr_plot_modified(panther, 
#                    X = xvars, 
...
png(height = 1500, width = 1500, file = file.path(root_path, "PANTHER/Results/Figures/panther_cor4.png"), res = 170)
corr_plot_modified(panther, 
                   X = xvars, 
...
png(height = 1500, width = 1500, file = file.path(root_path, "PANTHER/Results/Figures/panther_cor5.png"), res = 170)
corr_plot_modified(panther, 
                   X = xvars2, 
...
plotVolcano_mod(data = pearson_cor_mat, 
 ...
 ggsave(file.path(root_path, "PANTHER/Results/Figures/gfr_cor_plot.jpeg"), 
       width = 12, height = 10)
```

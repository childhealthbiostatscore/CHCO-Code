...
panther_uacr <- (subset(panther, select = c(record_id, group, u24_mab, acr_u, creatinine_u, microalbumin_u))) %>%
...
panther_uacr_wide <- panther_uacr_2 %>%
  pivot_wider(
    id_cols = c(record_id, group),  # person ID and group (adjust if needed)

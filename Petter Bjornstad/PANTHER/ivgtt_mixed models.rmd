...
matching_cols_cpep <- names(dat)[startsWith(names(dat), "cpep")]
matching_cols_ins <- names(dat)[startsWith(names(dat), "ins")]
matching_cols_ins <- matching_cols_ins[2:47]
matching_cols_glu <- names(dat)[startsWith(names(dat), "glu")]
matching_cols_glu <- c(matching_cols_glu[1:30], matching_cols_glu[40:100], matching_cols_glu[107:112])
...
# dict <- read.csv("/Users/laurapyle/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Data Harmonization/data_dictionary_master.csv")
# 

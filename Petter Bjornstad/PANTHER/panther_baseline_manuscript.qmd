...
panther$uacr_cat <- factor(panther$uacr_cat, levels = c("UACR [0, 10]",
                                                        "UACR (10, 20]",
                                                        "UACR (20, 30]",
                                                        "UACR > 30"))
```
...
kable(summary(tableby(group_risk ~ age + sex + group_2 + race_ethnicity_condensed + height + weight + 
                        ...
                        kwt(acr_u, "Nmiss", "medianq1q3") + uacr_cat + kwt(u24_mab, "Nmiss", "medianq1q3") + 
                        gotast_base + gptalt_base +  
                        metformin_timepoint + insulin_med_timepoint + glp1_agonist_timepoint + sglti_timepoint, 
                      data = panther, 
...
kable(summary(tableby(group_risk ~  kwt(lh, "medianq1q3") + kwt(estrad, "medianq1q3") + kwt(tot_test, "medianq1q3") + 
                        kwt(free_test, "medianq1q3") + bl_dheas + igf_1 + igf1_z_score + cpeptide + 

...
#########################################
# 20 T1D high risk vs. 20 T1D low risk  #
#########################################

# read in simulated data
# changed SD of random intercept to 5
data <- read.csv('/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Grants/Puberty and kidney structure and function R01 (PANTHER)/Renewal application/Power calculations/ald_sim_20_vs_20_per_group.csv')

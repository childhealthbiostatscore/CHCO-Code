...
3) There was only 1 participant in Tanner stage 5 at baseline, so Tanner 4 and 5 were combined for analysis.
4) Tukey's HSD procedure was used to account for multiple testing during the comparison of groups at each time point.

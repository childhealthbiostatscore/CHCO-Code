...
```{r echo = F}
pc_kpmp_results <- analyze_pseudotime_by_celltype(
  so = attempt_so,
  celltype_col = "KPMP_celltype",
  celltype_groups = c("CCD-PC", "dCCD-PC", "CNT-PC", "M-PC", "tPC-IC"),
  start_cluster = "CCD-PC",
  custom_colors = color_5,
  suffix = "pc_kpmp",
  aws_s3 = s3
)
...
# PC (non-KPMP celltype)

```{r echo = F}
pc_results <- analyze_pseudotime_by_celltype(
  so = attempt_so,
  celltype_col = "celltype",
  celltype_groups = c("tPC-IC", "PC-1", "PC-2"),
  start_cluster = "PC-1",
  custom_colors = color_5,
  suffix = "pc",
  aws_s3 = s3
...
# Immune (KPMP celltype)

```{r echo = F}
immune_kpmp_results <- analyze_pseudotime_by_celltype(
  so = attempt_so,
  celltype_col = "KPMP_celltype",
  celltype_groups = c("CD4+ T", "CD8+ T", "cycT", "cDC", "pDC", "MAC", "MON", "NK", "B"),
  start_cluster = "NK",
  custom_colors = color_9,
  suffix = "immune_kpmp",
  aws_s3 = s3
)
```

# Immune (non-KPMP celltype)

```{r echo = F}
immune_results <- analyze_pseudotime_by_celltype(
  so = attempt_so,
  celltype_col = "celltype",
  celltype_groups = c("MAC", "MON", "NKT/NKC", "T", "B"),
  start_cluster = "NKT/NKC",
  custom_colors = color_5,
  suffix = "immune",
  aws_s3 = s3
)
...
# Fib/VSMC/P (KPMP celltype)

```{r echo = F}
fibvsmcp_kpmp_results <- analyze_pseudotime_by_celltype(
  so = attempt_so,
  celltype_col = "KPMP_celltype",
  celltype_groups = c("FIB", "VSMC/P", "EC/VSMC", "PEC", "MC"),
  start_cluster = "VSMC/P",
  custom_colors = color_5,
  suffix = "fibvsmcp_kpmp",
  aws_s3 = s3
)
```

# Fib/VSMC/P (non-KPMP celltype)

```{r echo = F}
fibvsmcp_results <- analyze_pseudotime_by_celltype(
  so = attempt_so,
  celltype_col = "celltype",
  celltype_groups = c("FIB", "VSMC/P"),
  start_cluster = "VSMC/P",
  custom_colors = color_5,
  suffix = "fibvsmcp",
  aws_s3 = s3

...
pt_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/pt_attempt_scrna_mm_model_combined.rds")

## read emmeans dataframe (rendered in Hyak)
pt_emmeans_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/pt_attempt_scrna_mm_emmeans_combined.rds")
```
...
pt_model_filteredmod1 <- pt_model_df_mod1 %>%
  group_by(Gene) %>%
  filter(all(!is.na(PValue)))

pt_emmeans_filteredmod1 <- pt_emmeans_df_mod1 %>%
  filter(Gene %in% pt_model_filteredmod1$Gene) %>%
  group_by(Gene) %>%
  filter(all(!is.na(SE)))
...
ordered_modelmod1 <- subset(pt_model_filteredmod1, Variable == "TreatmentDapagliflozin:VisitPOST") %>%
  arrange(PValue)
gene_order <- factor(ordered_modelmod1$Gene, levels = ordered_modelmod1$Gene)
sig_genes <- subset(pt_model_filteredmod1, Variable == "TreatmentDapagliflozin:VisitPOST" & PValue < 0.05)$Gene
```

```{r echo =F}
## compute emmean difference in POST - PRE in each treatment group
pt_emmeans_diff_mod1 <- pt_emmeans_filteredmod1 %>%
...
colnames(pt_emmeans_diff_placebo_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(pt_emmeans_diff_placebo_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/pt_emmeans_diff_placebo.csv", row.names = F)
...
pt_emmeans_diff_dapa_mod1 <- pt_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(pt_emmeans_diff_dapa_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(pt_emmeans_diff_dapa_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/pt_emmeans_diff_dapa.csv", row.names = F)
```
...
colnames(pt_emmeans_diff_DiD_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(pt_emmeans_diff_DiD_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/pt_emmeans_diff_DiD.csv", row.names = F)
```
...
```{r echo = F}
plot_volcano <- function(data, p_col, title_suffix, x_axis, y_axis, file_suffix, p_thresh = 0.05) {
  top_pos <- data %>%
    filter(`Expr Other` > 0, !!sym(p_col) < p_thresh) %>%
    arrange(!!sym(p_col)) %>%
    slice_head(n=20)
  ...
  p <- ggplot(data, aes(x = `Expr Other`, y = -log10(!!sym(p_col)))) +
...
```{r echo = F}
# Placebo
plot_volcano(pt_emmeans_diff_placebo_mod1, "Expr p-value",
             "Model 1 PT Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/pt_placebo_pvalue_mod1")

plot_volcano(pt_emmeans_diff_placebo_mod1, "Expr False Discovery Rate", 
             "Model 1 PT Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/pt_placebo_adj_pvalue_mod1")
# Dapa
plot_volcano(pt_emmeans_diff_dapa_mod1, "Expr p-value",
             "Model 1 PT Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/pt_dapa_pvalue_mod1")

plot_volcano(pt_emmeans_diff_dapa_mod1, "Expr False Discovery Rate", 
             "Model 1 PT Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/pt_dapa_adj_pvalue_mod1")

# DiD
plot_volcano(pt_emmeans_diff_DiD_mod1, "Expr p-value", "Model 1 PT DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/pt_DiD_pvalue_mod1")

plot_volcano(pt_emmeans_diff_DiD_mod1, "Expr False Discovery Rate", "Model 1 PT DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/pt_DiD_adj_pvalue_mod1")
```
...
# pt_placebo_pos_mod1 <- (pt_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# pt_placebo_neg_mod1 <- (pt_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# pt_dapa_pos <- (pt_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# pt_dapa_neg <- (pt_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
pt_emmeans_diff_wide_mod1 <- (pt_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
pt_DiD_negmod1 <- (pt_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# pt_gsea_placebo_pos_mod1 <- enrichr(pt_placebo_pos_mod1, dbs)
# # expected negative
# pt_gsea_placebo_neg_mod1 <- enrichr(pt_placebo_neg_mod1, dbs)
# # actual positive
# pt_gsea_dapa_posmod1 <- enrichr(pt_dapa_pos, dbs)
# # actual negative
# pt_gsea_dapa_negmod1 <- enrichr(pt_dapa_neg, dbs)
# DiD positive
pt_gsea_DiD_posmod1 <- enrichr(pt_emmeans_diff_wide_mod1, dbs)
# DiD negative
pt_gsea_DiD_negmod1 <- enrichr(pt_DiD_negmod1, dbs)

# pt_gsea_placebo_pos_mod1
# pt_gsea_placebo_neg_mod1
# pt_gsea_dapa_posmod1
# pt_gsea_dapa_negmod1
# pt_gsea_DiD_posmod1
# pt_gsea_DiD_negmod1
plotEnrich(as.data.frame(pt_gsea_DiD_posmod1[[1]]), title = "Model 1 Positive DiD - PT GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pt_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_posmod1[[2]]), title = "Model 1 Positive DiD - PT KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pt_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_posmod1[[3]]), title = "Model 1 Positive DiD - PT REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pt_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_posmod1[[4]]), title = "Model 1 Positive DiD - PT REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pt_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(pt_gsea_DiD_negmod1[[1]]), title = "Model 1 Negative DiD - PT GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pt_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_negmod1[[2]]), title = "Model 1 Negative DiD - PT KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pt_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_negmod1[[3]]), title = "Model 1 Negative DiD - PT REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pt_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_negmod1[[4]]), title = "Model 1 Negative DiD - PT REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pt_neg_DiD_gsea_reactome24.jpeg")
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
tal_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/tal_attempt_scrna_mm_model_combined.rds")

## read emmeans dataframe (rendered in Hyak)
tal_emmeans_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/tal_attempt_scrna_mm_emmeans_combined.rds")
```
...
tal_emmeans_diff_placebo_mod1 <- tal_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(tal_emmeans_diff_placebo_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(tal_emmeans_diff_placebo_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/tal_emmeans_diff_placebo.csv", row.names = F)
...
tal_emmeans_diff_dapa_mod1 <- tal_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(tal_emmeans_diff_dapa_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(tal_emmeans_diff_dapa_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/tal_emmeans_diff_dapa.csv", row.names = F)
```
...
tal_emmeans_diff_DiD_mod1 <- tal_emmeans_diff_wide_mod1  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(tal_emmeans_diff_DiD_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(tal_emmeans_diff_DiD_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/tal_emmeans_diff_DiD.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(tal_emmeans_diff_placebo_mod1, "Expr p-value",
             "Model 1 TAL Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/tal_placebo_pvalue_mod1")

plot_volcano(tal_emmeans_diff_placebo_mod1, "Expr False Discovery Rate", 
             "Model 1 TAL Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/tal_placebo_adj_pvalue_mod1")
# Dapa
plot_volcano(tal_emmeans_diff_dapa_mod1, "Expr p-value",
             "Model 1 TAL Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/tal_dapa_pvalue_mod1")

plot_volcano(tal_emmeans_diff_dapa_mod1, "Expr False Discovery Rate", 
             "Model 1 TAL Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/tal_dapa_adj_pvalue_mod1")

# DiD
plot_volcano(tal_emmeans_diff_DiD_mod1, "Expr p-value", "Model 1 TAL DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/tal_DiD_pvalue_mod1")

plot_volcano(tal_emmeans_diff_DiD_mod1, "Expr False Discovery Rate", "Model 1 TAL DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/tal_DiD_adj_pvalue_mod1")
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# tal_placebo_pos <- (tal_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# tal_placebo_neg <- (tal_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# tal_dapa_pos <- (tal_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# tal_dapa_neg <- (tal_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
tal_DiD_pos_mod1 <- (tal_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
tal_DiD_neg_mod1 <- (tal_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# tal_gsea_placebo_pos_mod1 <- enrichr(tal_placebo_pos, dbs)
# # expected negative
# tal_gsea_placebo_neg_mod1 <- enrichr(tal_placebo_neg, dbs)
# # actual positive
# tal_gsea_dapa_pos_mod1 <- enrichr(tal_dapa_pos, dbs)
# # actual negative
# tal_gsea_dapa_neg_mod1 <- enrichr(tal_dapa_neg, dbs)
# DiD positive
tal_gsea_DiD_pos_mod1 <- enrichr(tal_DiD_pos_mod1, dbs)
# DiD negative
tal_gsea_DiD_neg_mod1 <- enrichr(tal_DiD_neg_mod1, dbs)

# tal_gsea_placebo_pos_mod1
# tal_gsea_placebo_neg_mod1
# tal_gsea_dapa_pos_mod1
# tal_gsea_dapa_neg_mod1
# tal_gsea_DiD_pos_mod1
# tal_gsea_DiD_neg_mod1
plotEnrich(as.data.frame(tal_gsea_DiD_pos_mod1[[1]]), title = "Model 1 Positive DiD - TAL GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/tal_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_pos_mod1[[2]]), title = "Model 1 Positive DiD - TAL KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/tal_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_pos_mod1[[3]]), title = "Model 1 Positive DiD - TAL REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/tal_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_pos_mod1[[4]]), title = "Model 1 Positive DiD - TAL REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/tal_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(tal_gsea_DiD_neg_mod1[[1]]), title = "Model 1 Negative DiD - TAL GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/tal_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_neg_mod1[[2]]), title = "Model 1 Negative DiD - TAL KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/tal_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_neg_mod1[[3]]), title = "Model 1 Negative DiD - TAL REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/tal_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_neg_mod1[[4]]), title = "Model 1 Negative DiD - TAL REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/tal_neg_DiD_gsea_reactome24.jpeg")
```
### PC
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
pc_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/pc_attempt_scrna_mm_model_combined.rds")

## read emmeans dataframe (rendered in Hyak)
pc_emmeans_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/pc_attempt_scrna_mm_emmeans_combined.rds")
```
...
pc_emmeans_diff_placebo_mod1 <- pc_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(pc_emmeans_diff_placebo_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(pc_emmeans_diff_placebo_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/pc_emmeans_diff_placebo.csv", row.names = F)
...
pc_emmeans_diff_dapa_mod1 <- pc_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(pc_emmeans_diff_dapa_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(pc_emmeans_diff_dapa_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/pc_emmeans_diff_dapa.csv", row.names = F)
```
...
pc_emmeans_diff_DiD_mod1 <- pc_emmeans_diff_wide_mod1  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(pc_emmeans_diff_DiD_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(pc_emmeans_diff_DiD_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/pc_emmeans_diff_DiD.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(pc_emmeans_diff_placebo_mod1, "Expr p-value",
             "Model 1 PC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/pc_placebo_pvalue_mod1")

plot_volcano(pc_emmeans_diff_placebo_mod1, "Expr False Discovery Rate", 
             "Model 1 PC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/pc_placebo_adj_pvalue_mod1")
# Dapa
plot_volcano(pc_emmeans_diff_dapa_mod1, "Expr p-value",
             "Model 1 PC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/pc_dapa_pvalue_mod1")

plot_volcano(pc_emmeans_diff_dapa_mod1, "Expr False Discovery Rate", 
             "Model 1 PC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/pc_dapa_adj_pvalue_mod1")

# DiD
plot_volcano(pc_emmeans_diff_DiD_mod1, "Expr p-value", "Model 1 PC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/pc_DiD_pvalue_mod1")

plot_volcano(pc_emmeans_diff_DiD_mod1, "Expr False Discovery Rate", "Model 1 PC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/pc_DiD_adj_pvalue_mod1")
```
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# pc_placebo_pos <- (pc_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# pc_placebo_neg <- (pc_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# pc_dapa_pos <- (pc_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# pc_dapa_neg <- (pc_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
pc_DiD_pos_mod1 <- (pc_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
pc_DiD_neg_mod1 <- (pc_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# pc_gsea_placebo_pos_mod1 <- enrichr(pc_placebo_pos, dbs)
# # expected negative
# pc_gsea_placebo_neg_mod1 <- enrichr(pc_placebo_neg, dbs)
# # actual positive
# pc_gsea_dapa_pos_mod1 <- enrichr(pc_dapa_pos, dbs)
# # actual negative
# pc_gsea_dapa_neg_mod1 <- enrichr(pc_dapa_neg, dbs)
# DiD positive
pc_gsea_DiD_pos_mod1 <- enrichr(pc_DiD_pos_mod1, dbs)
# DiD negative
pc_gsea_DiD_neg_mod1 <- enrichr(pc_DiD_neg_mod1, dbs)

# pc_gsea_placebo_pos_mod1
# pc_gsea_placebo_neg_mod1
# pc_gsea_dapa_pos_mod1
# pc_gsea_dapa_neg_mod1
# pc_gsea_DiD_pos_mod1
# pc_gsea_DiD_neg_mod1
plotEnrich(as.data.frame(pc_gsea_DiD_pos_mod1[[1]]), title = "Model 1 Positive DiD - PC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pc_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_pos_mod1[[2]]), title = "Model 1 Positive DiD - PC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pc_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_pos_mod1[[3]]), title = "Model 1 Positive DiD - PC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pc_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_pos_mod1[[4]]), title = "Model 1 Positive DiD - PC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pc_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(pc_gsea_DiD_neg_mod1[[1]]), title = "Model 1 Negative DiD - PC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pc_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_neg_mod1[[2]]), title = "Model 1 Negative DiD - PC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pc_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_neg_mod1[[3]]), title = "Model 1 Negative DiD - PC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pc_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_neg_mod1[[4]]), title = "Model 1 Negative DiD - PC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/pc_neg_DiD_gsea_reactome24.jpeg")
```

### Immune (very few cells)
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
immune_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/immune_attempt_scrna_mm_model_combined.rds")

## read emmeans dataframe (rendered in Hyak)
immune_emmeans_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/immune_attempt_scrna_mm_emmeans_combined.rds")
```
...
immune_emmeans_diff_placebo_mod1 <- immune_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(immune_emmeans_diff_placebo_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(immune_emmeans_diff_placebo_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/immune_emmeans_diff_placebo.csv", row.names = F)
...
immune_emmeans_diff_dapa_mod1 <- immune_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(immune_emmeans_diff_dapa_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(immune_emmeans_diff_dapa_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/immune_emmeans_diff_dapa.csv", row.names = F)
```
...
immune_emmeans_diff_DiD_mod1 <- immune_emmeans_diff_wide_mod1  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(immune_emmeans_diff_DiD_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(immune_emmeans_diff_DiD_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/immune_emmeans_diff_DiD.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(immune_emmeans_diff_placebo_mod1, "Expr p-value",
             "Model 1 Immune Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/immune_placebo_pvalue_mod1")

plot_volcano(immune_emmeans_diff_placebo_mod1, "Expr False Discovery Rate", 
             "Model 1 Immune Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/immune_placebo_adj_pvalue_mod1")
# Dapa
plot_volcano(immune_emmeans_diff_dapa_mod1, "Expr p-value",
             "Model 1 Immune Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/immune_dapa_pvalue_mod1")

plot_volcano(immune_emmeans_diff_dapa_mod1, "Expr False Discovery Rate", 
             "Model 1 Immune Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/immune_dapa_adj_pvalue_mod1")

# DiD
plot_volcano(immune_emmeans_diff_DiD_mod1, "Expr p-value", "Model 1 Immune DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/immune_DiD_pvalue_mod1")

plot_volcano(immune_emmeans_diff_DiD_mod1, "Expr False Discovery Rate", "Model 1 Immune DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/immune_DiD_adj_pvalue_mod1")
```
#### GSEA (enrichR)
```{r echo = F}
# pathways from emmeans
# enrichment analysis
# # significant positive in placebo (expected positive)
# immune_placebo_pos <- (immune_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# immune_placebo_neg <- (immune_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# immune_dapa_pos <- (immune_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# immune_dapa_neg <- (immune_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
immune_DiD_pos_mod1 <- (immune_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
immune_DiD_neg_mod1 <- (immune_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# immune_gsea_placebo_pos_mod1 <- enrichr(immune_placebo_pos, dbs)
# # expected negative
# immune_gsea_placebo_neg_mod1 <- enrichr(immune_placebo_neg, dbs)
# # actual positive
# immune_gsea_dapa_pos_mod1 <- enrichr(immune_dapa_pos, dbs)
# # actual negative
# immune_gsea_dapa_neg_mod1 <- enrichr(immune_dapa_neg, dbs)
# DiD positive
immune_gsea_DiD_pos_mod1 <- enrichr(immune_DiD_pos_mod1, dbs)
# DiD negative
immune_gsea_DiD_neg_mod1 <- enrichr(immune_DiD_neg_mod1, dbs)

# immune_gsea_placebo_pos_mod1
# immune_gsea_placebo_neg_mod1
# immune_gsea_dapa_pos_mod1
# immune_gsea_dapa_neg_mod1
# immune_gsea_DiD_pos_mod1
# immune_gsea_DiD_neg_mod1
plotEnrich(as.data.frame(immune_gsea_DiD_pos_mod1[[1]]), title = "Model 1 Positive DiD - Immune GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/immune_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_pos_mod1[[2]]), title = "Model 1 Positive DiD - Immune KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/immune_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_pos_mod1[[3]]), title = "Model 1 Positive DiD - Immune REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/immune_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_pos_mod1[[4]]), title = "Model 1 Positive DiD - Immune REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/immune_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(immune_gsea_DiD_neg_mod1[[1]]), title = "Model 1 Negative DiD - Immune GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/immune_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_neg_mod1[[2]]), title = "Model 1 Negative DiD - Immune KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/immune_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_neg_mod1[[3]]), title = "Model 1 Negative DiD - Immune REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/immune_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_neg_mod1[[4]]), title = "Model 1 Negative DiD - Immune REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/immune_neg_DiD_gsea_reactome24.jpeg")
```
### IC
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
ic_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/ic_attempt_scrna_mm_model_combined.rds")

## read emmeans dataframe (rendered in Hyak)
ic_emmeans_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/ic_attempt_scrna_mm_emmeans_combined.rds")
```
...
ic_emmeans_diff_placebo_mod1 <- ic_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(ic_emmeans_diff_placebo_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(ic_emmeans_diff_placebo_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/ic_emmeans_diff_placebo.csv", row.names = F)
...
ic_emmeans_diff_dapa_mod1 <- ic_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(ic_emmeans_diff_dapa_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(ic_emmeans_diff_dapa_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/ic_emmeans_diff_dapa.csv", row.names = F)
```
...
ic_emmeans_diff_DiD_mod1 <- ic_emmeans_diff_wide_mod1  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(ic_emmeans_diff_DiD_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(ic_emmeans_diff_DiD_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/ic_emmeans_diff_DiD.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(ic_emmeans_diff_placebo_mod1, "Expr p-value",
             "Model 1 IC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/ic_placebo_pvalue_mod1")

plot_volcano(ic_emmeans_diff_placebo_mod1, "Expr False Discovery Rate", 
             "Model 1 IC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/ic_placebo_adj_pvalue_mod1")
# Dapa
plot_volcano(ic_emmeans_diff_dapa_mod1, "Expr p-value",
             "Model 1 IC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/ic_dapa_pvalue_mod1")

plot_volcano(ic_emmeans_diff_dapa_mod1, "Expr False Discovery Rate", 
             "Model 1 IC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/ic_dapa_adj_pvalue_mod1")

# DiD
plot_volcano(ic_emmeans_diff_DiD_mod1, "Expr p-value", "Model 1 IC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/ic_DiD_pvalue_mod1")

plot_volcano(ic_emmeans_diff_DiD_mod1, "Expr False Discovery Rate", "Model 1 IC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/ic_DiD_adj_pvalue_mod1")
```
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# ic_placebo_pos <- (ic_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# ic_placebo_neg <- (ic_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# ic_dapa_pos <- (ic_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# ic_dapa_neg <- (ic_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
ic_DiD_pos_mod1 <- (ic_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
ic_DiD_neg_mod1 <- (ic_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# ic_gsea_placebo_pos_mod1 <- enrichr(ic_placebo_pos, dbs)
# # expected negative
# ic_gsea_placebo_neg_mod1 <- enrichr(ic_placebo_neg, dbs)
# # actual positive
# ic_gsea_dapa_pos_mod1 <- enrichr(ic_dapa_pos, dbs)
# # actual negative
# ic_gsea_dapa_neg_mod1 <- enrichr(ic_dapa_neg, dbs)
# DiD positive
ic_gsea_DiD_pos_mod1 <- enrichr(ic_DiD_pos_mod1, dbs)
# DiD negative
ic_gsea_DiD_neg_mod1 <- enrichr(ic_DiD_neg_mod1, dbs)

# ic_gsea_placebo_pos_mod1
# ic_gsea_placebo_neg_mod1
# ic_gsea_dapa_pos_mod1
# ic_gsea_dapa_neg_mod1
# ic_gsea_DiD_pos_mod1
# ic_gsea_DiD_neg_mod1
plotEnrich(as.data.frame(ic_gsea_DiD_pos_mod1[[1]]), title = "Model 1 Positive DiD - IC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ic_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_pos_mod1[[2]]), title = "Model 1 Positive DiD - IC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ic_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_pos_mod1[[3]]), title = "Model 1 Positive DiD - IC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ic_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_pos_mod1[[4]]), title = "Model 1 Positive DiD - IC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ic_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(ic_gsea_DiD_neg_mod1[[1]]), title = "Model 1 Negative DiD - IC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ic_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_neg_mod1[[2]]), title = "Model 1 Negative DiD - IC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ic_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_neg_mod1[[3]]), title = "Model 1 Negative DiD - IC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ic_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_neg_mod1[[4]]), title = "Model 1 Negative DiD - IC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ic_neg_DiD_gsea_reactome24.jpeg")
```
### EC
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
ec_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/ec_attempt_scrna_mm_model_combined.rds")

## read emmeans dataframe (rendered in Hyak)
ec_emmeans_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/ec_attempt_scrna_mm_emmeans_combined.rds")
```
...
ec_emmeans_diff_placebo_mod1 <- ec_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(ec_emmeans_diff_placebo_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(ec_emmeans_diff_placebo_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/ec_emmeans_diff_placebo.csv", row.names = F)
...
ec_emmeans_diff_dapa_mod1 <- ec_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(ec_emmeans_diff_dapa_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(ec_emmeans_diff_dapa_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/ec_emmeans_diff_dapa.csv", row.names = F)
```
...
ec_emmeans_diff_DiD_mod1 <- ec_emmeans_diff_wide_mod1  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(ec_emmeans_diff_DiD_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(ec_emmeans_diff_DiD_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/ec_emmeans_diff_DiD.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(ec_emmeans_diff_placebo_mod1, "Expr p-value",
             "Model 1 EC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/ec_placebo_pvalue_mod1")

plot_volcano(ec_emmeans_diff_placebo_mod1, "Expr False Discovery Rate", 
             "Model 1 EC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/ec_placebo_adj_pvalue_mod1")
# Dapa
plot_volcano(ec_emmeans_diff_dapa_mod1, "Expr p-value",
             "Model 1 EC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/ec_dapa_pvalue_mod1")

plot_volcano(ec_emmeans_diff_dapa_mod1, "Expr False Discovery Rate", 
             "Model 1 EC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/ec_dapa_adj_pvalue_mod1")

# DiD
plot_volcano(ec_emmeans_diff_DiD_mod1, "Expr p-value", "Model 1 EC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/ec_DiD_pvalue_mod1")

plot_volcano(ec_emmeans_diff_DiD_mod1, "Expr False Discovery Rate", "Model 1 EC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/ec_DiD_adj_pvalue_mod1")
```
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# ec_placebo_pos <- (ec_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# ec_placebo_neg <- (ec_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# ec_dapa_pos <- (ec_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# ec_dapa_neg <- (ec_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
ec_DiD_pos_mod1 <- (ec_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
ec_DiD_neg_mod1 <- (ec_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# ec_gsea_placebo_pos_mod1 <- enrichr(ec_placebo_pos, dbs)
# # expected negative
# ec_gsea_placebo_neg_mod1 <- enrichr(ec_placebo_neg, dbs)
# # actual positive
# ec_gsea_dapa_pos_mod1 <- enrichr(ec_dapa_pos, dbs)
# # actual negative
# ec_gsea_dapa_neg_mod1 <- enrichr(ec_dapa_neg, dbs)
# DiD positive
ec_gsea_DiD_pos_mod1 <- enrichr(ec_DiD_pos_mod1, dbs)
# DiD negative
ec_gsea_DiD_neg_mod1 <- enrichr(ec_DiD_neg_mod1, dbs)

# ec_gsea_placebo_pos_mod1
# ec_gsea_placebo_neg_mod1
# ec_gsea_dapa_pos_mod1
# ec_gsea_dapa_neg_mod1
# ec_gsea_DiD_pos_mod1
# ec_gsea_DiD_neg_mod1
plotEnrich(as.data.frame(ec_gsea_DiD_pos_mod1[[1]]), title = "Model 1 Positive DiD - EC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ec_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_pos_mod1[[2]]), title = "Model 1 Positive DiD - EC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ec_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_pos_mod1[[3]]), title = "Model 1 Positive DiD - EC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ec_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_pos_mod1[[4]]), title = "Model 1 Positive DiD - EC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ec_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(ec_gsea_DiD_neg_mod1[[1]]), title = "Model 1 Negative DiD - EC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ec_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_neg_mod1[[2]]), title = "Model 1 Negative DiD - EC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ec_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_neg_mod1[[3]]), title = "Model 1 Negative DiD - EC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ec_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_neg_mod1[[4]]), title = "Model 1 Negative DiD - EC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/ec_neg_DiD_gsea_reactome24.jpeg")
```
### DTL (very few cells)
```{r echo = F, eval = F}
## read mixed model results dataframe (rendered in Hyak)
dtl_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/dtl_attempt_scrna_mm_model_combined.rds")

## read emmeans dataframe (rendered in Hyak)
dtl_emmeans_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/dtl_attempt_scrna_mm_emmeans_combined.rds")
```
...
dtl_emmeans_diff_placebo_mod1 <- dtl_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(dtl_emmeans_diff_placebo_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
## write.csv(dtl_emmeans_diff_placebo_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/dtl_emmeans_diff_placebo.csv", row.names = F)
...
dtl_emmeans_diff_dapa_mod1 <- dtl_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(dtl_emmeans_diff_dapa_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
## write.csv(dtl_emmeans_diff_dapa_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/dtl_emmeans_diff_dapa.csv", row.names = F)
```
...
dtl_emmeans_diff_DiD_mod1 <- dtl_emmeans_diff_wide_mod1  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(dtl_emmeans_diff_DiD_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
## write.csv(dtl_emmeans_diff_DiD_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/dtl_emmeans_diff_DiD.csv", row.names = F)
```
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
fibvsmcp_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/fibvsmcp_attempt_scrna_mm_model_combined.rds")

## read emmeans dataframe (rendered in Hyak)
fibvsmcp_emmeans_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/1 Nested visit and zero inflation/fibvsmcp_attempt_scrna_mm_emmeans_combined.rds")
```
...
fibvsmcp_emmeans_diff_placebo_mod1 <- fibvsmcp_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(fibvsmcp_emmeans_diff_placebo_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(fibvsmcp_emmeans_diff_placebo_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/fibvsmcp_emmeans_diff_placebo.csv", row.names = F)
...
fibvsmcp_emmeans_diff_dapa_mod1 <- fibvsmcp_emmeans_diff_mod1 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(fibvsmcp_emmeans_diff_dapa_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(fibvsmcp_emmeans_diff_dapa_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/fibvsmcp_emmeans_diff_dapa.csv", row.names = F)
```
...
fibvsmcp_emmeans_diff_DiD_mod1 <- fibvsmcp_emmeans_diff_wide_mod1  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(fibvsmcp_emmeans_diff_DiD_mod1) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(fibvsmcp_emmeans_diff_DiD_mod1, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/1 Nested visit and zero inflation/fibvsmcp_emmeans_diff_DiD.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(fibvsmcp_emmeans_diff_placebo_mod1, "Expr p-value",
             "Model 1 FIB/VSMC/P Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/fibvsmcp_placebo_pvalue_mod1")

plot_volcano(fibvsmcp_emmeans_diff_placebo_mod1, "Expr False Discovery Rate", 
             "Model 1 FIB/VSMC/P Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/fibvsmcp_placebo_adj_pvalue_mod1")
# Dapa
plot_volcano(fibvsmcp_emmeans_diff_dapa_mod1, "Expr p-value",
             "Model 1 FIB/VSMC/P Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/fibvsmcp_dapa_pvalue_mod1")

plot_volcano(fibvsmcp_emmeans_diff_dapa_mod1, "Expr False Discovery Rate", 
             "Model 1 FIB/VSMC/P Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/fibvsmcp_dapa_adj_pvalue_mod1")

# DiD
plot_volcano(fibvsmcp_emmeans_diff_DiD_mod1, "Expr p-value", "Model 1 FIB/VSMC/P DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "1 Nested visit and zero inflation/fibvsmcp_DiD_pvalue_mod1")

plot_volcano(fibvsmcp_emmeans_diff_DiD_mod1, "Expr False Discovery Rate", "Model 1 FIB/VSMC/P DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "1 Nested visit and zero inflation/fibvsmcp_DiD_adj_pvalue_mod1")
```
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# fibvsmcp_placebo_pos <- (fibvsmcp_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# fibvsmcp_placebo_neg <- (fibvsmcp_emmeans_diff_placebo_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# fibvsmcp_dapa_pos <- (fibvsmcp_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# fibvsmcp_dapa_neg <- (fibvsmcp_emmeans_diff_dapa_mod1 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
fibvsmcp_DiD_pos_mod1 <- (fibvsmcp_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
fibvsmcp_DiD_neg_mod1 <- (fibvsmcp_emmeans_diff_DiD_mod1 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# fibvsmcp_gsea_placebo_pos_mod1 <- enrichr(fibvsmcp_placebo_pos, dbs)
# # expected negative
# fibvsmcp_gsea_placebo_neg_mod1 <- enrichr(fibvsmcp_placebo_neg, dbs)
# # actual positive
# fibvsmcp_gsea_dapa_pos_mod1 <- enrichr(fibvsmcp_dapa_pos, dbs)
# # actual negative
# fibvsmcp_gsea_dapa_neg_mod1 <- enrichr(fibvsmcp_dapa_neg, dbs)
# DiD positive
fibvsmcp_gsea_DiD_pos_mod1 <- enrichr(fibvsmcp_DiD_pos_mod1, dbs)
# DiD negative
fibvsmcp_gsea_DiD_neg_mod1 <- enrichr(fibvsmcp_DiD_neg_mod1, dbs)

# fibvsmcp_gsea_placebo_pos_mod1
# fibvsmcp_gsea_placebo_neg_mod1
# fibvsmcp_gsea_dapa_pos_mod1
# fibvsmcp_gsea_dapa_neg_mod1
# fibvsmcp_gsea_DiD_pos_mod1
# fibvsmcp_gsea_DiD_neg_mod1
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_pos_mod1[[1]]), title = "Model 1 Positive DiD - FIB/VSMC/P GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/fibvsmcp_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_pos_mod1[[2]]), title = "Model 1 Positive DiD - FIB/VSMC/P KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/fibvsmcp_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_pos_mod1[[3]]), title = "Model 1 Positive DiD - FIB/VSMC/P REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/fibvsmcp_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_pos_mod1[[4]]), title = "Model 1 Positive DiD - FIB/VSMC/P REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/fibvsmcp_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_neg_mod1[[1]]), title = "Model 1 Negative DiD - FIB/VSMC/P GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/fibvsmcp_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_neg_mod1[[2]]), title = "Model 1 Negative DiD - FIB/VSMC/P KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/fibvsmcp_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_neg_mod1[[3]]), title = "Model 1 Negative DiD - FIB/VSMC/P REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/fibvsmcp_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_neg_mod1[[4]]), title = "Model 1 Negative DiD - FIB/VSMC/P REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/1 Nested visit and zero inflation/fibvsmcp_neg_DiD_gsea_reactome24.jpeg")
```
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
pt_model_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/pt_attempt_scrna_mm_model_combined_2.rds")

## read emmeans dataframe (rendered in Hyak)
pt_emmeans_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/pt_attempt_scrna_mm_emmeans_combined_2.rds")
```
...
pt_emmeans_diff_placebo_mod2 <- pt_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(pt_emmeans_diff_placebo_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(pt_emmeans_diff_placebo_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/pt_emmeans_diff_placebo_2.csv", row.names = F)
...
pt_emmeans_diff_dapa_mod2 <- pt_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(pt_emmeans_diff_dapa_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(pt_emmeans_diff_dapa_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/pt_emmeans_diff_dapa_2.csv", row.names = F)
```
...
pt_emmeans_diff_DiD_mod2 <- pt_emmeans_diff_wide_mod2  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(pt_emmeans_diff_DiD_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(pt_emmeans_diff_DiD_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/pt_emmeans_diff_DiD_2.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(pt_emmeans_diff_placebo_mod2, "Expr p-value",
             "Model 2 PT Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/pt_placebo_pvalue_mod2")

plot_volcano(pt_emmeans_diff_placebo_mod2, "Expr False Discovery Rate", 
             "Model 2 PT Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/pt_placebo_adj_pvalue_mod2")
# Dapa
plot_volcano(pt_emmeans_diff_dapa_mod2, "Expr p-value",
             "Model 2 PT Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/pt_dapa_pvalue_mod2")

plot_volcano(pt_emmeans_diff_dapa_mod2, "Expr False Discovery Rate", 
             "Model 2 PT Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/pt_dapa_adj_pvalue_mod2")

# DiD
plot_volcano(pt_emmeans_diff_DiD_mod2, "Expr p-value", "Model 2 PT DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/pt_DiD_pvalue_mod2")

plot_volcano(pt_emmeans_diff_DiD_mod2, "Expr False Discovery Rate", "Model 2 PT DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/pt_DiD_adj_pvalue_mod2")
```
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# pt_placebo_pos <- (pt_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# pt_placebo_neg <- (pt_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# pt_dapa_pos <- (pt_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# pt_dapa_neg <- (pt_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
pt_DiD_pos_mod2 <- (pt_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
pt_DiD_neg_mod2 <- (pt_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# pt_gsea_placebo_pos_mod2 <- enrichr(pt_placebo_pos, dbs)
# # expected negative
# pt_gsea_placebo_neg_mod2 <- enrichr(pt_placebo_neg, dbs)
# # actual positive
# pt_gsea_dapa_pos_mod2 <- enrichr(pt_dapa_pos, dbs)
# # actual negative
# pt_gsea_dapa_neg_mod2 <- enrichr(pt_dapa_neg, dbs)
# DiD positive
pt_gsea_DiD_pos_mod2 <- enrichr(pt_DiD_pos_mod2, dbs)
# DiD negative
pt_gsea_DiD_neg_mod2 <- enrichr(pt_DiD_neg_mod2, dbs)

# pt_gsea_placebo_pos_mod2
# pt_gsea_placebo_neg_mod2
# pt_gsea_dapa_pos_mod2
# pt_gsea_dapa_neg_mod2
# pt_gsea_DiD_pos_mod2
# pt_gsea_DiD_neg_mod2
plotEnrich(as.data.frame(pt_gsea_DiD_pos_mod2[[1]]), title = "Model 2 Positive DiD - PT GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pt_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_pos_mod2[[2]]), title = "Model 2 Positive DiD - PT KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pt_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_pos_mod2[[3]]), title = "Model 2 Positive DiD - PT REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pt_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_pos_mod2[[4]]), title = "Model 2 Positive DiD - PT REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pt_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(pt_gsea_DiD_neg_mod2[[1]]), title = "Model 2 Negative DiD - PT GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pt_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_neg_mod2[[2]]), title = "Model 2 Negative DiD - PT KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pt_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_neg_mod2[[3]]), title = "Model 2 Negative DiD - PT REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pt_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_neg_mod2[[4]]), title = "Model 2 Negative DiD - PT REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pt_neg_DiD_gsea_reactome24.jpeg")
```
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
tal_model_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/tal_attempt_scrna_mm_model_combined_2.rds")

## read emmeans dataframe (rendered in Hyak)
tal_emmeans_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/tal_attempt_scrna_mm_emmeans_combined_2.rds")
```
...
tal_emmeans_diff_placebo_mod2 <- tal_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(tal_emmeans_diff_placebo_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(tal_emmeans_diff_placebo_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/tal_emmeans_diff_placebo_2.csv", row.names = F)
...
tal_emmeans_diff_dapa_mod2 <- tal_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(tal_emmeans_diff_dapa_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(tal_emmeans_diff_dapa_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/tal_emmeans_diff_dapa_2.csv", row.names = F)
```
...
tal_emmeans_diff_DiD_mod2 <- tal_emmeans_diff_wide_mod2  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(tal_emmeans_diff_DiD_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(tal_emmeans_diff_DiD_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/tal_emmeans_diff_DiD_2.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(tal_emmeans_diff_placebo_mod2, "Expr p-value",
             "Model 2 TAL Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/tal_placebo_pvalue_mod2")

plot_volcano(tal_emmeans_diff_placebo_mod2, "Expr False Discovery Rate", 
             "Model 2 TAL Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/tal_placebo_adj_pvalue_mod2")
# Dapa
plot_volcano(tal_emmeans_diff_dapa_mod2, "Expr p-value",
             "Model 2 TAL Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/tal_dapa_pvalue_mod2")

plot_volcano(tal_emmeans_diff_dapa_mod2, "Expr False Discovery Rate", 
             "Model 2 TAL Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/tal_dapa_adj_pvalue_mod2")

# DiD
plot_volcano(tal_emmeans_diff_DiD_mod2, "Expr p-value", "Model 2 TAL DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/tal_DiD_pvalue_mod2")

plot_volcano(tal_emmeans_diff_DiD_mod2, "Expr False Discovery Rate", "Model 2 TAL DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/tal_DiD_adj_pvalue_mod2")
```
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# tal_placebo_pos <- (tal_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# tal_placebo_neg <- (tal_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# tal_dapa_pos <- (tal_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# tal_dapa_neg <- (tal_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
tal_DiD_pos_mod2 <- (tal_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
tal_DiD_neg_mod2 <- (tal_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# tal_gsea_placebo_pos_mod2 <- enrichr(tal_placebo_pos, dbs)
# # expected negative
# tal_gsea_placebo_neg_mod2 <- enrichr(tal_placebo_neg, dbs)
# # actual positive
# tal_gsea_dapa_pos_mod2 <- enrichr(tal_dapa_pos, dbs)
# # actual negative
# tal_gsea_dapa_neg_mod2 <- enrichr(tal_dapa_neg, dbs)
# DiD positive
tal_gsea_DiD_pos_mod2 <- enrichr(tal_DiD_pos_mod2, dbs)
# DiD negative
tal_gsea_DiD_neg_mod2 <- enrichr(tal_DiD_neg_mod2, dbs)

# tal_gsea_placebo_pos_mod2
# tal_gsea_placebo_neg_mod2
# tal_gsea_dapa_pos_mod2
# tal_gsea_dapa_neg_mod2
# tal_gsea_DiD_pos_mod2
# tal_gsea_DiD_neg_mod2
plotEnrich(as.data.frame(tal_gsea_DiD_pos_mod2[[1]]), title = "Model 2 Positive DiD - TAL GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/tal_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_pos_mod2[[2]]), title = "Model 2 Positive DiD - TAL KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/tal_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_pos_mod2[[3]]), title = "Model 2 Positive DiD - TAL REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/tal_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_pos_mod2[[4]]), title = "Model 2 Positive DiD - TAL REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/tal_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(tal_gsea_DiD_neg_mod2[[1]]), title = "Model 2 Negative DiD - TAL GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/tal_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_neg_mod2[[2]]), title = "Model 2 Negative DiD - TAL KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/tal_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_neg_mod2[[3]]), title = "Model 2 Negative DiD - TAL REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/tal_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(tal_gsea_DiD_neg_mod2[[4]]), title = "Model 2 Negative DiD - TAL REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/tal_neg_DiD_gsea_reactome24.jpeg")
```
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
pc_model_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/pc_attempt_scrna_mm_model_combined_2.rds")

## read emmeans dataframe (rendered in Hyak)
pc_emmeans_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/pc_attempt_scrna_mm_emmeans_combined_2.rds")
```
...
pc_emmeans_diff_placebo_mod2 <- pc_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(pc_emmeans_diff_placebo_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(pc_emmeans_diff_placebo_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/pc_emmeans_diff_placebo_2.csv", row.names = F)
...
pc_emmeans_diff_dapa_mod2 <- pc_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(pc_emmeans_diff_dapa_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(pc_emmeans_diff_dapa_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/pc_emmeans_diff_dapa_2.csv", row.names = F)
```
...
pc_emmeans_diff_DiD_mod2 <- pc_emmeans_diff_wide_mod2  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(pc_emmeans_diff_DiD_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(pc_emmeans_diff_DiD_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/pc_emmeans_diff_DiD_2.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(pc_emmeans_diff_placebo_mod2, "Expr p-value",
             "Model 2 PC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/pc_placebo_pvalue_mod2")

plot_volcano(pc_emmeans_diff_placebo_mod2, "Expr False Discovery Rate", 
             "Model 2 PC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/pc_placebo_adj_pvalue_mod2")
# Dapa
plot_volcano(pc_emmeans_diff_dapa_mod2, "Expr p-value",
             "Model 2 PC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/pc_dapa_pvalue_mod2")

plot_volcano(pc_emmeans_diff_dapa_mod2, "Expr False Discovery Rate", 
             "Model 2 PC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/pc_dapa_adj_pvalue_mod2")

# DiD
plot_volcano(pc_emmeans_diff_DiD_mod2, "Expr p-value", "Model 2 PC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/pc_DiD_pvalue_mod2")

plot_volcano(pc_emmeans_diff_DiD_mod2, "Expr False Discovery Rate", "Model 2 PC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/pc_DiD_adj_pvalue_mod2")
```
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# pc_placebo_pos <- (pc_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# pc_placebo_neg <- (pc_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# pc_dapa_pos <- (pc_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# pc_dapa_neg <- (pc_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
pc_DiD_pos_mod2 <- (pc_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
pc_DiD_neg_mod2 <- (pc_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# pc_gsea_placebo_pos_mod2 <- enrichr(pc_placebo_pos, dbs)
# # expected negative
# pc_gsea_placebo_neg_mod2 <- enrichr(pc_placebo_neg, dbs)
# # actual positive
# pc_gsea_dapa_pos_mod2 <- enrichr(pc_dapa_pos, dbs)
# # actual negative
# pc_gsea_dapa_neg_mod2 <- enrichr(pc_dapa_neg, dbs)
# DiD positive
pc_gsea_DiD_pos_mod2 <- enrichr(pc_DiD_pos_mod2, dbs)
# DiD negative
pc_gsea_DiD_neg_mod2 <- enrichr(pc_DiD_neg_mod2, dbs)

# pc_gsea_placebo_pos_mod2
# pc_gsea_placebo_neg_mod2
# pc_gsea_dapa_pos_mod2
# pc_gsea_dapa_neg_mod2
# pc_gsea_DiD_pos_mod2
# pc_gsea_DiD_neg_mod2
plotEnrich(as.data.frame(pc_gsea_DiD_pos_mod2[[1]]), title = "Model 2 Positive DiD - PC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pc_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_pos_mod2[[2]]), title = "Model 2 Positive DiD - PC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pc_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_pos_mod2[[3]]), title = "Model 2 Positive DiD - PC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pc_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_pos_mod2[[4]]), title = "Model 2 Positive DiD - PC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pc_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(pc_gsea_DiD_neg_mod2[[1]]), title = "Model 2 Negative DiD - PC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pc_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_neg_mod2[[2]]), title = "Model 2 Negative DiD - PC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pc_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_neg_mod2[[3]]), title = "Model 2 Negative DiD - PC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pc_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(pc_gsea_DiD_neg_mod2[[4]]), title = "Model 2 Negative DiD - PC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/pc_neg_DiD_gsea_reactome24.jpeg")
```

### Immune (very few cells)
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
immune_model_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/immune_attempt_scrna_mm_model_combined_2.rds")

## read emmeans dataframe (rendered in Hyak)
immune_emmeans_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/immune_attempt_scrna_mm_emmeans_combined_2.rds")
```
...
immune_emmeans_diff_placebo_mod2 <- immune_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(immune_emmeans_diff_placebo_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(immune_emmeans_diff_placebo_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/immune_emmeans_diff_placebo_2.csv", row.names = F)
...
immune_emmeans_diff_dapa_mod2 <- immune_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(immune_emmeans_diff_dapa_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(immune_emmeans_diff_dapa_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/immune_emmeans_diff_dapa_2.csv", row.names = F)
```
...
immune_emmeans_diff_DiD_mod2 <- immune_emmeans_diff_wide_mod2  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(immune_emmeans_diff_DiD_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(immune_emmeans_diff_DiD_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/immune_emmeans_diff_DiD_2.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(immune_emmeans_diff_placebo_mod2, "Expr p-value",
             "Model 2 Immune Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/immune_placebo_pvalue_mod2")

plot_volcano(immune_emmeans_diff_placebo_mod2, "Expr False Discovery Rate", 
             "Model 2 Immune Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/immune_placebo_adj_pvalue_mod2")
# Dapa
plot_volcano(immune_emmeans_diff_dapa_mod2, "Expr p-value",
             "Model 2 Immune Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/immune_dapa_pvalue_mod2")

plot_volcano(immune_emmeans_diff_dapa_mod2, "Expr False Discovery Rate", 
             "Model 2 Immune Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/immune_dapa_adj_pvalue_mod2")

# DiD
plot_volcano(immune_emmeans_diff_DiD_mod2, "Expr p-value", "Model 2 Immune DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/immune_DiD_pvalue_mod2")

plot_volcano(immune_emmeans_diff_DiD_mod2, "Expr False Discovery Rate", "Model 2 Immune DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/immune_DiD_adj_pvalue_mod2")
```
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# immune_placebo_pos <- (immune_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# immune_placebo_neg <- (immune_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# immune_dapa_pos <- (immune_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# immune_dapa_neg <- (immune_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
immune_DiD_pos_mod2 <- (immune_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
immune_DiD_neg_mod2 <- (immune_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# immune_gsea_placebo_pos_mod2 <- enrichr(immune_placebo_pos, dbs)
# # expected negative
# immune_gsea_placebo_neg_mod2 <- enrichr(immune_placebo_neg, dbs)
# # actual positive
# immune_gsea_dapa_pos_mod2 <- enrichr(immune_dapa_pos, dbs)
# # actual negative
# immune_gsea_dapa_neg_mod2 <- enrichr(immune_dapa_neg, dbs)
# DiD positive
immune_gsea_DiD_pos_mod2 <- enrichr(immune_DiD_pos_mod2, dbs)
# DiD negative
immune_gsea_DiD_neg_mod2 <- enrichr(immune_DiD_neg_mod2, dbs)

# immune_gsea_placebo_pos_mod2
# immune_gsea_placebo_neg_mod2
# immune_gsea_dapa_pos_mod2
# immune_gsea_dapa_neg_mod2
# immune_gsea_DiD_pos_mod2
# immune_gsea_DiD_neg_mod2
plotEnrich(as.data.frame(immune_gsea_DiD_pos_mod2[[1]]), title = "Model 2 Positive DiD - Immune GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/immune_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_pos_mod2[[2]]), title = "Model 2 Positive DiD - Immune KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/immune_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_pos_mod2[[3]]), title = "Model 2 Positive DiD - Immune REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/immune_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_pos_mod2[[4]]), title = "Model 2 Positive DiD - Immune REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/immune_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(immune_gsea_DiD_neg_mod2[[1]]), title = "Model 2 Negative DiD - Immune GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/immune_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_neg_mod2[[2]]), title = "Model 2 Negative DiD - Immune KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/immune_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_neg_mod2[[3]]), title = "Model 2 Negative DiD - Immune REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/immune_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(immune_gsea_DiD_neg_mod2[[4]]), title = "Model 2 Negative DiD - Immune REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/immune_neg_DiD_gsea_reactome24.jpeg")
```

### IC
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
ic_model_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/ic_attempt_scrna_mm_model_combined_2.rds")

## read emmeans dataframe (rendered in Hyak)
ic_emmeans_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/ic_attempt_scrna_mm_emmeans_combined_2.rds")
```
...
ic_emmeans_diff_placebo_mod2 <- ic_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(ic_emmeans_diff_placebo_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(ic_emmeans_diff_placebo_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/ic_emmeans_diff_placebo_2.csv", row.names = F)
...
ic_emmeans_diff_dapa_mod2 <- ic_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(ic_emmeans_diff_dapa_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(ic_emmeans_diff_dapa_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/ic_emmeans_diff_dapa_2.csv", row.names = F)
```
...
ic_emmeans_diff_DiD_mod2 <- ic_emmeans_diff_wide_mod2  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(ic_emmeans_diff_DiD_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(ic_emmeans_diff_DiD_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/ic_emmeans_diff_DiD_2.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(ic_emmeans_diff_placebo_mod2, "Expr p-value",
             "Model 2 IC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/ic_placebo_pvalue_mod2")

plot_volcano(ic_emmeans_diff_placebo_mod2, "Expr False Discovery Rate", 
             "Model 2 IC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/ic_placebo_adj_pvalue_mod2")
# Dapa
plot_volcano(ic_emmeans_diff_dapa_mod2, "Expr p-value",
             "Model 2 IC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/ic_dapa_pvalue_mod2")

plot_volcano(ic_emmeans_diff_dapa_mod2, "Expr False Discovery Rate", 
             "Model 2 IC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/ic_dapa_adj_pvalue_mod2")

# DiD
plot_volcano(ic_emmeans_diff_DiD_mod2, "Expr p-value", "Model 2 IC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/ic_DiD_pvalue_mod2")

plot_volcano(ic_emmeans_diff_DiD_mod2, "Expr False Discovery Rate", "Model 2 IC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/ic_DiD_adj_pvalue_mod2")
```
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# ic_placebo_pos <- (ic_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# ic_placebo_neg <- (ic_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# ic_dapa_pos <- (ic_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# ic_dapa_neg <- (ic_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
ic_DiD_pos_mod2 <- (ic_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
ic_DiD_neg_mod2 <- (ic_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# ic_gsea_placebo_pos_mod2 <- enrichr(ic_placebo_pos, dbs)
# # expected negative
# ic_gsea_placebo_neg_mod2 <- enrichr(ic_placebo_neg, dbs)
# # actual positive
# ic_gsea_dapa_pos_mod2 <- enrichr(ic_dapa_pos, dbs)
# # actual negative
# ic_gsea_dapa_neg_mod2 <- enrichr(ic_dapa_neg, dbs)
# DiD positive
ic_gsea_DiD_pos_mod2 <- enrichr(ic_DiD_pos_mod2, dbs)
# DiD negative
ic_gsea_DiD_neg_mod2 <- enrichr(ic_DiD_neg_mod2, dbs)

# ic_gsea_placebo_pos_mod2
# ic_gsea_placebo_neg_mod2
# ic_gsea_dapa_pos_mod2
# ic_gsea_dapa_neg_mod2
# ic_gsea_DiD_pos_mod2
# ic_gsea_DiD_neg_mod2
plotEnrich(as.data.frame(ic_gsea_DiD_pos_mod2[[1]]), title = "Model 2 Positive DiD - IC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ic_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_pos_mod2[[2]]), title = "Model 2 Positive DiD - IC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ic_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_pos_mod2[[3]]), title = "Model 2 Positive DiD - IC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ic_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_pos_mod2[[4]]), title = "Model 2 Positive DiD - IC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ic_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(ic_gsea_DiD_neg_mod2[[1]]), title = "Model 2 Negative DiD - IC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ic_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_neg_mod2[[2]]), title = "Model 2 Negative DiD - IC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ic_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_neg_mod2[[3]]), title = "Model 2 Negative DiD - IC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ic_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(ic_gsea_DiD_neg_mod2[[4]]), title = "Model 2 Negative DiD - IC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ic_neg_DiD_gsea_reactome24.jpeg")
```
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
ec_model_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/ec_attempt_scrna_mm_model_combined_2.rds")

## read emmeans dataframe (rendered in Hyak)
ec_emmeans_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/ec_attempt_scrna_mm_emmeans_combined_2.rds")
```
...
ec_emmeans_diff_placebo_mod2 <- ec_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(ec_emmeans_diff_placebo_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(ec_emmeans_diff_placebo_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/ec_emmeans_diff_placebo_2.csv", row.names = F)
...
ec_emmeans_diff_dapa_mod2 <- ec_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(ec_emmeans_diff_dapa_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(ec_emmeans_diff_dapa_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/ec_emmeans_diff_dapa_2.csv", row.names = F)
```
...
ec_emmeans_diff_DiD_mod2 <- ec_emmeans_diff_wide_mod2  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(ec_emmeans_diff_DiD_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(ec_emmeans_diff_DiD_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/ec_emmeans_diff_DiD_2.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(ec_emmeans_diff_placebo_mod2, "Expr p-value",
             "Model 2 EC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/ec_placebo_pvalue_mod2")

plot_volcano(ec_emmeans_diff_placebo_mod2, "Expr False Discovery Rate", 
             "Model 2 EC Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/ec_placebo_adj_pvalue_mod2")
# Dapa
plot_volcano(ec_emmeans_diff_dapa_mod2, "Expr p-value",
             "Model 2 EC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/ec_dapa_pvalue_mod2")

plot_volcano(ec_emmeans_diff_dapa_mod2, "Expr False Discovery Rate", 
             "Model 2 EC Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/ec_dapa_adj_pvalue_mod2")

# DiD
plot_volcano(ec_emmeans_diff_DiD_mod2, "Expr p-value", "Model 2 EC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/ec_DiD_pvalue_mod2")

plot_volcano(ec_emmeans_diff_DiD_mod2, "Expr False Discovery Rate", "Model 2 EC DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/ec_DiD_adj_pvalue_mod2")
```
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# ec_placebo_pos <- (ec_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# ec_placebo_neg <- (ec_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# ec_dapa_pos <- (ec_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# ec_dapa_neg <- (ec_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
ec_DiD_pos_mod2 <- (ec_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
ec_DiD_neg_mod2 <- (ec_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# ec_gsea_placebo_pos_mod2 <- enrichr(ec_placebo_pos, dbs)
# # expected negative
# ec_gsea_placebo_neg_mod2 <- enrichr(ec_placebo_neg, dbs)
# # actual positive
# ec_gsea_dapa_pos_mod2 <- enrichr(ec_dapa_pos, dbs)
# # actual negative
# ec_gsea_dapa_neg_mod2 <- enrichr(ec_dapa_neg, dbs)
# DiD positive
ec_gsea_DiD_pos_mod2 <- enrichr(ec_DiD_pos_mod2, dbs)
# DiD negative
ec_gsea_DiD_neg_mod2 <- enrichr(ec_DiD_neg_mod2, dbs)

# ec_gsea_placebo_pos_mod2
# ec_gsea_placebo_neg_mod2
# ec_gsea_dapa_pos_mod2
# ec_gsea_dapa_neg_mod2
# ec_gsea_DiD_pos_mod2
# ec_gsea_DiD_neg_mod2
plotEnrich(as.data.frame(ec_gsea_DiD_pos_mod2[[1]]), title = "Model 2 Positive DiD - EC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ec_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_pos_mod2[[2]]), title = "Model 2 Positive DiD - EC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ec_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_pos_mod2[[3]]), title = "Model 2 Positive DiD - EC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ec_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_pos_mod2[[4]]), title = "Model 2 Positive DiD - EC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ec_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(ec_gsea_DiD_neg_mod2[[1]]), title = "Model 2 Negative DiD - EC GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ec_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_neg_mod2[[2]]), title = "Model 2 Negative DiD - EC KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ec_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_neg_mod2[[3]]), title = "Model 2 Negative DiD - EC REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ec_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(ec_gsea_DiD_neg_mod2[[4]]), title = "Model 2 Negative DiD - EC REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/ec_neg_DiD_gsea_reactome24.jpeg")
```

### DTL (very few cells)
```{r echo = F, eval = F}
## read mixed model results dataframe (rendered in Hyak)
dtl_model_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/dtl_attempt_scrna_mm_model_combined_2.rds")

## read emmeans dataframe (rendered in Hyak)
dtl_emmeans_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/dtl_attempt_scrna_mm_emmeans_combined_2.rds")
```
...
dtl_emmeans_diff_placebo_mod2 <- dtl_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(dtl_emmeans_diff_placebo_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
## write.csv(dtl_emmeans_diff_placebo_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/dtl_emmeans_diff_placebo_2.csv", row.names = F)
...
dtl_emmeans_diff_dapa_mod2 <- dtl_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(dtl_emmeans_diff_dapa_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
## write.csv(dtl_emmeans_diff_dapa_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/dtl_emmeans_diff_dapa_2.csv", row.names = F)
```
...
dtl_emmeans_diff_DiD_mod2 <- dtl_emmeans_diff_wide_mod2  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(dtl_emmeans_diff_DiD_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
## write.csv(dtl_emmeans_diff_DiD_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/dtl_emmeans_diff_DiD_2.csv", row.names = F)
```
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
fibvsmcp_model_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/fibvsmcp_attempt_scrna_mm_model_combined_2.rds")

## read emmeans dataframe (rendered in Hyak)
fibvsmcp_emmeans_df_mod2 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/2 Zero inflation and no nested visit/fibvsmcp_attempt_scrna_mm_emmeans_combined_2.rds")
```
...
fibvsmcp_emmeans_diff_placebo_mod2 <- fibvsmcp_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(fibvsmcp_emmeans_diff_placebo_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(fibvsmcp_emmeans_diff_placebo_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/fibvsmcp_emmeans_diff_placebo_2.csv", row.names = F)
...
fibvsmcp_emmeans_diff_dapa_mod2 <- fibvsmcp_emmeans_diff_mod2 %>%
  ...
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(fibvsmcp_emmeans_diff_dapa_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(fibvsmcp_emmeans_diff_dapa_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/fibvsmcp_emmeans_diff_dapa_2.csv", row.names = F)
```
...
fibvsmcp_emmeans_diff_DiD_mod2 <- fibvsmcp_emmeans_diff_wide_mod2  %>%
  ...
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(fibvsmcp_emmeans_diff_DiD_mod2) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(fibvsmcp_emmeans_diff_DiD_mod2, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/2 Zero inflation and no nested visit/fibvsmcp_emmeans_diff_DiD_2.csv", row.names = F)
```
...
```{r echo = F}
# Placebo
plot_volcano(fibvsmcp_emmeans_diff_placebo_mod2, "Expr p-value",
             "Model 2 FIB/VSMC/P Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/fibvsmcp_placebo_pvalue_mod2")

plot_volcano(fibvsmcp_emmeans_diff_placebo_mod2, "Expr False Discovery Rate", 
             "Model 2 FIB/VSMC/P Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/fibvsmcp_placebo_adj_pvalue_mod2")
# Dapa
plot_volcano(fibvsmcp_emmeans_diff_dapa_mod2, "Expr p-value",
             "Model 2 FIB/VSMC/P Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/fibvsmcp_dapa_pvalue_mod2")

plot_volcano(fibvsmcp_emmeans_diff_dapa_mod2, "Expr False Discovery Rate", 
             "Model 2 FIB/VSMC/P Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/fibvsmcp_dapa_adj_pvalue_mod2")

# DiD
plot_volcano(fibvsmcp_emmeans_diff_DiD_mod2, "Expr p-value", "Model 2 FIB/VSMC/P DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "2 Zero inflation and no nested visit/fibvsmcp_DiD_pvalue_mod2")

plot_volcano(fibvsmcp_emmeans_diff_DiD_mod2, "Expr False Discovery Rate", "Model 2 FIB/VSMC/P DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "2 Zero inflation and no nested visit/fibvsmcp_DiD_adj_pvalue_mod2")
```
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# fibvsmcp_placebo_pos <- (fibvsmcp_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# fibvsmcp_placebo_neg <- (fibvsmcp_emmeans_diff_placebo_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# fibvsmcp_dapa_pos <- (fibvsmcp_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# fibvsmcp_dapa_neg <- (fibvsmcp_emmeans_diff_dapa_mod2 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
fibvsmcp_DiD_pos_mod2 <- (fibvsmcp_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
fibvsmcp_DiD_neg_mod2 <- (fibvsmcp_emmeans_diff_DiD_mod2 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# fibvsmcp_gsea_placebo_pos_mod2 <- enrichr(fibvsmcp_placebo_pos, dbs)
# # expected negative
# fibvsmcp_gsea_placebo_neg_mod2 <- enrichr(fibvsmcp_placebo_neg, dbs)
# # actual positive
# fibvsmcp_gsea_dapa_pos_mod2 <- enrichr(fibvsmcp_dapa_pos, dbs)
# # actual negative
# fibvsmcp_gsea_dapa_neg_mod2 <- enrichr(fibvsmcp_dapa_neg, dbs)
# DiD positive
fibvsmcp_gsea_DiD_pos_mod2 <- enrichr(fibvsmcp_DiD_pos_mod2, dbs)
# DiD negative
fibvsmcp_gsea_DiD_neg_mod2 <- enrichr(fibvsmcp_DiD_neg_mod2, dbs)

# fibvsmcp_gsea_placebo_pos_mod2
# fibvsmcp_gsea_placebo_neg_mod2
# fibvsmcp_gsea_dapa_pos_mod2
# fibvsmcp_gsea_dapa_neg_mod2
# fibvsmcp_gsea_DiD_pos_mod2
# fibvsmcp_gsea_DiD_neg_mod2
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_pos_mod2[[1]]), title = "Model 2 Positive DiD - FIB/VSMC/P GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/fibvsmcp_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_pos_mod2[[2]]), title = "Model 2 Positive DiD - FIB/VSMC/P KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/fibvsmcp_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_pos_mod2[[3]]), title = "Model 2 Positive DiD - FIB/VSMC/P REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/fibvsmcp_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_pos_mod2[[4]]), title = "Model 2 Positive DiD - FIB/VSMC/P REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/fibvsmcp_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_neg_mod2[[1]]), title = "Model 2 Negative DiD - FIB/VSMC/P GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/fibvsmcp_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_neg_mod2[[2]]), title = "Model 2 Negative DiD - FIB/VSMC/P KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/fibvsmcp_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_neg_mod2[[3]]), title = "Model 2 Negative DiD - FIB/VSMC/P REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/fibvsmcp_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(fibvsmcp_gsea_DiD_neg_mod2[[4]]), title = "Model 2 Negative DiD - FIB/VSMC/P REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/2 Zero inflation and no nested visit/fibvsmcp_neg_DiD_gsea_reactome24.jpeg")
```
...
pt_placebo_mod2 <- read_excel("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/IPA/2 Zero inflation and no nested visit/pt_placebo_pathways_2.xls", skip = 1) 
...
colnames(pt_placebo_mod2) <- c("pathway", "neg_log_p_placebo", "ratio_placebo", "z_placebo", "genes_placebo")

pt_pathways_merged_mod2 <- pt_pathways_mod2 %>%
  full_join(pt_dapa_mod2) %>% full_join(pt_placebo_mod2) %>%
  dplyr::select(pathway, neg_log_p, z, neg_log_p_dapa, z_dapa, neg_log_p_placebo, z_placebo) %>%
  mutate(scenario = case_when(
    z_dapa > 0 & z_placebo > 0 & z_placebo < z_dapa ~ "Activated in both, more in D",
    z_dapa > 0 & z_placebo > 0 & z_placebo > z_dapa ~ "Activated in both, less in D",
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/pt_top30_inhibited_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
##                                left = 0.45, bottom = 0.01,
##                                right = 0.80, top = 0.6)
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/pt_top_inhibited_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/pt_top30_activated_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/pt_top_activated_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
pt_neg_pathways_merged_long_mod2 %>%
  ...
  guides(alpha = "none") +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgray")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/pt_top10_inhibited_pathway_zscores_mod2.jpeg",
       scale = 1.5)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/pt_top10_activated_pathway_zscores_mod2.jpeg",
       scale = 1.5)
```
...
tal_placebo_mod2 <- read_excel("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/IPA/2 Zero inflation and no nested visit/tal_placebo_pathways_2.xls", skip = 1) 
...
colnames(tal_placebo_mod2) <- c("pathway", "neg_log_p_placebo", "ratio_placebo", "z_placebo", "genes_placebo")

tal_pathways_merged_mod2 <- tal_pathways_mod2 %>%
  full_join(tal_dapa_mod2) %>% full_join(tal_placebo_mod2) %>%
  dplyr::select(pathway, neg_log_p, z, neg_log_p_dapa, z_dapa, neg_log_p_placebo, z_placebo)  %>%
  dplyr::select(pathway, neg_log_p, z, neg_log_p_dapa, z_dapa, neg_log_p_placebo, z_placebo) %>%
  mutate(scenario = case_when(
    z_dapa > 0 & z_placebo > 0 & z_placebo < z_dapa ~ "Activated in both, more in D",
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/tal_top30_inhibited_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/tal_top_inhibited_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/tal_top30_activated_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/tal_top_activated_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
#### Z-Score Bar charts
```{r echo = F, warning = F}
...
tal_neg_pathways_merged_long_mod2 %>%
  ...
  guides(alpha = "none") +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgray")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/tal_top10_inhibited_pathway_zscores_mod2.jpeg",
       scale = 1.5)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/tal_top10_activated_pathway_zscores_mod2.jpeg",
       scale = 1.5)
```
...
pc_placebo_mod2 <- read_excel("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/IPA/2 Zero inflation and no nested visit/pc_placebo_pathways_2.xls", skip = 1) 
...
colnames(pc_placebo_mod2) <- c("pathway", "neg_log_p_placebo", "ratio_placebo", "z_placebo", "genes_placebo")

pc_pathways_merged_mod2 <- pc_pathways_mod2 %>%
  full_join(pc_dapa_mod2) %>% full_join(pc_placebo_mod2) %>%
  dplyr::select(pathway, neg_log_p, z, neg_log_p_dapa, z_dapa, neg_log_p_placebo, z_placebo) %>%
  mutate(scenario = case_when(
    z_dapa > 0 & z_placebo > 0 & z_placebo < z_dapa ~ "Activated in both, more in D",
    z_dapa > 0 & z_placebo > 0 & z_placebo > z_dapa ~ "Activated in both, less in D",
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/pc_top30_inhibited_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/pc_top_inhibited_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/pc_top30_activated_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/pc_top_activated_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
#### Z-Score Bar charts
```{r echo = F, warning = F}
...
pc_neg_pathways_merged_long_mod2 %>%
  ...
  guides(alpha = "none") +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgray")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/pc_top10_inhibited_pathway_zscores_mod2.jpeg",
       scale = 1.5)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/pc_top10_activated_pathway_zscores_mod2.jpeg",
       scale = 1.5)
```
...
immune_placebo_mod2 <- read_excel("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/IPA/2 Zero inflation and no nested visit/immune_placebo_pathways_2.xls", skip = 1) 
...
colnames(immune_placebo_mod2) <- c("pathway", "neg_log_p_placebo", "ratio_placebo", "z_placebo", "genes_placebo")

immune_pathways_merged_mod2 <- immune_pathways_mod2 %>%
  full_join(immune_dapa_mod2) %>% full_join(immune_placebo_mod2) %>%
  dplyr::select(pathway, neg_log_p, z, neg_log_p_dapa, z_dapa, neg_log_p_placebo, z_placebo) %>%
  mutate(scenario = case_when(
    z_dapa > 0 & z_placebo > 0 & z_placebo < z_dapa ~ "Activated in both, more in D",
    z_dapa > 0 & z_placebo > 0 & z_placebo > z_dapa ~ "Activated in both, less in D",
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/immune_top30_inhibited_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/immune_top_inhibited_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/immune_top30_activated_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/immune_top_activated_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
#### Z-Score Bar charts
```{r echo = F, warning = F}
...
immune_neg_pathways_merged_long_mod2 %>%
  ...
  guides(alpha = "none") +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgray")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/immune_top10_inhibited_pathway_zscores_mod2.jpeg",
       scale = 1.5)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/immune_top10_activated_pathway_zscores_mod2.jpeg",
       scale = 1.5)
```
...
ic_placebo_mod2 <- read_excel("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/IPA/2 Zero inflation and no nested visit/ic_placebo_pathways_2.xls", skip = 1) 
...
colnames(ic_placebo_mod2) <- c("pathway", "neg_log_p_placebo", "ratio_placebo", "z_placebo", "genes_placebo")

ic_pathways_merged_mod2 <- ic_pathways_mod2 %>%
  full_join(ic_dapa_mod2) %>% full_join(ic_placebo_mod2) %>%
  dplyr::select(pathway, neg_log_p, z, neg_log_p_dapa, z_dapa, neg_log_p_placebo, z_placebo) %>%
  mutate(scenario = case_when(
    z_dapa > 0 & z_placebo > 0 & z_placebo < z_dapa ~ "Activated in both, more in D",
    z_dapa > 0 & z_placebo > 0 & z_placebo > z_dapa ~ "Activated in both, less in D",
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/ic_top30_inhibited_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/ic_top_inhibited_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/ic_top30_activated_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/ic_top_activated_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
ic_neg_pathways_merged_long_mod2 %>%
  ...
  guides(alpha = "none") +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgray")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/ic_top10_inhibited_pathway_zscores_mod2.jpeg",
       scale = 1.5)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/ic_top10_activated_pathway_zscores_mod2.jpeg",
       scale = 1.5)
```
...
ec_placebo_mod2 <- read_excel("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/IPA/2 Zero inflation and no nested visit/ec_placebo_pathways_2.xls", skip = 1) 
...
colnames(ec_placebo_mod2) <- c("pathway", "neg_log_p_placebo", "ratio_placebo", "z_placebo", "genes_placebo")

ec_pathways_merged_mod2 <- ec_pathways_mod2 %>%
  full_join(ec_dapa_mod2) %>% full_join(ec_placebo_mod2) %>%
  dplyr::select(pathway, neg_log_p, z, neg_log_p_dapa, z_dapa, neg_log_p_placebo, z_placebo) %>%
  mutate(scenario = case_when(
    z_dapa > 0 & z_placebo > 0 & z_placebo < z_dapa ~ "Activated in both, more in D",
    z_dapa > 0 & z_placebo > 0 & z_placebo > z_dapa ~ "Activated in both, less in D",
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/ec_top30_inhibited_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/ec_top_inhibited_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/ec_top30_activated_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/ec_top_activated_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
#### Z-Score Bar charts
```{r echo = F, warning = F}
...
ec_neg_pathways_merged_long_mod2 %>%
  ...
  guides(alpha = "none") +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgray")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/ec_top10_inhibited_pathway_zscores_mod2.jpeg",
       scale = 1.5)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/ec_top10_activated_pathway_zscores_mod2.jpeg",
       scale = 1.5)
```
...
dtl_placebo_mod2 <- read_excel("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/IPA/2 Zero inflation and no nested visit/dtl_placebo_pathways_2.xls", skip = 1) 
...
colnames(dtl_placebo_mod2) <- c("pathway", "neg_log_p_placebo", "ratio_placebo", "z_placebo", "genes_placebo")

dtl_pathways_merged_mod2 <- dtl_pathways_mod2 %>%
  full_join(dtl_dapa_mod2) %>% full_join(dtl_placebo_mod2) %>%
  dplyr::select(pathway, neg_log_p, z, neg_log_p_dapa, z_dapa, neg_log_p_placebo, z_placebo) %>%
  mutate(scenario = case_when(
    z_dapa > 0 & z_placebo > 0 & z_placebo < z_dapa ~ "Activated in both, more in D",
    z_dapa > 0 & z_placebo > 0 & z_placebo > z_dapa ~ "Activated in both, less in D",
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/dtl_top30_inhibited_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
##   scale_y_discrete(expand = expansion(mult = c(0.5, 0.01))) 
## 
## ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/dtl_top_inhibited_pathways_2_mod2.jpeg",
##        width = 27.5, height = 10, scale = 1)
```
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/dtl_top30_activated_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/dtl_top_activated_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
dtl_neg_pathways_merged_long_mod2 %>%
  ...
  guides(alpha = "none") +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgray")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/dtl_top10_inhibited_pathway_zscores_mod2.jpeg",
       scale = 1.5)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/dtl_top10_activated_pathway_zscores_mod2.jpeg",
       scale = 1.5)
```
...
fibvsmcp_placebo_mod2 <- read_excel("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/IPA/2 Zero inflation and no nested visit/fibvsmcp_placebo_pathways_2.xls", skip = 1) 
...
colnames(fibvsmcp_placebo_mod2) <- c("pathway", "neg_log_p_placebo", "ratio_placebo", "z_placebo", "genes_placebo")

fibvsmcp_pathways_merged_mod2 <- fibvsmcp_pathways_mod2 %>%
  full_join(fibvsmcp_dapa_mod2) %>% full_join(fibvsmcp_placebo_mod2) %>%
  dplyr::select(pathway, neg_log_p, z, neg_log_p_dapa, z_dapa, neg_log_p_placebo, z_placebo) %>%
  mutate(scenario = case_when(
    z_dapa > 0 & z_placebo > 0 & z_placebo < z_dapa ~ "Activated in both, more in D",
    z_dapa > 0 & z_placebo > 0 & z_placebo > z_dapa ~ "Activated in both, less in D",
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/fibvsmcp_top30_inhibited_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/fibvsmcp_top_inhibited_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/fibvsmcp_top30_activated_pathways_mod2.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/fibvsmcp_top_activated_pathways_2_mod2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
fibvsmcp_neg_pathways_merged_long_mod2 %>%
  ...
  guides(alpha = "none") +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgray")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/fibvsmcp_top10_inhibited_pathway_zscores_mod2.jpeg",
       scale = 1.5)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/2 Zero inflation and no nested visit/fibvsmcp_top10_activated_pathway_zscores_mod2.jpeg",
       scale = 1.5)
```
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
pt_model_df_mod3 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/3 Nested visit and no zero inflation/pt_attempt_scrna_mm_model_combined_3.rds")

## read emmeans dataframe (rendered in Hyak)
pt_emmeans_df_mod3 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/kopah/3 Nested visit and no zero inflation/pt_attempt_scrna_mm_emmeans_combined_3.rds")
```

```{r echo = F}
## keep converged model results only
pt_model_filtered_mod3 <- pt_model_df_mod3 %>%
  group_by(Gene) %>%
  filter(all(!is.na(PValue)))

pt_emmeans_filtered_mod3 <- pt_emmeans_df_mod3 %>%
  filter(Gene %in% pt_model_filtered_mod3$Gene) %>%
  group_by(Gene) %>%
  filter(all(!is.na(SE)))

## non-converged genes percentage
pt_nonconverged_genes_mod3 <- unique((pt_model_df_mod3 %>%
  group_by(Gene) %>%
  filter(all(is.na(PValue))))$Gene)
pt_nonconverged_percentage_mod3 <- (length(unique(pt_nonconverged_genes_mod3))/length(unique(pt_model_df_mod3$Gene)))*100
```

```{r echo = F}
## arrange the model based on significance of interaction term in model
ordered_model_mod3 <- subset(pt_model_filtered_mod3, Variable == "TreatmentDapagliflozin:VisitPOST") %>%
  arrange(PValue)
gene_order <- factor(ordered_model_mod3$Gene, levels = ordered_model_mod3$Gene)
sig_genes <- subset(pt_model_filtered_mod3, Variable == "TreatmentDapagliflozin:VisitPOST" & PValue < 0.05)$Gene
```

```{r echo =F}
## compute emmean difference in POST - PRE in each treatment group
pt_emmeans_diff_mod3 <- pt_emmeans_filtered_mod3 %>%
  pivot_wider(names_from = Visit, values_from = c(emmean, SE)) %>%
  group_by(Treatment, Gene) %>%
  fill(ends_with("PRE"), ends_with("POST")) %>%
  mutate(diff_emmean = emmean_POST - emmean_PRE,
...
### Placebo
pt_emmeans_diff_placebo_mod3 <- pt_emmeans_diff_mod3 %>%
  filter(Treatment == "Placebo") %>%
  ungroup() %>%
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(pt_emmeans_diff_placebo_mod3) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(pt_emmeans_diff_placebo_mod3, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/3 Nested visit and no zero inflation/pt_emmeans_diff_placebo_3.csv", row.names = F)

### Dapa
pt_emmeans_diff_dapa_mod3 <- pt_emmeans_diff_mod3 %>%
  filter(Treatment == "Dapagliflozin") %>%
  ungroup() %>%
  mutate(q_value = p.adjust(p_value, method = "fdr")) %>%
  dplyr::select(Gene, diff_emmean, p_value, q_value)
colnames(pt_emmeans_diff_dapa_mod3) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")
write.csv(pt_emmeans_diff_dapa_mod3, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/3 Nested visit and no zero inflation/pt_emmeans_diff_dapa_3.csv", row.names = F)
```

```{r echo = F}
## DiD (Differences in Differences)
pt_emmeans_diff_wide_mod3  <- pt_emmeans_diff_mod3 %>%
  pivot_wider(names_from = Treatment, values_from = c(diff_emmean, SE_diff))

pt_emmeans_diff_DiD_mod3_raw <- pt_emmeans_diff_wide_mod3  %>%
  group_by(Gene) %>%
  fill(ends_with("Placebo"), ends_with("Dapagliflozin")) %>%
  dplyr::mutate(DiD = diff_emmean_Dapagliflozin - diff_emmean_Placebo,
         SE_DiD = sqrt(SE_diff_Dapagliflozin^2 + SE_diff_Placebo^2),  ## SE computation
         t_stat_DiD = DiD / SE_DiD,  ## t-statistic
         p_value_DiD = safe_pval(t_stat_DiD, nrow(pt_emmeans_diff_mod3))) %>%
  dplyr::select(Gene, diff_emmean_Dapagliflozin,diff_emmean_Placebo, DiD, SE_DiD, t_stat_DiD, p_value_DiD) %>%
  filter(!is.na(DiD)) %>%
  ungroup() %>%
  mutate(q_value = p.adjust(p_value_DiD, method = "fdr")) 

pt_emmeans_diff_DiD_mod3 <- pt_emmeans_diff_DiD_mod3_raw %>%
  dplyr::select(Gene, DiD, p_value_DiD, q_value)
colnames(pt_emmeans_diff_DiD_mod3) <- c("Gene", "Expr Other", "Expr p-value", "Expr False Discovery Rate")

### Save for IPA
write.csv(pt_emmeans_diff_DiD_mod3, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Data Clean/emmeans/3 Nested visit and no zero inflation/pt_emmeans_diff_DiD_3.csv", row.names = F)
```

#### Top genes delta plot
```{r echo = F}
pt_emmeans_diff_mod3 %>%
  filter(interaction_significance == "p<0.05") %>%
  filter(Gene %in% gene_order[1:10]) %>%
  ggplot(aes(x = Gene, y = diff_emmean, color = Treatment)) +
    geom_pointrange(aes(ymin = diff_lowerCL, ymax = diff_upperCL, alpha = 0.8),
...
```{r echo = F}
# Placebo
plot_volcano(pt_emmeans_diff_placebo_mod3, "Expr p-value",
             "Model 3 PT Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "3 Nested visit and no zero inflation/pt_placebo_pvalue_mod3")

plot_volcano(pt_emmeans_diff_placebo_mod3, "Expr False Discovery Rate", 
             "Model 3 PT Placebo", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "3 Nested visit and no zero inflation/pt_placebo_adj_pvalue_mod3")
# Dapa
plot_volcano(pt_emmeans_diff_dapa_mod3, "Expr p-value",
             "Model 3 PT Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(p-value)",
             "3 Nested visit and no zero inflation/pt_dapa_pvalue_mod3")

plot_volcano(pt_emmeans_diff_dapa_mod3, "Expr False Discovery Rate", 
             "Model 3 PT Dapagliflozin", 
             "EMM Delta (POST - PRE)", 
             "-log10(adj.p-value)",
             "3 Nested visit and no zero inflation/pt_dapa_adj_pvalue_mod3")

# DiD
plot_volcano(pt_emmeans_diff_DiD_mod3, "Expr p-value", "Model 3 PT DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(p-value)",
             "3 Nested visit and no zero inflation/pt_DiD_pvalue_mod3")

plot_volcano(pt_emmeans_diff_DiD_mod3, "Expr False Discovery Rate", "Model 3 PT DiD", 
             "DiD (Dapagliflozin - Placebo)", 
             "-log10(adj.p-value)",
             "3 Nested visit and no zero inflation/pt_DiD_adj_pvalue_mod3")

# Counts
# Total, p-value, q-value
pt_mod3_tot_pos <- nrow(pt_emmeans_diff_DiD_mod3 %>% filter(`Expr Other` > 0))
pt_mod3_tot_neg <- nrow(pt_emmeans_diff_DiD_mod3 %>% filter(`Expr Other` < 0))
pt_mod3_sig_pos <- nrow(pt_emmeans_diff_DiD_mod3 %>% filter(`Expr Other` > 0) %>% filter(`Expr p-value` < 0.05))
pt_mod3_sig_neg <- nrow(pt_emmeans_diff_DiD_mod3 %>% filter(`Expr Other` < 0) %>% filter(`Expr p-value` < 0.05))
pt_mod3_adj_sig_pos <- nrow(pt_emmeans_diff_DiD_mod3 %>% filter(`Expr Other` > 0) %>% filter(`Expr False Discovery Rate` < 0.05))
pt_mod3_adj_sig_neg <- nrow(pt_emmeans_diff_DiD_mod3 %>% filter(`Expr Other` < 0) %>% filter(`Expr False Discovery Rate` < 0.05))

pt_mod3_count <- data.frame(total = c(pt_mod3_tot_pos, pt_mod3_tot_neg),
                            pvalue = c(pt_mod3_sig_pos, pt_mod3_sig_neg),
                            fdr = c(pt_mod3_adj_sig_pos, pt_mod3_adj_sig_neg))
rownames(pt_mod3_count) <- c("Positive", "Negative")
kable(pt_mod3_count, col.names = c("Total", "P < 0.05", "P < 0.05 (FDR)"))
...
# enrichment analysis
# # significant positive in placebo (expected positive)
# pt_placebo_pos <- (pt_emmeans_diff_placebo_mod3 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in placebo (expected negative)
# pt_placebo_neg <- (pt_emmeans_diff_placebo_mod3 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# # significant positive in dapa (actual positive)
# pt_dapa_pos <- (pt_emmeans_diff_dapa_mod3 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` > 0))$Gene
# # significant negative in dapa (actual negative)
# pt_dapa_neg <- (pt_emmeans_diff_dapa_mod3 %>% filter(`Expr p-value` < 0.01) %>%
#                   filter(`Expr Other` < 0))$Gene
# significant positive in DiD
pt_DiD_pos_mod3 <- (pt_emmeans_diff_DiD_mod3 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` > 0))$Gene
# significant negative in DiD
pt_DiD_neg_mod3 <- (pt_emmeans_diff_DiD_mod3 %>% filter(`Expr p-value` < 0.01) %>%
                  filter(`Expr Other` < 0))$Gene

# # expected positive
# pt_gsea_placebo_pos_mod3 <- enrichr(pt_placebo_pos, dbs)
# # expected negative
# pt_gsea_placebo_neg_mod3 <- enrichr(pt_placebo_neg, dbs)
# # actual positive
# pt_gsea_dapa_pos_mod3 <- enrichr(pt_dapa_pos, dbs)
# # actual negative
# pt_gsea_dapa_neg_mod3 <- enrichr(pt_dapa_neg, dbs)
# DiD positive
pt_gsea_DiD_pos_mod3 <- enrichr(pt_DiD_pos_mod3, dbs)
# DiD negative
pt_gsea_DiD_neg_mod3 <- enrichr(pt_DiD_neg_mod3, dbs)

# pt_gsea_placebo_pos_mod3
# pt_gsea_placebo_neg_mod3
# pt_gsea_dapa_pos_mod3
# pt_gsea_dapa_neg_mod3
# pt_gsea_DiD_pos_mod3
# pt_gsea_DiD_neg_mod3
plotEnrich(as.data.frame(pt_gsea_DiD_pos_mod3[[1]]), title = "Model 3 Positive DiD - PT GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/3 Nested visit and no zero inflation/pt_pos_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_pos_mod3[[2]]), title = "Model 3 Positive DiD - PT KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/3 Nested visit and no zero inflation/pt_pos_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_pos_mod3[[3]]), title = "Model 3 Positive DiD - PT REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/3 Nested visit and no zero inflation/pt_pos_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_pos_mod3[[4]]), title = "Model 3 Positive DiD - PT REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/3 Nested visit and no zero inflation/pt_pos_DiD_gsea_reactome24.jpeg")

plotEnrich(as.data.frame(pt_gsea_DiD_neg_mod3[[1]]), title = "Model 3 Negative DiD - PT GO")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/3 Nested visit and no zero inflation/pt_neg_DiD_gsea_go.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_neg_mod3[[2]]), title = "Model 3 Negative DiD - PT KEGG")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/3 Nested visit and no zero inflation/pt_neg_DiD_gsea_kegg.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_neg_mod3[[3]]), title = "Model 3 Negative DiD - PT REACTOME '22")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/3 Nested visit and no zero inflation/pt_neg_DiD_gsea_reactome22.jpeg")
plotEnrich(as.data.frame(pt_gsea_DiD_neg_mod3[[4]]), title = "Model 3 Negative DiD - PT REACTOME '24")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/GSEA/3 Nested visit and no zero inflation/pt_neg_DiD_gsea_reactome24.jpeg")
```
...
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(pt_model_filtered_mod3$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(pt_model_filtered_mod3$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(pt_model_filtered_mod3$Gene), savefile = FALSE)

# rank genes by t-stats in DiD
rankings_pt_mod3 <- pt_emmeans_diff_DiD_mod3_raw$t_stat_DiD
names(rankings_pt_mod3) <- pt_emmeans_diff_DiD_mod3_raw$Gene
rankings_pt_mod3 <- sort(rankings_pt_mod3, decreasing = TRUE)
plot(rankings_pt_mod3)
min(rankings_pt_mod3)
max(rankings_pt_mod3)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_pt_mod3 <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_pt_mod3,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_pt_mod3 <- fgsea(pathways = reactome,
                              stats = rankings_pt_mod3,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_pt_mod3 <- fgsea(pathways = go,
                        stats = rankings_pt_mod3,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
mod3_fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_pt_mod3[, padj < 0.05]), sum(kegg_legacy_res_pt_mod3[, pval < 0.05])),
                         "REACTOME"=c(sum(reactome_res_pt_mod3[, padj < 0.05]), sum(reactome_res_pt_mod3[, pval < 0.05])),
                         "GO"=c(sum(go_res_pt_mod3[, padj < 0.05]), sum(go_res_pt_mod3[, pval < 0.05])))
rownames(mod3_fgsea) <- c("adj.pval", "p.val")
mod3_fgsea
```
##### KEGG Legacy
```{r echo = F}
plot_fgsea(kegg_legacy_res_pt_mod3, title = "Model 3 PT Top 30 KEGG", xnudge = 0.03)
...
##### REACTOME
```{r echo = F}
plot_fgsea(reactome_res_pt_mod3, title = "Model 3 PT Top 30 REACTOME", xlimit = 5)
...
##### GO
```{r echo = F}
plot_fgsea(go_res_pt_mod3, title = "Model 3 PT Top 30 GO", xlimit = 8)

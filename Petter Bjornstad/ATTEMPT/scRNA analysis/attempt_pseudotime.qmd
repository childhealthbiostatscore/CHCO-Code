...
p <- ggarrange(pt_kpmp_results$p_pseudotime$plot, 
...
temp_file <- tempfile(fileext = ".RDS")
saveRDS(p, temp_file)
s3$upload_file(temp_file, "attempt", file.path("slingshot", paste0("attempt_pt_slingshot_density_celltype_pie.RDS")))

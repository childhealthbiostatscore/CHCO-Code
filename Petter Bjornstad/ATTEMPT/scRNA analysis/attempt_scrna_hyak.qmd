...
print(elapsed_time) 
# start_time <- Sys.time()
# attempt_so_raw <- s3readRDS("Kidney transcriptomics/Single cell RNA seq/PB_attempt_harmony_rpca_RM_kpmpV1labelled_Sept2024.RDS", 
#                             "scrna", region = "")
# end_time <- Sys.time()
# elapsed_time <- end_time - start_time
# print(elapsed_time) 
...
```
```{r}
# attempt_so@meta.data %>%
#   filter(KPMP_celltype %in% c("DTL", "aDTL")) %>%
#   ggplot(aes(paste0(visit, "\n", treatment), fill = KPMP_celltype)) +
...
#   ggtitle("Proportion of DTL cells") +
#   scale_fill_manual(values = c("#264653", "#2a9d8f", "#e9c46a", "#f4a261", "#e76f51"))
# 
# attempt_so@meta.data %>%
#   filter(KPMP_celltype %in% c("FIB", "VSMC/P", "EC/VSMC")) %>%
#   ggplot(aes(paste0(visit, "\n", treatment), fill = KPMP_celltype)) +
#   geom_bar(stat = "count", position = "fill") +
#   theme_classic() +
#   labs(x = NULL,
...
subject_col <- "subject_id"        # patient ID (for the paired random effect)
group_col   <- "treatment"          # A vs B
time_col    <- "visit"           # pre vs post
sample_col <- "subj_visit"
# pull metadata out of the Seurat object
attempt_so$subj_visit <- paste0(md$subject_id, "-", md$visit)
md <- attempt_so@meta.data %>%
  as_tibble() %>%
  select(all_of(c(sample_col, subject_col, group_col, time_col, ct_col)))

# counts per sample x cell type, including explicit zeros
counts <- md %>%
  dplyr::count(across(all_of(c(sample_col, subject_col, group_col, time_col))),
        .data[[ct_col]], name = "count") %>%
  dplyr::rename(KPMP_celltype = !!ct_col) %>%
  complete(
    nesting(!!!syms(c(sample_col, subject_col, group_col, time_col))),
    KPMP_celltype,
    fill = list(count = 0)
  ) %>%
...
sccomp_res <- sccomp_estimate(
  counts,
  formula_composition = ~ treatment * visit + (1 | subject_id),
  .sample = subj_visit, 
...
sccomp_res <- sccomp_res |> dplyr::filter(!grepl("___", parameter)) |>
  dplyr::filter(parameter == "treatmentDapagliflozin:visitPOST") |>
...
s3write_using_region(FUN = ggsave,
                     bucket = "attempt",
                     region = "",
                     object = "Figures/sccomp_celltype_intervals.png",
                     width = 8, 
                     height = 8, 
                     dpi = 300, 
                     bg = "transparent")
...
plot_df <- sccomp_res %>%
  ...
  unnest(count_data) %>%
  dplyr::group_by(subj_visit) %>%
  dplyr::mutate(proportion = count / sum(count)) %>%
  ungroup()

ggplot(plot_df, aes(x = treatment, y = proportion, fill = visit)) +
  ...
  scale_fill_manual(values = c("PRE" = "#eec170",
                               "POST" = "#f58549"))

s3write_using_region(FUN = ggsave,
                     bucket = "attempt",
                     region = "",
                     object = "Figures/sccomp_celltype_facet_proportions_boxplot.png",
                     width = 12, 
                     height = 12, 
                     dpi = 300, 
                     bg = "transparent")
...
s3$upload_file(temp_file, "attempt", "Figures/attempt_umap_visit.pdf") 

DimPlot(attempt_so, reduction = "umap.harmony", group.by = "treatment", raster = F, alpha = 0.2)
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file, width = 10)
s3$upload_file(temp_file, "attempt", "Figures/attempt_umap_treat.pdf") 

DimPlot(attempt_so, reduction = "umap.harmony", group.by = "celltype", raster = F, alpha = 0.2, label = T)
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file, width = 10)
s3$upload_file(temp_file, "attempt", "Figures/attempt_umap_celltype.pdf") 

DimPlot(attempt_so, reduction = "umap.harmony", group.by = "KPMP_celltype", raster = F, alpha = 0.2, label = T)
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file, width = 10)
s3$upload_file(temp_file, "attempt", "Figures/attempt_umap_kpmpcelltype.pdf") 
...
save(umap_df, file = temp_file)
s3$upload_file(temp_file, "attempt", "cleaned_data/attempt_umap_data.Rdata")
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file, width = 7, height = 7)
s3$upload_file(temp_file, "attempt", "Figures/attempt_umap_kpmpcelltype.pdf") 
# 
# temp_file <- tempfile(fileext = ".svg")
# ggsave(temp_file, width = 7, height = 7)
# s3$upload_file(temp_file, "attempt", "Figures/attempt_umap_kpmpcelltype.svg") 
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file, width = 10)
s3$upload_file(temp_file, "attempt", "Figures/attempt_cellcounts_plot.pdf") 
...
s3$upload_file(temp_file, "attempt", "Figures/attempt_cellcounts_proportions_plot.pdf") 
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file, width = 10)
s3$upload_file(temp_file, "attempt", "Figures/attempt_kpmp_cellcounts_plot.pdf") 
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file, width = 15)
s3$upload_file(temp_file, "attempt", "Figures/attempt_kpmp_cellcounts_proportions_plot.pdf") 
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file)
s3$upload_file(temp_file, "attempt", "Figures/attempt_general_cellcounts_plot.pdf") 
...
s3$upload_file(temp_file, "attempt", "Figures/attempt_general_cellcounts_proportions_plot.pdf") 
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file)
s3$upload_file(temp_file, "attempt", "Figures/attempt_general_cellcounts_plot_clean.pdf") 
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file)
s3$upload_file(temp_file, "attempt", "Figures/attempt_general_cellcounts_proportions_plot_clean.pdf") 
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file)
s3$upload_file(temp_file, "attempt", "Figures/attempt_general_kpmp_cellcounts_plot_clean.pdf") 
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file)
s3$upload_file(temp_file, "attempt", "Figures/attempt_general_kpmp_cellcounts_proportions_plot_clean.pdf") 
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file)
s3$upload_file(temp_file, "attempt", "Figures/attempt_kpmp_pt_proportions_plot.pdf") 
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file)
s3$upload_file(temp_file, "attempt", "Figures/attempt_kpmp_tal_proportions_plot.pdf") 
...
s3$upload_file(temp_file, "attempt", "Figures/Proportions/attempt_pt_visit_proportions_plot.pdf")
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file, height = 10, bg = "transparent")
s3$upload_file(temp_file, "attempt", "Figures/Proportions/attempt_pt_treatment_proportions_plot.pdf")
...
s3$upload_file(temp_file, "attempt", "Figures/Proportions/attempt_pt_treatment_visit_proportions_plot.pdf")
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file, height = 10, bg = "transparent")
s3$upload_file(temp_file, "attempt", "Figures/Proportions/attempt_pt_visit_proportions_plot_kpmp.pdf")
...
temp_file <- tempfile(fileext = ".pdf")
ggsave(temp_file, height = 10, bg = "transparent")
s3$upload_file(temp_file, "attempt", "Figures/Proportions/attempt_pt_visit_treatment_proportions_plot_kpmp.pdf")
```

...
for (cell in names(celltype_groups)) {
  ...
  if(length(brackets) > 0) {
    ...
    p <- p + coord_cartesian(xlim = c(1, 3), clip = "off")
  }
...
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Panels/croc_attempt_rev_heatmap_2.pdf"), width = 12, height = 12)

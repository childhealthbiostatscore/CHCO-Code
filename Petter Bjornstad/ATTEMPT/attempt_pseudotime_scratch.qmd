...
treatment_effects <- test_treatment_effects(sce_pt_celltype_df, clinical_vars)
...
# 1. Create pseudobulk data by aggregating cells per subject/visit
pseudobulk_data <- sce_pt_celltype_df %>%
  ...
  summarise(
    ...
    # Clinical variables (should be constant within subject/visit)
...
summary(lmer(median_pseudotime ~ hba1c *treatment + visit + (1|subject_id), data = pseudobulk_data))
summary(lmer(median_pseudotime  ~ weight *treatment + visit + (1|subject_id), data = pseudobulk_data))
summary(lmer(median_pseudotime  ~ mgfr_jodal *treatment + visit + (1|subject_id), data = pseudobulk_data))
summary(lmer(median_pseudotime  ~ cgm_tir *treatment + visit + (1|subject_id), data = pseudobulk_data))
```
...
model <- (lmer(scaled_pseudotime ~ hba1c + treatment + visit + (1 |subject_id), data = sce_pt_celltype_df))
summary(model)
qqnorm(resid(model)); qqline(resid(model))

model <- (lmer(scaled_pseudotime ~ weight + treatment + visit + (1 |subject_id), data = sce_pt_celltype_df))
summary(model)
qqnorm(resid(model)); qqline(resid(model))

model <- (lmer(scaled_pseudotime ~ mgfr_jodal + treatment + visit + (1 |subject_id), data = sce_pt_celltype_df))
summary(model)
qqnorm(resid(model)); qqline(resid(model))

model <- (lmer(scaled_pseudotime ~ mgfr_jodal_bsa + treatment + visit + (1 |subject_id), data = sce_pt_celltype_df))
summary(model)
qqnorm(resid(model)); qqline(resid(model))

model <- (lmer(scaled_pseudotime ~ cgm_tir + treatment + visit + (1 |subject_id), data = sce_pt_celltype_df))
summary(model)
qqnorm(resid(model)); qqline(resid(model))

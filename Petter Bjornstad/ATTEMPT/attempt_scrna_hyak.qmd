...
celltypes <- unique(Idents(attempt_so))
...
#   res_list <- run_for_subset(so_subset, paste0("kpmp_grouped/", grp_name))
#   
...
for (ct in all_listed_celltypes) {
  ...
  res_list <- run_for_subset(so_subset, paste0("kpmp_individual/", ct))

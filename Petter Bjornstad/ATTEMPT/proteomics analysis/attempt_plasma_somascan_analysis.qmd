...
write.csv(soma_DiD_fgsea_hallmark, file.path(root_path, "ATTEMPT/Results/GSEA/Proteomics/plasma_mixed_DiD_HALLMARK.csv"), row.names = F, na = "")
...
write.csv(soma_DiD_fgsea_kegg, file.path(root_path, "ATTEMPT/Results/GSEA/Proteomics/plasma_mixed_DiD_KEGG.csv"), row.names = F, na = "")
...
write.csv(soma_DiD_fgsea_reactome, file.path(root_path, "ATTEMPT/Results/GSEA/Proteomics/plasma_mixed_DiD_REACTOME.csv"), row.names = F, na = "")
...
write.csv(soma_DiD_fgsea_go, file.path(root_path, "ATTEMPT/Results/GSEA/Proteomics/plasma_mixed_DiD_GO.csv"), row.names = F, na = "")
```

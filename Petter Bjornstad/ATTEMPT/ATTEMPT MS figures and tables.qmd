...
ggarrange(mgfr_jodal_bsa_category_bars, delta_avg_k_r2_overtime, avg_k_r2_by_mgfr_category_bars, croc_r2_p,
          ncol=3, nrow=2, common.legend = TRUE, legend="bottom", labels = "AUTO")

ggsave(file.path(base_path, "Panels/full_mgfr_r2.png"), width = 12, height = 8, dpi = 600)
```
...
img4 <- image_read(file.path(base_path, "Slingshot/attempt_pt_slingshot_density_mgfr_jodal_delta_pie.png"))
img5 <- image_read(file.path(base_path, "Slingshot/attempt_pt_slingshot_density_hba1c_delta_pie.png"))
img6 <- image_read(file.path(base_path, "Slingshot/attempt_pt_slingshot_density_tir_delta_pie.png"))
img7 <- image_read(file.path(base_path, "Slingshot/attempt_pt_slingshot_density_weight_delta_pie.png"))

...
for (cell in celltypes)  {
  input_path <- paste0("/CROCODILE comparison analysis/", cell, "/nebula/",tolower(cell),"_croc_targeted_t1dvhc.rds")
  ...
  var_name <- paste0(lower_cell, "_croc_targeted_res_hvg")
...
# Full gene set
for (cell in celltypes)  {
  input_path <- paste0("/CROCODILE comparison analysis/", cell, "/nebula/",tolower(cell),"_croc_targeted_t1dvhc_full.rds")
  cell_df <- s3readRDS(input_path, bucket = "attempt", region = "")
  head(cell_df)
  processed <- process_nebula_results(cell_df, pval_col = "p_groupType_1_Diabetes")
  lower_cell <- tolower(cell)
...
plot_croc_attempt_volcano(
  attempt_df = pt_nebula_res_combined_reml_pooled,
  croc_df = pt_croc_targeted_res,
  cell_type = "PT",
  top_n = 20,
  save_path = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/CROCODILE comparison/Volcano Plots/pt_targeted_volcano_attempt_directions_labeled.jpeg"
)
```


```{r echo =F}
plot_volcano(pt_croc_targeted_res, "logFC_groupType_1_Diabetes", 
...
plot_volcano(pt_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             ...
             "CROCODILE comparison analysis/pt_croc_fdr_nebula_reml_offset")
```
...
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(croc_pt_croc_targeted_res$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(croc_pt_croc_targeted_res$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(croc_pt_croc_targeted_res$Gene), savefile = FALSE)

# rank genes by logFC
rankings_croc_pt_nebula_reml_offset <- croc_pt_croc_targeted_res$`logFC_groupType_1_Diabetes`
names(rankings_croc_pt_nebula_reml_offset) <- croc_pt_croc_targeted_res$Gene
...
```{r echo = F}
plot_croc_attempt_volcano(
  attempt_df = tal_nebula_res_combined_reml_pooled,
  croc_df = tal_croc_targeted_res,
  cell_type = "TAL",
  top_n = 20,
  save_path = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/CROCODILE comparison/Volcano Plots/tal_targeted_volcano_attempt_directions_labeled.jpeg"
)
```


```{r echo =F}
plot_volcano(tal_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             "p_groupType_1_Diabetes",
...
plot_volcano(tal_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             ...
             "logFC group (Type 1 Diabetes)", 
             "-log10(FDR adjusted p-value)",
             "CROCODILE comparison analysis/tal_croc_fdr_nebula_reml_offset")
```
##### GSEA (fgsea)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(tal_croc_targeted_res$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(tal_croc_targeted_res$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(tal_croc_targeted_res$Gene), savefile = FALSE)

# rank genes by logFC
rankings_tal_nebula_reml_offset <- tal_croc_targeted_res$`logFC_groupType_1_Diabetes`
names(rankings_tal_nebula_reml_offset) <- tal_croc_targeted_res$Gene
...
```{r echo = F}
plot_croc_attempt_volcano(
  attempt_df = pc_nebula_res_combined_reml_pooled,
  croc_df = pc_croc_targeted_res,
  cell_type = "PC",
  top_n = 20,
  save_path = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/CROCODILE comparison/Volcano Plots/pc_targeted_volcano_attempt_directions_labeled.jpeg"
)
```


```{r echo =F}
plot_volcano(pc_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             "p_groupType_1_Diabetes",
...
plot_volcano(pc_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             ...
             "logFC group (Type 1 Diabetes)", 
             "-log10(FDR adjusted p-value)",
             "CROCODILE comparison analysis/pc_croc_fdr_nebula_reml_offset")
```
##### GSEA (fgsea)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(pc_croc_targeted_res$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(pc_croc_targeted_res$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(pc_croc_targeted_res$Gene), savefile = FALSE)

# rank genes by logFC
rankings_pc_nebula_reml_offset <- pc_croc_targeted_res$`logFC_groupType_1_Diabetes`
names(rankings_pc_nebula_reml_offset) <- pc_croc_targeted_res$Gene
...
```{r echo = F}
plot_croc_attempt_volcano(
  attempt_df = immune_nebula_res_combined_reml_pooled,
  croc_df = immune_croc_targeted_res,
  cell_type = "Immune",
  top_n = 20,
  save_path = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/CROCODILE comparison/Volcano Plots/immune_targeted_volcano_attempt_directions_labeled.jpeg"
)
```


```{r echo =F}
plot_volcano(immune_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             "p_groupType_1_Diabetes",
...
plot_volcano(immune_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             ...
             "logFC group (Type 1 Diabetes)", 
             "-log10(FDR adjusted p-value)",
             "CROCODILE comparison analysis/immune_croc_fdr_nebula_reml_offset")
```
##### GSEA (fgsea)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(immune_croc_targeted_res$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(immune_croc_targeted_res$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(immune_croc_targeted_res$Gene), savefile = FALSE)

# rank genes by logFC
rankings_immune_nebula_reml_offset <- immune_croc_targeted_res$`logFC_groupType_1_Diabetes`
names(rankings_immune_nebula_reml_offset) <- immune_croc_targeted_res$Gene
...
```{r echo = F}
plot_croc_attempt_volcano(
  attempt_df = ic_nebula_res_combined_reml_pooled,
  croc_df = ic_croc_targeted_res,
  cell_type = "IC",
  top_n = 20,
  save_path = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/CROCODILE comparison/Volcano Plots/ic_targeted_volcano_attempt_directions_labeled.jpeg"
)
```

```{r echo =F}
plot_volcano(ic_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             "p_groupType_1_Diabetes",
...
plot_volcano(ic_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             ...
             "logFC group (Type 1 Diabetes)", 
             "-log10(FDR adjusted p-value)",
             "CROCODILE comparison analysis/ic_croc_fdr_nebula_reml_offset")
```
##### GSEA (fgsea)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(ic_croc_targeted_res$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(ic_croc_targeted_res$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(ic_croc_targeted_res$Gene), savefile = FALSE)

# rank genes by logFC
rankings_ic_nebula_reml_offset <- ic_croc_targeted_res$`logFC_groupType_1_Diabetes`
names(rankings_ic_nebula_reml_offset) <- ic_croc_targeted_res$Gene
...
```{r echo = F}
plot_croc_attempt_volcano(
  attempt_df = ec_nebula_res_combined_reml_pooled,
  croc_df = ec_croc_targeted_res,
  cell_type = "EC",
  top_n = 20,
  save_path = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/CROCODILE comparison/Volcano Plots/ec_targeted_volcano_attempt_directions_labeled.jpeg"
)
```


```{r echo =F}
plot_volcano(ec_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             "p_groupType_1_Diabetes",
...
plot_volcano(ec_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             ...
             "logFC group (Type 1 Diabetes)", 
             "-log10(FDR adjusted p-value)",
             "CROCODILE comparison analysis/ec_croc_fdr_nebula_reml_offset")
```
##### GSEA (fgsea)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(ec_croc_targeted_res$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(ec_croc_targeted_res$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(ec_croc_targeted_res$Gene), savefile = FALSE)

# rank genes by logFC
rankings_ec_nebula_reml_offset <- ec_croc_targeted_res$`logFC_groupType_1_Diabetes`
names(rankings_ec_nebula_reml_offset) <- ec_croc_targeted_res$Gene
...
```{r echo = F}
plot_croc_attempt_volcano(
  attempt_df = fibvsmcp_nebula_res_combined_reml_pooled,
  croc_df = fibvsmcp_croc_targeted_res,
  cell_type = "FIB, VSMC/P",
  top_n = 20,
  save_path = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/CROCODILE comparison/Volcano Plots/fibvsmcp_targeted_volcano_attempt_directions_labeled.jpeg"
)
```

```{r echo =F}
plot_volcano(fibvsmc_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             "p_groupType_1_Diabetes",
...
plot_volcano(fibvsmc_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             ...
             "logFC group (Type 1 Diabetes)", 
             "-log10(FDR adjusted p-value)",
             "CROCODILE comparison analysis/fibvsmc_croc_fdr_nebula_reml_offset")
```
##### GSEA (fgsea)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(fibvsmc_croc_targeted_res$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(fibvsmc_croc_targeted_res$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(fibvsmc_croc_targeted_res$Gene), savefile = FALSE)

# rank genes by logFC
rankings_fibvsmc_nebula_reml_offset <- fibvsmc_croc_targeted_res$`logFC_groupType_1_Diabetes`
names(rankings_fibvsmc_nebula_reml_offset) <- fibvsmc_croc_targeted_res$Gene
...
```{r echo = F}
plot_croc_attempt_volcano(
  attempt_df = pod_nebula_res_combined_reml_pooled,
  croc_df = pod_croc_targeted_res,
  cell_type = "POD",
  top_n = 20,
  save_path = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/CROCODILE comparison/Volcano Plots/pod_targeted_volcano_attempt_directions_labeled.jpeg"
)
```

```{r echo =F}
plot_volcano(pod_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             "p_groupType_1_Diabetes",
             "nebula POD (REML & Offset)", 
             "logFC group (Type 1 Diabetes)", 
             "-log10(p-value)",
             "CROCODILE comparison analysis/pod_croc_pvalue_nebula_reml_offset")
...
plot_volcano(pod_croc_targeted_res, "logFC_groupType_1_Diabetes", 
             ...
             "logFC group (Type 1 Diabetes)", 
             "-log10(FDR adjusted p-value)",
             "CROCODILE comparison analysis/pod_croc_fdr_nebula_reml_offset")
```
##### GSEA (fgsea)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(pod_croc_targeted_res$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(pod_croc_targeted_res$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(pod_croc_targeted_res$Gene), savefile = FALSE)

# rank genes by logFC
rankings_pod_nebula_reml_offset <- pod_croc_targeted_res$`logFC_groupType_1_Diabetes`
names(rankings_pod_nebula_reml_offset) <- pod_croc_targeted_res$Gene

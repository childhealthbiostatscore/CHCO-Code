...
write.csv(pt_nebula_pooled_ipa_DiD, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kpmp/nebula/pt_nebula_pooled_ipa_input_DiD.csv", row.names = F)
```
...
write.csv(tal_nebula_pooled_ipa_DiD, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kpmp/nebula/tal_nebula_pooled_ipa_input_DiD.csv", row.names = F)
```
...
write.csv(pc_nebula_pooled_ipa_DiD, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kpmp/nebula/pc_nebula_pooled_ipa_input_DiD.csv", row.names = F)
```
...
write.csv(immune_nebula_pooled_ipa_DiD, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kpmp/nebula/immune_nebula_pooled_ipa_input_DiD.csv", row.names = F)
```
...
write.csv(immune_myeloid_nebula_pooled_ipa_DiD, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kpmp/nebula/immune_myeloid_nebula_pooled_ipa_input_DiD.csv", row.names = F)
```
...
write.csv(immune_lymphoid_nebula_pooled_ipa_DiD, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kpmp/nebula/immune_lymphoid_nebula_pooled_ipa_input_DiD.csv", row.names = F)
```
...
write.csv(ic_nebula_pooled_ipa_DiD, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kpmp/nebula/ic_nebula_pooled_ipa_input_DiD.csv", row.names = F)
```
...
write.csv(ec_nebula_pooled_ipa_DiD, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kpmp/nebula/ec_nebula_pooled_ipa_input_DiD.csv", row.names = F)
```
...
plot_volcano(vsmc_p_fib_hvg_kpmp, "logFC_treatmentDapagliflozin:visitPOST", 
             ...
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/vsmc_p_fib_hvg_kpmp_DiD",
             formula = "treatment * visit",
...
# save input for IPA
## Interaction or DiD
vsmc_p_fib_nebula_pooled_ipa_DiD <- vsmc_p_fib_hvg_kpmp %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr)
colnames(vsmc_p_fib_nebula_pooled_ipa_DiD) <- c("Gene", "Log Fold Change", "Expr p-value", "Expr False Discovery Rate")

write.csv(vsmc_p_fib_nebula_pooled_ipa_DiD, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kpmp/nebula/vsmc_p_fib_nebula_pooled_ipa_input_DiD.csv", row.names = F)
```
...
```{r echo =F}
plot_volcano(vsmc_p_fib_kpmp, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL,
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/vsmc_p_fib_kpmp_DiD",
             formula = "treatment * visit",
             cell_type = "FIB, VSMC/P")
...
# save input for IPA
## Interaction or DiD
pod_nebula_pooled_ipa_DiD <- pod_hvg_kpmp %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr)
colnames(pod_nebula_pooled_ipa_DiD) <- c("Gene", "Log Fold Change", "Expr p-value", "Expr False Discovery Rate")

write.csv(pod_nebula_pooled_ipa_DiD, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kpmp/nebula/pod_nebula_pooled_ipa_input_DiD.csv", row.names = F)
```
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/vsmc_p_fib_top30_inhibited_pathways_nebula.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/vsmc_p_fib_top_inhibited_pathways_2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/vsmc_p_fib_top30_activated_pathways_nebula.jpeg",
       width = 27.5, height = 14, scale = 1)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/vsmc_p_fib_top_activated_pathways_2.jpeg",
       width = 27.5, height = 10, scale = 1)
```
...
vsmc_p_fib_neg_pathways_merged_long_nebula %>%
  ...
  guides(alpha = "none") +
  geom_hline(yintercept = 0, linetype = "dashed", color = "darkgray")
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/nebula/vsmc_p_fib_top10_inhibited_pathway_zscores.jpeg",
       scale = 1.5)
...
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Z score bar plots/nebula/vsmc_p_fib_top10_activated_pathway_zscores.jpeg",
       scale = 1.5)
```

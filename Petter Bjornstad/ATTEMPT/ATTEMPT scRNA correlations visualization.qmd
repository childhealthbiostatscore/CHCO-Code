...
plot_volcano <- function(data, fc, p_col, title_suffix, x_axis, y_axis, file_suffix, p_thresh = 0.05,
                         positive_text = "Positively associated with Dapagliflozin", 
                         negative_text = "Negatively associated with Dapagliflozin",
                         formula = "treatment") {
  set.seed(1)
  top_pos <- data %>%
  ...
  annotate("segment", 
           ...
           xend=(max_fc*7)/8, 
           y=-1.5,
           col="#f28482", arrow=arrow(length=unit(0.2, "cm"))) +
  annotate("text", 
  ...
  annotate("segment", 
           ...
           xend=(min_fc*7)/8, 
           y=-1.5,
           col="#457b9d", arrow=arrow(length=unit(0.2, "cm"))) +
  annotate("text", 
  ...
  theme(plot.margin = margin(t = 10, r = 20, b = 28, l = 20), 

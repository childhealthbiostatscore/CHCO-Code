...
```{r echo = F}
filter_redundant_pathways <- function(gsea_result, overlap_pct = 0.7) {
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pt_mgfr_jodal_filtered <- filter_redundant_pathways(kegg_legacy_res_pt_mgfr_jodal, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pt_mgfr_jodal_filtered <- filter_redundant_pathways(reactome_res_pt_mgfr_jodal, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pt_mgfr_jodal_filtered <- filter_redundant_pathways(go_res_pt_mgfr_jodal, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pt_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(kegg_legacy_res_pt_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pt_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(reactome_res_pt_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pt_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(go_res_pt_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pt_tir_filtered <- filter_redundant_pathways(kegg_legacy_res_pt_tir, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pt_tir_filtered <- filter_redundant_pathways(reactome_res_pt_tir, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pt_tir_filtered <- filter_redundant_pathways(go_res_pt_tir, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pt_hba1c_filtered <- filter_redundant_pathways(kegg_legacy_res_pt_hba1c, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pt_hba1c_filtered <- filter_redundant_pathways(reactome_res_pt_hba1c, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pt_hba1c_filtered <- filter_redundant_pathways(go_res_pt_hba1c, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pt_weight_filtered <- filter_redundant_pathways(kegg_legacy_res_pt_weight, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pt_weight_filtered <- filter_redundant_pathways(reactome_res_pt_weight, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pt_weight_filtered <- filter_redundant_pathways(go_res_pt_weight, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pt_avg_c_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_pt_avg_c_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pt_avg_c_r2_filtered <- filter_redundant_pathways(reactome_res_pt_avg_c_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pt_avg_c_r2_filtered <- filter_redundant_pathways(go_res_pt_avg_c_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pt_avg_k_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_pt_avg_k_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pt_avg_k_r2_filtered <- filter_redundant_pathways(reactome_res_pt_avg_k_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pt_avg_k_r2_filtered <- filter_redundant_pathways(go_res_pt_avg_k_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_tal_mgfr_jodal_filtered <- filter_redundant_pathways(kegg_legacy_res_tal_mgfr_jodal, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_tal_mgfr_jodal_filtered <- filter_redundant_pathways(reactome_res_tal_mgfr_jodal, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_tal_mgfr_jodal_filtered <- filter_redundant_pathways(go_res_tal_mgfr_jodal, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_tal_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(kegg_legacy_res_tal_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_tal_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(reactome_res_tal_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_tal_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(go_res_tal_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_tal_tir_filtered <- filter_redundant_pathways(kegg_legacy_res_tal_tir, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_tal_tir_filtered <- filter_redundant_pathways(reactome_res_tal_tir, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_tal_tir_filtered <- filter_redundant_pathways(go_res_tal_tir, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_tal_hba1c_filtered <- filter_redundant_pathways(kegg_legacy_res_tal_hba1c, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_tal_hba1c_filtered <- filter_redundant_pathways(reactome_res_tal_hba1c, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_tal_hba1c_filtered <- filter_redundant_pathways(go_res_tal_hba1c, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_tal_weight_filtered <- filter_redundant_pathways(kegg_legacy_res_tal_weight, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_tal_weight_filtered <- filter_redundant_pathways(reactome_res_tal_weight, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_tal_weight_filtered <- filter_redundant_pathways(go_res_tal_weight, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_tal_avg_c_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_tal_avg_c_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_tal_avg_c_r2_filtered <- filter_redundant_pathways(reactome_res_tal_avg_c_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_tal_avg_c_r2_filtered <- filter_redundant_pathways(go_res_tal_avg_c_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_tal_avg_k_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_tal_avg_k_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_tal_avg_k_r2_filtered <- filter_redundant_pathways(reactome_res_tal_avg_k_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_tal_avg_k_r2_filtered <- filter_redundant_pathways(go_res_tal_avg_k_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_mgfr_jodal_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_mgfr_jodal, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_mgfr_jodal_filtered <- filter_redundant_pathways(reactome_res_immune_mgfr_jodal, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_mgfr_jodal_filtered <- filter_redundant_pathways(go_res_immune_mgfr_jodal, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(reactome_res_immune_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(go_res_immune_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_tir_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_tir, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_tir_filtered <- filter_redundant_pathways(reactome_res_immune_tir, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_tir_filtered <- filter_redundant_pathways(go_res_immune_tir, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_hba1c_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_hba1c, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_hba1c_filtered <- filter_redundant_pathways(reactome_res_immune_hba1c, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_hba1c_filtered <- filter_redundant_pathways(go_res_immune_hba1c, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_weight_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_weight, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_weight_filtered <- filter_redundant_pathways(reactome_res_immune_weight, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_weight_filtered <- filter_redundant_pathways(go_res_immune_weight, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_avg_c_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_avg_c_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_avg_c_r2_filtered <- filter_redundant_pathways(reactome_res_immune_avg_c_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_avg_c_r2_filtered <- filter_redundant_pathways(go_res_immune_avg_c_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_avg_k_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_avg_k_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_avg_k_r2_filtered <- filter_redundant_pathways(reactome_res_immune_avg_k_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_avg_k_r2_filtered <- filter_redundant_pathways(go_res_immune_avg_k_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_myeloid_mgfr_jodal_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_myeloid_mgfr_jodal, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_myeloid_mgfr_jodal_filtered <- filter_redundant_pathways(reactome_res_immune_myeloid_mgfr_jodal, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_myeloid_mgfr_jodal_filtered <- filter_redundant_pathways(go_res_immune_myeloid_mgfr_jodal, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_myeloid_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_myeloid_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_myeloid_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(reactome_res_immune_myeloid_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_myeloid_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(go_res_immune_myeloid_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_myeloid_tir_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_myeloid_tir, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_myeloid_tir_filtered <- filter_redundant_pathways(reactome_res_immune_myeloid_tir, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_myeloid_tir_filtered <- filter_redundant_pathways(go_res_immune_myeloid_tir, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_myeloid_hba1c_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_myeloid_hba1c, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_myeloid_hba1c_filtered <- filter_redundant_pathways(reactome_res_immune_myeloid_hba1c, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_myeloid_hba1c_filtered <- filter_redundant_pathways(go_res_immune_myeloid_hba1c, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_myeloid_weight_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_myeloid_weight, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_myeloid_weight_filtered <- filter_redundant_pathways(reactome_res_immune_myeloid_weight, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_myeloid_weight_filtered <- filter_redundant_pathways(go_res_immune_myeloid_weight, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_myeloid_avg_c_r2_filtered <- filter_redundant_pathways(reactome_res_immune_myeloid_avg_c_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_myeloid_avg_c_r2_filtered <- filter_redundant_pathways(go_res_immune_myeloid_avg_c_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_myeloid_avg_k_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_myeloid_avg_k_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_myeloid_avg_k_r2_filtered <- filter_redundant_pathways(reactome_res_immune_myeloid_avg_k_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_myeloid_avg_k_r2_filtered <- filter_redundant_pathways(go_res_immune_myeloid_avg_k_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_lymphoid_mgfr_jodal_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_lymphoid_mgfr_jodal, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_lymphoid_mgfr_jodal_filtered <- filter_redundant_pathways(reactome_res_immune_lymphoid_mgfr_jodal, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_lymphoid_mgfr_jodal_filtered <- filter_redundant_pathways(go_res_immune_lymphoid_mgfr_jodal, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_lymphoid_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_lymphoid_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_lymphoid_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(reactome_res_immune_lymphoid_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_lymphoid_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(go_res_immune_lymphoid_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_lymphoid_tir_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_lymphoid_tir, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_lymphoid_tir_filtered <- filter_redundant_pathways(reactome_res_immune_lymphoid_tir, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_lymphoid_tir_filtered <- filter_redundant_pathways(go_res_immune_lymphoid_tir, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_lymphoid_hba1c_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_lymphoid_hba1c, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_lymphoid_hba1c_filtered <- filter_redundant_pathways(reactome_res_immune_lymphoid_hba1c, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_lymphoid_hba1c_filtered <- filter_redundant_pathways(go_res_immune_lymphoid_hba1c, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_lymphoid_weight_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_lymphoid_weight, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_lymphoid_weight_filtered <- filter_redundant_pathways(reactome_res_immune_lymphoid_weight, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_lymphoid_weight_filtered <- filter_redundant_pathways(go_res_immune_lymphoid_weight, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_lymphoid_avg_c_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_lymphoid_avg_c_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_lymphoid_avg_c_r2_filtered <- filter_redundant_pathways(reactome_res_immune_lymphoid_avg_c_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_lymphoid_avg_c_r2_filtered <- filter_redundant_pathways(go_res_immune_lymphoid_avg_c_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_immune_lymphoid_avg_k_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_immune_lymphoid_avg_k_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_immune_lymphoid_avg_k_r2_filtered <- filter_redundant_pathways(reactome_res_immune_lymphoid_avg_k_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_immune_lymphoid_avg_k_r2_filtered <- filter_redundant_pathways(go_res_immune_lymphoid_avg_k_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pc_mgfr_jodal_filtered <- filter_redundant_pathways(kegg_legacy_res_pc_mgfr_jodal, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pc_mgfr_jodal_filtered <- filter_redundant_pathways(reactome_res_pc_mgfr_jodal, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pc_mgfr_jodal_filtered <- filter_redundant_pathways(go_res_pc_mgfr_jodal, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pc_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(kegg_legacy_res_pc_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pc_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(reactome_res_pc_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pc_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(go_res_pc_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pc_tir_filtered <- filter_redundant_pathways(kegg_legacy_res_pc_tir, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pc_tir_filtered <- filter_redundant_pathways(reactome_res_pc_tir, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pc_tir_filtered <- filter_redundant_pathways(go_res_pc_tir, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pc_hba1c_filtered <- filter_redundant_pathways(kegg_legacy_res_pc_hba1c, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pc_hba1c_filtered <- filter_redundant_pathways(reactome_res_pc_hba1c, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pc_hba1c_filtered <- filter_redundant_pathways(go_res_pc_hba1c, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pc_weight_filtered <- filter_redundant_pathways(kegg_legacy_res_pc_weight, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pc_weight_filtered <- filter_redundant_pathways(reactome_res_pc_weight, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pc_weight_filtered <- filter_redundant_pathways(go_res_pc_weight, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pc_avg_c_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_pc_avg_c_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pc_avg_c_r2_filtered <- filter_redundant_pathways(reactome_res_pc_avg_c_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pc_avg_c_r2_filtered <- filter_redundant_pathways(go_res_pc_avg_c_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_pc_avg_k_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_pc_avg_k_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_pc_avg_k_r2_filtered <- filter_redundant_pathways(reactome_res_pc_avg_k_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_pc_avg_k_r2_filtered <- filter_redundant_pathways(go_res_pc_avg_k_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ic_mgfr_jodal_filtered <- filter_redundant_pathways(kegg_legacy_res_ic_mgfr_jodal, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ic_mgfr_jodal_filtered <- filter_redundant_pathways(reactome_res_ic_mgfr_jodal, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ic_mgfr_jodal_filtered <- filter_redundant_pathways(go_res_ic_mgfr_jodal, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ic_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(kegg_legacy_res_ic_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ic_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(reactome_res_ic_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ic_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(go_res_ic_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ic_tir_filtered <- filter_redundant_pathways(kegg_legacy_res_ic_tir, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ic_tir_filtered <- filter_redundant_pathways(reactome_res_ic_tir, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ic_tir_filtered <- filter_redundant_pathways(go_res_ic_tir, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ic_hba1c_filtered <- filter_redundant_pathways(kegg_legacy_res_ic_hba1c, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ic_hba1c_filtered <- filter_redundant_pathways(reactome_res_ic_hba1c, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ic_hba1c_filtered <- filter_redundant_pathways(go_res_ic_hba1c, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ic_weight_filtered <- filter_redundant_pathways(kegg_legacy_res_ic_weight, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ic_weight_filtered <- filter_redundant_pathways(reactome_res_ic_weight, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ic_weight_filtered <- filter_redundant_pathways(go_res_ic_weight, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ic_avg_c_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_ic_avg_c_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ic_avg_c_r2_filtered <- filter_redundant_pathways(reactome_res_ic_avg_c_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ic_avg_c_r2_filtered <- filter_redundant_pathways(go_res_ic_avg_c_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ic_avg_k_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_ic_avg_k_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ic_avg_k_r2_filtered <- filter_redundant_pathways(reactome_res_ic_avg_k_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ic_avg_k_r2_filtered <- filter_redundant_pathways(go_res_ic_avg_k_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ec_mgfr_jodal_filtered <- filter_redundant_pathways(kegg_legacy_res_ec_mgfr_jodal, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ec_mgfr_jodal_filtered <- filter_redundant_pathways(reactome_res_ec_mgfr_jodal, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ec_mgfr_jodal_filtered <- filter_redundant_pathways(go_res_ec_mgfr_jodal, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ec_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(kegg_legacy_res_ec_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ec_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(reactome_res_ec_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ec_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(go_res_ec_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ec_tir_filtered <- filter_redundant_pathways(kegg_legacy_res_ec_tir, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ec_tir_filtered <- filter_redundant_pathways(reactome_res_ec_tir, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ec_tir_filtered <- filter_redundant_pathways(go_res_ec_tir, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ec_hba1c_filtered <- filter_redundant_pathways(kegg_legacy_res_ec_hba1c, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ec_hba1c_filtered <- filter_redundant_pathways(reactome_res_ec_hba1c, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ec_hba1c_filtered <- filter_redundant_pathways(go_res_ec_hba1c, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ec_weight_filtered <- filter_redundant_pathways(kegg_legacy_res_ec_weight, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ec_weight_filtered <- filter_redundant_pathways(reactome_res_ec_weight, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ec_weight_filtered <- filter_redundant_pathways(go_res_ec_weight, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ec_avg_c_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_ec_avg_c_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ec_avg_c_r2_filtered <- filter_redundant_pathways(reactome_res_ec_avg_c_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ec_avg_c_r2_filtered <- filter_redundant_pathways(go_res_ec_avg_c_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_ec_avg_k_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_ec_avg_k_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_ec_avg_k_r2_filtered <- filter_redundant_pathways(reactome_res_ec_avg_k_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_ec_avg_k_r2_filtered <- filter_redundant_pathways(go_res_ec_avg_k_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_fibvsmc_mgfr_jodal_filtered <- filter_redundant_pathways(kegg_legacy_res_fibvsmc_mgfr_jodal, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_fibvsmc_mgfr_jodal_filtered <- filter_redundant_pathways(reactome_res_fibvsmc_mgfr_jodal, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_fibvsmc_mgfr_jodal_filtered <- filter_redundant_pathways(go_res_fibvsmc_mgfr_jodal, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_fibvsmc_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(kegg_legacy_res_fibvsmc_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_fibvsmc_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(reactome_res_fibvsmc_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_fibvsmc_mgfr_jodal_bsa_filtered <- filter_redundant_pathways(go_res_fibvsmc_mgfr_jodal_bsa, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_fibvsmc_tir_filtered <- filter_redundant_pathways(kegg_legacy_res_fibvsmc_tir, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_fibvsmc_tir_filtered <- filter_redundant_pathways(reactome_res_fibvsmc_tir, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_fibvsmc_tir_filtered <- filter_redundant_pathways(go_res_fibvsmc_tir, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_fibvsmc_hba1c_filtered <- filter_redundant_pathways(kegg_legacy_res_fibvsmc_hba1c, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_fibvsmc_hba1c_filtered <- filter_redundant_pathways(reactome_res_fibvsmc_hba1c, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_fibvsmc_hba1c_filtered <- filter_redundant_pathways(go_res_fibvsmc_hba1c, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_fibvsmc_weight_filtered <- filter_redundant_pathways(kegg_legacy_res_fibvsmc_weight, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_fibvsmc_weight_filtered <- filter_redundant_pathways(reactome_res_fibvsmc_weight, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_fibvsmc_weight_filtered <- filter_redundant_pathways(go_res_fibvsmc_weight, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_fibvsmc_avg_c_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_fibvsmc_avg_c_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_fibvsmc_avg_c_r2_filtered <- filter_redundant_pathways(reactome_res_fibvsmc_avg_c_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_fibvsmc_avg_c_r2_filtered <- filter_redundant_pathways(go_res_fibvsmc_avg_c_r2, overlap_pct = 0.7)
...
##### KEGG Legacy
```{r echo = F}
kegg_legacy_res_fibvsmc_avg_k_r2_filtered <- filter_redundant_pathways(kegg_legacy_res_fibvsmc_avg_k_r2, overlap_pct = 0.7)
...
##### REACTOME
```{r echo = F}
reactome_res_fibvsmc_avg_k_r2_filtered <- filter_redundant_pathways(reactome_res_fibvsmc_avg_k_r2, overlap_pct = 0.7)
...
##### GO
```{r echo = F}
go_res_fibvsmc_avg_k_r2_filtered <- filter_redundant_pathways(go_res_fibvsmc_avg_k_r2, overlap_pct = 0.7)

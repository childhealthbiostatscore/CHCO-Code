...
```{r echo = F}
clinical_directions <- data.frame(variable = c("mgfr_jodal", "mgfr_jodal_bsa", "tir", "hba1c", "weight", "avg_c_r2", "avg_k_r2"),
                                  direction = c("-", "-", "+", "-", "-", "+","+"))
...
plot_volcano_concordance(pt_mgfr_jodal_bsa_res_combined, 
                          ...
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "\u0394 mGFR (BSA) + treatment",
                          positive_text = "Positively associated with \u0394 mGFR (BSA)",
                          negative_text = "Negatively associated with \u0394 mGFR (BSA)",
...
plot_volcano(tal_weight_res_combined, "logFC_weight_delta", 
             ...
             formula = "\u0394 weight + treatment",
             positive_text = "Positively associated with \u0394 weight",
             negative_text = "Negatively associated with \u0394 weight"m
             cell_type = "TAL")

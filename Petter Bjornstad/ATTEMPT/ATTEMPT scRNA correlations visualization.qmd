...
```{r echo = F}
plot_volcano_associations(pt_mgfr_raw_res_combined, 
                          "logFC_gfr_raw_plasma_delta", 
                          "p_gfr_raw_plasma_delta",
                          "PT Raw mGFR", 
                          "logFC mGFR (Raw)", 
                          "-log10(p-value)",
                          "nebula/pt_mgfr_raw_trtcolors",
                          treatment_results = pt_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "mGFR (Raw) + treatment",
                          positive_text = "Positively associated with mGFR",
                          negative_text = "Negatively associated with mGFR")
...
plot_volcano_associations(pt_mgfr_raw_res_combined, 
                          ...
                          "logFC mGFR (Raw)", 
                          "-log10(p-value)",
                          "nebula/pt_mgfr_raw_trtcolors_fdr",
                          treatment_results = pt_nebula_res_combined_reml_pooled,
...
plot_volcano_associations(pt_mgfr_raw_res_combined, 
                          ...
                          "-log10(p-value)",
                          "nebula/pt_mgfr_raw_trtcolors_fdr",
                          treatment_results = subset(pt_nebula_res_combined_reml_pooled, abs(`logFC_treatmentDapagliflozin:visitPOST`)>.5),
                          treatment_p_col = "fdr_interaction",
                          formula = "mGFR (Raw) + treatment",
                          positive_text = "Positively associated with mGFR",
                          negative_text = "Negatively associated with mGFR")
...
```{r echo = F}
plot_volcano_associations(pt_mgfr_bsa_res_combined, 
                          "logFC_gfr_bsa_plasma_delta", 
                          "p_gfr_bsa_plasma_delta",
                          "PT BSA mGFR", 
                          "logFC mGFR (BSA)", 
                          "-log10(p-value)",
                          "nebula/pt_mgfr_bsa_trtcolors",
                          treatment_results = pt_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "mGFR (BSA) + treatment",
                          positive_text = "Positively associated with mGFR",
                          negative_text = "Negatively associated with mGFR")
```
...
plot_volcano_associations(pt_tir_res_combined, 
                          ...
                          treatment_results = pt_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "TIR + treatment",
                          positive_text = "Positively associated with TIR",
                          negative_text = "Negatively associated with TIR")
```
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_pt_tir, title = "PT Top 30 TIR Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_pt_tir, title = "PT Top 30  TIR Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_pt_tir, title = "PT Top 30  TIR Associations GO", xmin = 1.4, xmax = 5)
...
plot_volcano_associations(pt_hba1c_res_combined, 
                          ...
                          treatment_results = pt_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "HbA1c + treatment",
                          positive_text = "Positively associated with HbA1c",
                          negative_text = "Negatively associated with HbA1c")
```
...
plot_volcano_associations(pt_weight_res_combined, 
                          ...
                          treatment_results = pt_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "Weight + treatment",
                          positive_text = "Positively associated with Weight",
                          negative_text = "Negatively associated with Weight")
```
...
pt_avg_c_r2_res_combined<- subset(pt_avg_c_r2_res_combined, logFC_avg_c_r2_delta >-50)
```
...
plot_volcano_associations(pt_avg_c_r2_res_combined, 
                          ...
                          treatment_results = pt_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "avg cortical R2* + treatment",
                          positive_text = "Positively associated with avg cortical R2*",
                          negative_text = "Negatively associated with avg cortical R2*")
```
...
```{r echo = F}
plot_volcano_associations(subset(pt_avg_k_r2_res_combined, logFC_avg_k_r2_delta >-50), 
                          ...
                          treatment_results = pt_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "avg kidney R2* + treatment",
                          positive_text = "Positively associated with avg kidney R2*",
                          negative_text = "Negatively associated with avg kidney R2*")
```
...
```{r echo = F}
plot_volcano_associations(tal_mgfr_raw_res_combined, 
                          "logFC_gfr_raw_plasma_delta", 
                          "p_gfr_raw_plasma_delta",
                          "TAL Raw mGFR", 
                          "logFC mGFR (Raw)", 
                          "-log10(p-value)",
                          "nebula/tal_mgfr_raw_trtcolors",
...
```{r echo = F}
plot_volcano_associations(tal_mgfr_bsa_res_combined, 
                          "logFC_gfr_bsa_plasma_delta", 
                          "p_gfr_bsa_plasma_delta",
                          "TAL BSA mGFR", 
                          "logFC mGFR (BSA)", 
                          "-log10(p-value)",
                          "nebula/tal_mgfr_bsa_trtcolors",
                          treatment_results = tal_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "mGFR (BSA) + treatment",
                          positive_text = "Positively associated with mGFR",
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_tal_tir, title = "TAL Top 30 TIR Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_tal_tir, title = "TAL Top 30  TIR Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_tal_tir, title = "TAL Top 30  TIR Associations GO", xmin = 1.4, xmax = 5)
...
tal_avg_c_r2_res_combined<- subset(tal_avg_c_r2_res_combined, logFC_avg_c_r2_delta >-50)

```

```{r echo = F}
plot_volcano_associations(tal_avg_c_r2_res_combined, 
                          "logFC_avg_c_r2_delta", 
                          "p_avg_c_r2_delta",
                          "TAL avg cortical R2*", 
                          "logFC avg cortical R2*", 
...
```{r echo = F}
plot_volcano_associations(subset(tal_avg_k_r2_res_combined, logFC_avg_k_r2_delta >-50), 
                          "logFC_avg_k_r2_delta", 
                          "p_avg_k_r2_delta",
                          "TAL avg kidney R2*", 
                          "logFC avg kidney R2*", 
...
```{r echo = F}
plot_volcano_associations(immune_mgfr_raw_res_combined, 
                          "logFC_gfr_raw_plasma_delta", 
                          "p_gfr_raw_plasma_delta",
                          "Immune Raw mGFR", 
                          "logFC mGFR (Raw)", 
                          "-log10(p-value)",
                          "nebula/immune_mgfr_raw_trtcolors",
...
```{r echo = F}
plot_volcano_associations(immune_mgfr_bsa_res_combined, 
                          "logFC_gfr_bsa_plasma_delta", 
                          "p_gfr_bsa_plasma_delta",
                          "Immune BSA mGFR", 
                          "logFC mGFR (BSA)", 
                          "-log10(p-value)",
                          "nebula/immune_mgfr_bsa_trtcolors",
                          treatment_results = immune_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "mGFR (BSA) + treatment",
                          positive_text = "Positively associated with mGFR",
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_tir, title = "Immune Top 30 TIR Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_tir, title = "Immune Top 30  TIR Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_tir, title = "Immune Top 30  TIR Associations GO", xmin = 1.4, xmax = 5)
...
immune_avg_c_r2_res_combined<- subset(immune_avg_c_r2_res_combined, logFC_avg_c_r2_delta >-50)
```
...
```{r echo = F}
plot_volcano_associations(subset(immune_avg_k_r2_res_combined, logFC_avg_k_r2_delta >-50), 
                          "logFC_avg_k_r2_delta", 
                          "p_avg_k_r2_delta",
...
```{r echo = F}
# Read in nebula results saved to kopah
immune_myeloid_mgfr_raw_res <- s3readRDS('associations/nebula/mgfr_raw/immune_myeloid_attempt_nebula_mgfr_raw.rds', bucket = "attempt", region = "")

# nebula only keeps results for converged
immune_myeloid_mgfr_raw_convergence <- map_dfr(
  names(immune_myeloid_mgfr_raw_res),
  function(gene_name) {
    converged <- immune_myeloid_mgfr_raw_res[[gene_name]]$convergence
    df <- data.frame(Gene = gene_name,
                     Convergence_Code = converged)
    return(df)
  }
...
immune_myeloid_mgfr_raw_converged <- immune_myeloid_mgfr_raw_convergence %>%
  filter(Convergence_Code >=-10)

immune_myeloid_mgfr_raw_res_combined <- map_dfr(
  names(immune_myeloid_mgfr_raw_res),
  function(gene_name) {
    df <- immune_myeloid_mgfr_raw_res[[gene_name]]$summary
    df <- df %>% filter(gene_name %in% immune_myeloid_mgfr_raw_converged$Gene) %>%
      mutate(Gene = gene_name)
    return(df)
  }
)

immune_myeloid_mgfr_raw_res_combined <- immune_myeloid_mgfr_raw_res_combined %>%
  ungroup() %>%
  mutate(fdr_interaction = p.adjust(p_gfr_raw_plasma_delta, method = "fdr"))

immune_myeloid_mgfr_raw_res_combined_disp <- map_dfr(
  names(immune_myeloid_mgfr_raw_res),
  function(gene_name) {
    df <- immune_myeloid_mgfr_raw_res[[gene_name]]$overdispersion
    df <- df %>% mutate(Gene = gene_name)
    return(df)
  }
)
...
```{r echo = F}
plot_volcano_associations(immune_myeloid_mgfr_raw_res_combined, 
                          "logFC_gfr_raw_plasma_delta", 
                          "p_gfr_raw_plasma_delta",
                          "Immune - Myeloid Raw mGFR", 
                          "logFC mGFR (Raw)", 
                          "-log10(p-value)",
                          "nebula/immune_myeloid_mgfr_raw_trtcolors",
...
```{r echo =F}
plot_volcano(immune_myeloid_mgfr_raw_res_combined, "logFC_gfr_raw_plasma_delta", 
             "p_gfr_raw_plasma_delta",
             "Immune_myeloid Raw mGFR (REML & Pooled offset)", 
             "logFC mGFR (Raw)", 
             "-log10(p-value)",
             "nebula/immune_myeloid_mgfr_raw",
             formula = "mGFR (Raw) + treatment",
             positive_text = "Positively associated with mGFR",
             negative_text = "Negatively associated with mGFR")
...
plot_volcano(immune_myeloid_mgfr_raw_res_combined, "logFC_gfr_raw_plasma_delta", 
             ...
             "logFC mGFR (Raw)", 
             "-log10(FDR adjusted p-value)",
             "nebula/immune_myeloid_mgfr_raw_fdr",
             formula = "mGFR (Raw) + treatment",
             positive_text = "Positively associated with mGFR",
             negative_text = "Negatively associated with mGFR")
```
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(immune_myeloid_mgfr_raw_res_combined$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(immune_myeloid_mgfr_raw_res_combined$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(immune_myeloid_mgfr_raw_res_combined$Gene), savefile = FALSE)

# rank genes by logFC
rankings_immune_myeloid_mgfr_raw <- immune_myeloid_mgfr_raw_res_combined$logFC_gfr_raw_plasma_delta
names(rankings_immune_myeloid_mgfr_raw) <- immune_myeloid_mgfr_raw_res_combined$Gene
rankings_immune_myeloid_mgfr_raw <- sort(rankings_immune_myeloid_mgfr_raw, decreasing = TRUE)
plot(rankings_immune_myeloid_mgfr_raw)
min(rankings_immune_myeloid_mgfr_raw)
max(rankings_immune_myeloid_mgfr_raw)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_immune_myeloid_mgfr_raw <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_immune_myeloid_mgfr_raw,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_immune_myeloid_mgfr_raw <- fgsea(pathways = reactome,
                              stats = rankings_immune_myeloid_mgfr_raw,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_immune_myeloid_mgfr_raw <- fgsea(pathways = go,
                        stats = rankings_immune_myeloid_mgfr_raw,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_immune_myeloid_mgfr_raw[, padj < 0.05], na.rm = T), sum(kegg_legacy_res_immune_myeloid_mgfr_raw[, pval < 0.05], na.rm = T)),
                         "REACTOME"=c(sum(reactome_res_immune_myeloid_mgfr_raw[, padj < 0.05], na.rm = T), sum(reactome_res_immune_myeloid_mgfr_raw[, pval < 0.05], na.rm = T)),
                         "GO"=c(sum(go_res_immune_myeloid_mgfr_raw[, padj < 0.05], na.rm = T), sum(go_res_immune_myeloid_mgfr_raw[, pval < 0.05], na.rm = T)))
rownames(fgsea) <- c("adj.pval", "p.val")
```

##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_myeloid_mgfr_raw, title = "Immune_myeloid Top 30 Raw mGFR Associations KEGG", xmin = 1, xmax = 3)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_myeloid_mgfr_raw_top30_kegg_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```

##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_myeloid_mgfr_raw, title = "Immune_myeloid Top 30  Raw mGFR Associations REACTOME", xmin = 1.1, xmax = 3.5)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_myeloid_mgfr_raw_top30_reactome_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_myeloid_mgfr_raw, title = "Immune_myeloid Top 30  Raw mGFR Associations GO", xmin = 1.4, xmax = 5)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_myeloid_mgfr_raw_top30_go_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```
...
```{r echo = F}
# Read in nebula results saved to kopah
immune_myeloid_mgfr_bsa_res <- s3readRDS('associations/nebula/mgfr_bsa/immune_myeloid_attempt_nebula_mgfr_bsa.rds', bucket = "attempt", region = "")

# nebula only keeps results for converged
immune_myeloid_mgfr_bsa_convergence <- map_dfr(
  names(immune_myeloid_mgfr_bsa_res),
  function(gene_name) {
    converged <- immune_myeloid_mgfr_bsa_res[[gene_name]]$convergence
    df <- data.frame(Gene = gene_name,
                     Convergence_Code = converged)
    return(df)
  }
...
immune_myeloid_mgfr_bsa_converged <- immune_myeloid_mgfr_bsa_convergence %>%
  filter(Convergence_Code >=-10)

immune_myeloid_mgfr_bsa_res_combined <- map_dfr(
  names(immune_myeloid_mgfr_bsa_res),
  function(gene_name) {
    df <- immune_myeloid_mgfr_bsa_res[[gene_name]]$summary
    df <- df %>% filter(gene_name %in% immune_myeloid_mgfr_bsa_converged$Gene) %>%
      mutate(Gene = gene_name)
    return(df)
  }
)

immune_myeloid_mgfr_bsa_res_combined <- immune_myeloid_mgfr_bsa_res_combined %>%
  ungroup() %>%
  mutate(fdr_interaction = p.adjust(p_gfr_bsa_plasma_delta, method = "fdr"))

immune_myeloid_mgfr_bsa_res_combined_disp <- map_dfr(
  names(immune_myeloid_mgfr_bsa_res),
  function(gene_name) {
    df <- immune_myeloid_mgfr_bsa_res[[gene_name]]$overdispersion
    df <- df %>% mutate(Gene = gene_name)
    return(df)
  }
)
...
```{r echo = F}
plot_volcano_associations(immune_myeloid_mgfr_bsa_res_combined, 
                          "logFC_gfr_bsa_plasma_delta", 
                          "p_gfr_bsa_plasma_delta",
                          "Immune - Myeloid BSA mGFR", 
                          "logFC mGFR (BSA)", 
                          "-log10(p-value)",
                          "nebula/immune_myeloid_mgfr_bsa_trtcolors",
                          treatment_results = immune_myeloid_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "mGFR (BSA) + treatment",
                          positive_text = "Positively associated with mGFR",
...
```{r echo =F}
plot_volcano(immune_myeloid_mgfr_bsa_res_combined, "logFC_gfr_bsa_plasma_delta", 
             "p_gfr_bsa_plasma_delta",
             "Immune_myeloid BSA mGFR (REML & Pooled offset)", 
             "logFC mGFR (BSA)", 
             "-log10(p-value)",
             "nebula/immune_myeloid_mgfr_bsa",
             formula = "mGFR (BSA) + treatment",
             positive_text = "Positively associated with mGFR",
             negative_text = "Negatively associated with mGFR")
...
plot_volcano(immune_myeloid_mgfr_bsa_res_combined, "logFC_gfr_bsa_plasma_delta", 
             ...
             "logFC mGFR (BSA)", 
             "-log10(FDR adjusted p-value)",
             "nebula/immune_myeloid_mgfr_bsa_fdr",
             formula = "mGFR (BSA) + treatment",
             positive_text = "Positively associated with mGFR",
             negative_text = "Negatively associated with mGFR")
```
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(immune_myeloid_mgfr_bsa_res_combined$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(immune_myeloid_mgfr_bsa_res_combined$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(immune_myeloid_mgfr_bsa_res_combined$Gene), savefile = FALSE)

# rank genes by logFC
rankings_immune_myeloid_mgfr_bsa <- immune_myeloid_mgfr_bsa_res_combined$logFC_gfr_bsa_plasma_delta
names(rankings_immune_myeloid_mgfr_bsa) <- immune_myeloid_mgfr_bsa_res_combined$Gene
rankings_immune_myeloid_mgfr_bsa <- sort(rankings_immune_myeloid_mgfr_bsa, decreasing = TRUE)
plot(rankings_immune_myeloid_mgfr_bsa)
min(rankings_immune_myeloid_mgfr_bsa)
max(rankings_immune_myeloid_mgfr_bsa)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_immune_myeloid_mgfr_bsa <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_immune_myeloid_mgfr_bsa,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_immune_myeloid_mgfr_bsa <- fgsea(pathways = reactome,
                              stats = rankings_immune_myeloid_mgfr_bsa,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_immune_myeloid_mgfr_bsa <- fgsea(pathways = go,
                        stats = rankings_immune_myeloid_mgfr_bsa,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_immune_myeloid_mgfr_bsa[, padj < 0.05], na.rm = T), sum(kegg_legacy_res_immune_myeloid_mgfr_bsa[, pval < 0.05], na.rm = T)),
                         "REACTOME"=c(sum(reactome_res_immune_myeloid_mgfr_bsa[, padj < 0.05], na.rm = T), sum(reactome_res_immune_myeloid_mgfr_bsa[, pval < 0.05], na.rm = T)),
                         "GO"=c(sum(go_res_immune_myeloid_mgfr_bsa[, padj < 0.05], na.rm = T), sum(go_res_immune_myeloid_mgfr_bsa[, pval < 0.05], na.rm = T)))
rownames(fgsea) <- c("adj.pval", "p.val")
```

##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_myeloid_mgfr_bsa, title = "Immune_myeloid Top 30 BSA mGFR Associations KEGG", xmin = 1, xmax = 3)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_myeloid_mgfr_bsa_top30_kegg_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```

##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_myeloid_mgfr_bsa, title = "Immune_myeloid Top 30 BSA mGFR Associations REACTOME", xmin = 1.1, xmax = 3.5)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_myeloid_mgfr_bsa_top30_reactome_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_myeloid_mgfr_bsa, title = "Immune_myeloid Top 30 BSA mGFR Associations GO", xmin = 1.4, xmax = 5)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_myeloid_mgfr_bsa_top30_go_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_myeloid_tir, title = "Immune_myeloid Top 30 TIR Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_myeloid_tir, title = "Immune_myeloid Top 30  TIR Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_myeloid_tir, title = "Immune_myeloid Top 30  TIR Associations GO", xmin = 1.4, xmax = 5)
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_myeloid_hba1c, title = "Immune_myeloid Top 30 HbA1c Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_myeloid_hba1c, title = "Immune_myeloid Top 30  HbA1c Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_myeloid_hba1c, title = "Immune_myeloid Top 30  HbA1c Associations GO", xmin = 1.4, xmax = 5)
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_myeloid_weight, title = "Immune_myeloid Top 30 Weight Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_myeloid_weight, title = "Immune_myeloid Top 30  Weight Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_myeloid_weight, title = "Immune_myeloid Top 30  Weight Associations GO", xmin = 1.4, xmax = 5)
...
immune_myeloid_avg_c_r2_res_combined<- subset(immune_myeloid_avg_c_r2_res_combined, logFC_avg_c_r2_delta >-50)
```
...
```{r echo =F}
plot_volcano(subset(immune_myeloid_avg_c_r2_res_combined, logFC_avg_c_r2_delta >-50), "logFC_avg_c_r2_delta", 
             "p_avg_c_r2_delta",
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_myeloid_avg_c_r2, title = "Immune_myeloid Top 30 Avg Cortical R2* Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_myeloid_avg_c_r2, title = "Immune_myeloid Top 30  Avg Cortical R2* Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_myeloid_avg_c_r2, title = "Immune_myeloid Top 30  Avg Cortical R2* Associations GO", xmin = 1.4, xmax = 5)
...
```{r echo = F}
plot_volcano_associations(subset(immune_myeloid_avg_k_r2_res_combined, logFC_avg_k_r2_delta >-50), 
                          "logFC_avg_k_r2_delta", 
                          "p_avg_k_r2_delta",
...
```{r echo =F}
plot_volcano(subset(immune_myeloid_avg_k_r2_res_combined, logFC_avg_k_r2_delta >-50), "logFC_avg_k_r2_delta", 
             "p_avg_k_r2_delta",
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_myeloid_avg_k_r2, title = "Immune_myeloid Top 30 Avg Kidney R2* Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_myeloid_avg_k_r2, title = "Immune_myeloid Top 30  Avg Kidney R2* Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_myeloid_avg_k_r2, title = "Immune_myeloid Top 30  Avg Kidney R2* Associations GO", xmin = 1.4, xmax = 5)
...
```{r echo = F}
# Read in nebula results saved to kopah
immune_lymphoid_mgfr_raw_res <- s3readRDS('associations/nebula/mgfr_raw/immune_lymphoid_attempt_nebula_mgfr_raw.rds', bucket = "attempt", region = "")

# nebula only keeps results for converged
immune_lymphoid_mgfr_raw_convergence <- map_dfr(
  names(immune_lymphoid_mgfr_raw_res),
  function(gene_name) {
    converged <- immune_lymphoid_mgfr_raw_res[[gene_name]]$convergence
    df <- data.frame(Gene = gene_name,
                     Convergence_Code = converged)
    return(df)
  }
...
immune_lymphoid_mgfr_raw_converged <- immune_lymphoid_mgfr_raw_convergence %>%
  filter(Convergence_Code >=-10)

immune_lymphoid_mgfr_raw_res_combined <- map_dfr(
  names(immune_lymphoid_mgfr_raw_res),
  function(gene_name) {
    df <- immune_lymphoid_mgfr_raw_res[[gene_name]]$summary
    df <- df %>% filter(gene_name %in% immune_lymphoid_mgfr_raw_converged$Gene) %>%
      mutate(Gene = gene_name)
    return(df)
  }
)

immune_lymphoid_mgfr_raw_res_combined <- immune_lymphoid_mgfr_raw_res_combined %>%
  ungroup() %>%
  mutate(fdr_interaction = p.adjust(p_gfr_raw_plasma_delta, method = "fdr"))

immune_lymphoid_mgfr_raw_res_combined_disp <- map_dfr(
  names(immune_lymphoid_mgfr_raw_res),
  function(gene_name) {
    df <- immune_lymphoid_mgfr_raw_res[[gene_name]]$overdispersion
    df <- df %>% mutate(Gene = gene_name)
    return(df)
  }
)
...
```{r echo = F}
plot_volcano_associations(immune_lymphoid_mgfr_raw_res_combined, 
                          "logFC_gfr_raw_plasma_delta", 
                          "p_gfr_raw_plasma_delta",
                          "Immune - Lymphoid Raw mGFR", 
                          "logFC mGFR (Raw)", 
                          "-log10(p-value)",
                          "nebula/immune_lymphoid_mgfr_raw_trtcolors",
...
```{r echo =F}
plot_volcano(immune_lymphoid_mgfr_raw_res_combined, "logFC_gfr_raw_plasma_delta", 
             "p_gfr_raw_plasma_delta",
             "Immune_lymphoid Raw mGFR (REML & Pooled offset)", 
             "logFC mGFR (Raw)", 
             "-log10(p-value)",
             "nebula/immune_lymphoid_mgfr_raw",
             formula = "mGFR (Raw) + treatment",
             positive_text = "Positively associated with mGFR",
             negative_text = "Negatively associated with mGFR")
...
plot_volcano(immune_lymphoid_mgfr_raw_res_combined, "logFC_gfr_raw_plasma_delta", 
             ...
             "logFC mGFR (Raw)", 
             "-log10(FDR adjusted p-value)",
             "nebula/immune_lymphoid_mgfr_raw_fdr",
             formula = "mGFR (Raw) + treatment",
             positive_text = "Positively associated with mGFR",
             negative_text = "Negatively associated with mGFR")
```
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(immune_lymphoid_mgfr_raw_res_combined$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(immune_lymphoid_mgfr_raw_res_combined$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(immune_lymphoid_mgfr_raw_res_combined$Gene), savefile = FALSE)

# rank genes by logFC
rankings_immune_lymphoid_mgfr_raw <- immune_lymphoid_mgfr_raw_res_combined$logFC_gfr_raw_plasma_delta
names(rankings_immune_lymphoid_mgfr_raw) <- immune_lymphoid_mgfr_raw_res_combined$Gene
rankings_immune_lymphoid_mgfr_raw <- sort(rankings_immune_lymphoid_mgfr_raw, decreasing = TRUE)
plot(rankings_immune_lymphoid_mgfr_raw)
min(rankings_immune_lymphoid_mgfr_raw)
max(rankings_immune_lymphoid_mgfr_raw)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_immune_lymphoid_mgfr_raw <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_immune_lymphoid_mgfr_raw,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_immune_lymphoid_mgfr_raw <- fgsea(pathways = reactome,
                              stats = rankings_immune_lymphoid_mgfr_raw,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_immune_lymphoid_mgfr_raw <- fgsea(pathways = go,
                        stats = rankings_immune_lymphoid_mgfr_raw,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_immune_lymphoid_mgfr_raw[, padj < 0.05], na.rm = T), sum(kegg_legacy_res_immune_lymphoid_mgfr_raw[, pval < 0.05], na.rm = T)),
                         "REACTOME"=c(sum(reactome_res_immune_lymphoid_mgfr_raw[, padj < 0.05], na.rm = T), sum(reactome_res_immune_lymphoid_mgfr_raw[, pval < 0.05], na.rm = T)),
                         "GO"=c(sum(go_res_immune_lymphoid_mgfr_raw[, padj < 0.05], na.rm = T), sum(go_res_immune_lymphoid_mgfr_raw[, pval < 0.05], na.rm = T)))
rownames(fgsea) <- c("adj.pval", "p.val")
```

##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_lymphoid_mgfr_raw, title = "Immune_lymphoid Top 30 Raw mGFR Associations KEGG", xmin = 1, xmax = 3)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_lymphoid_mgfr_raw_top30_kegg_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```

##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_lymphoid_mgfr_raw, title = "Immune_lymphoid Top 30  Raw mGFR Associations REACTOME", xmin = 1.1, xmax = 3.5)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_lymphoid_mgfr_raw_top30_reactome_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_lymphoid_mgfr_raw, title = "Immune_lymphoid Top 30  Raw mGFR Associations GO", xmin = 1.4, xmax = 5)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_lymphoid_mgfr_raw_top30_go_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```
...
```{r echo = F}
# Read in nebula results saved to kopah
immune_lymphoid_mgfr_bsa_res <- s3readRDS('associations/nebula/mgfr_bsa/immune_lymphoid_attempt_nebula_mgfr_bsa.rds', bucket = "attempt", region = "")

# nebula only keeps results for converged
immune_lymphoid_mgfr_bsa_convergence <- map_dfr(
  names(immune_lymphoid_mgfr_bsa_res),
  function(gene_name) {
    converged <- immune_lymphoid_mgfr_bsa_res[[gene_name]]$convergence
    df <- data.frame(Gene = gene_name,
                     Convergence_Code = converged)
    return(df)
  }
...
immune_lymphoid_mgfr_bsa_converged <- immune_lymphoid_mgfr_bsa_convergence %>%
  filter(Convergence_Code >=-10)

immune_lymphoid_mgfr_bsa_res_combined <- map_dfr(
  names(immune_lymphoid_mgfr_bsa_res),
  function(gene_name) {
    df <- immune_lymphoid_mgfr_bsa_res[[gene_name]]$summary
    df <- df %>% filter(gene_name %in% immune_lymphoid_mgfr_bsa_converged$Gene) %>%
      mutate(Gene = gene_name)
    return(df)
  }
)

immune_lymphoid_mgfr_bsa_res_combined <- immune_lymphoid_mgfr_bsa_res_combined %>%
  ungroup() %>%
  mutate(fdr_interaction = p.adjust(p_gfr_bsa_plasma_delta, method = "fdr"))

immune_lymphoid_mgfr_bsa_res_combined_disp <- map_dfr(
  names(immune_lymphoid_mgfr_bsa_res),
  function(gene_name) {
    df <- immune_lymphoid_mgfr_bsa_res[[gene_name]]$overdispersion
    df <- df %>% mutate(Gene = gene_name)
    return(df)
  }
)
...
```{r echo = F}
plot_volcano_associations(immune_lymphoid_mgfr_bsa_res_combined, 
                          "logFC_gfr_bsa_plasma_delta", 
                          "p_gfr_bsa_plasma_delta",
                          "Immune - Lymphoid BSA mGFR", 
                          "logFC mGFR (BSA)", 
                          "-log10(p-value)",
                          "nebula/immune_lymphoid_mgfr_bsa_trtcolors",
                          treatment_results = immune_lymphoid_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "mGFR (BSA) + treatment",
                          positive_text = "Positively associated with mGFR",
...
```{r echo =F}
plot_volcano(immune_lymphoid_mgfr_bsa_res_combined, "logFC_gfr_bsa_plasma_delta", 
             "p_gfr_bsa_plasma_delta",
             "Immune_lymphoid BSA mGFR (REML & Pooled offset)", 
             "logFC mGFR (BSA)", 
             "-log10(p-value)",
             "nebula/immune_lymphoid_mgfr_bsa",
             formula = "mGFR (BSA) + treatment",
             positive_text = "Positively associated with mGFR",
             negative_text = "Negatively associated with mGFR")
...
plot_volcano(immune_lymphoid_mgfr_bsa_res_combined, "logFC_gfr_bsa_plasma_delta", 
             ...
             "logFC mGFR (BSA)", 
             "-log10(FDR adjusted p-value)",
             "nebula/immune_lymphoid_mgfr_bsa_fdr",
             formula = "mGFR (BSA) + treatment",
             positive_text = "Positively associated with mGFR",
             negative_text = "Negatively associated with mGFR")
```
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(immune_lymphoid_mgfr_bsa_res_combined$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(immune_lymphoid_mgfr_bsa_res_combined$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(immune_lymphoid_mgfr_bsa_res_combined$Gene), savefile = FALSE)

# rank genes by logFC
rankings_immune_lymphoid_mgfr_bsa <- immune_lymphoid_mgfr_bsa_res_combined$logFC_gfr_bsa_plasma_delta
names(rankings_immune_lymphoid_mgfr_bsa) <- immune_lymphoid_mgfr_bsa_res_combined$Gene
rankings_immune_lymphoid_mgfr_bsa <- sort(rankings_immune_lymphoid_mgfr_bsa, decreasing = TRUE)
plot(rankings_immune_lymphoid_mgfr_bsa)
min(rankings_immune_lymphoid_mgfr_bsa)
max(rankings_immune_lymphoid_mgfr_bsa)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_immune_lymphoid_mgfr_bsa <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_immune_lymphoid_mgfr_bsa,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_immune_lymphoid_mgfr_bsa <- fgsea(pathways = reactome,
                              stats = rankings_immune_lymphoid_mgfr_bsa,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_immune_lymphoid_mgfr_bsa <- fgsea(pathways = go,
                        stats = rankings_immune_lymphoid_mgfr_bsa,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_immune_lymphoid_mgfr_bsa[, padj < 0.05], na.rm = T), sum(kegg_legacy_res_immune_lymphoid_mgfr_bsa[, pval < 0.05], na.rm = T)),
                         "REACTOME"=c(sum(reactome_res_immune_lymphoid_mgfr_bsa[, padj < 0.05], na.rm = T), sum(reactome_res_immune_lymphoid_mgfr_bsa[, pval < 0.05], na.rm = T)),
                         "GO"=c(sum(go_res_immune_lymphoid_mgfr_bsa[, padj < 0.05], na.rm = T), sum(go_res_immune_lymphoid_mgfr_bsa[, pval < 0.05], na.rm = T)))
rownames(fgsea) <- c("adj.pval", "p.val")
```

##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_lymphoid_mgfr_bsa, title = "Immune_lymphoid Top 30 BSA mGFR Associations KEGG", xmin = 1, xmax = 3)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_lymphoid_mgfr_bsa_top30_kegg_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```

##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_lymphoid_mgfr_bsa, title = "Immune_lymphoid Top 30 BSA mGFR Associations REACTOME", xmin = 1.1, xmax = 3.5)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_lymphoid_mgfr_bsa_top30_reactome_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_lymphoid_mgfr_bsa, title = "Immune_lymphoid Top 30 BSA mGFR Associations GO", xmin = 1.4, xmax = 5)

ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/nebula/immune_lymphoid_mgfr_bsa_top30_go_pathways.jpeg",
       width = 27.5, height = 14, scale = 1)
```
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_lymphoid_tir, title = "Immune_lymphoid Top 30 TIR Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_lymphoid_tir, title = "Immune_lymphoid Top 30  TIR Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_lymphoid_tir, title = "Immune_lymphoid Top 30  TIR Associations GO", xmin = 1.4, xmax = 5)
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_lymphoid_hba1c, title = "Immune_lymphoid Top 30 HbA1c Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_lymphoid_hba1c, title = "Immune_lymphoid Top 30  HbA1c Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_lymphoid_hba1c, title = "Immune_lymphoid Top 30  HbA1c Associations GO", xmin = 1.4, xmax = 5)
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_lymphoid_weight, title = "Immune_lymphoid Top 30 Weight Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_lymphoid_weight, title = "Immune_lymphoid Top 30  Weight Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_lymphoid_weight, title = "Immune_lymphoid Top 30  Weight Associations GO", xmin = 1.4, xmax = 5)
...
immune_lymphoid_avg_c_r2_res_combined<- subset(immune_lymphoid_avg_c_r2_res_combined, logFC_avg_c_r2_delta >-50)
```
...
```{r echo =F}
plot_volcano(subset(immune_lymphoid_avg_c_r2_res_combined, logFC_avg_c_r2_delta >-50), "logFC_avg_c_r2_delta", 
             "p_avg_c_r2_delta",
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_lymphoid_avg_c_r2, title = "Immune_lymphoid Top 30 Avg Cortical R2* Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_lymphoid_avg_c_r2, title = "Immune_lymphoid Top 30  Avg Cortical R2* Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_lymphoid_avg_c_r2, title = "Immune_lymphoid Top 30  Avg Cortical R2* Associations GO", xmin = 1.4, xmax = 5)
...
```{r echo = F}
plot_volcano_associations(subset(immune_lymphoid_avg_k_r2_res_combined, logFC_avg_k_r2_delta >-50), 
                          "logFC_avg_k_r2_delta", 
                          "p_avg_k_r2_delta",
...
```{r echo =F}
plot_volcano(subset(immune_lymphoid_avg_k_r2_res_combined, logFC_avg_k_r2_delta >-50), "logFC_avg_k_r2_delta", 
             "p_avg_k_r2_delta",
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_lymphoid_avg_k_r2, title = "Immune_lymphoid Top 30 Avg Kidney R2* Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_lymphoid_avg_k_r2, title = "Immune_lymphoid Top 30  Avg Kidney R2* Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_lymphoid_avg_k_r2, title = "Immune_lymphoid Top 30  Avg Kidney R2* Associations GO", xmin = 1.4, xmax = 5)
...
```{r echo = F}
plot_volcano_associations(pc_mgfr_raw_res_combined, 
                          "logFC_gfr_raw_plasma_delta", 
                          "p_gfr_raw_plasma_delta",
                          "PC Raw mGFR", 
                          "logFC mGFR (Raw)", 
                          "-log10(p-value)",
                          "nebula/pc_mgfr_raw_trtcolors",
...
```{r echo = F}
plot_volcano_associations(pc_mgfr_bsa_res_combined, 
                          "logFC_gfr_bsa_plasma_delta", 
                          "p_gfr_bsa_plasma_delta",
                          "PC BSA mGFR", 
                          "logFC mGFR (BSA)", 
                          "-log10(p-value)",
                          "nebula/pc_mgfr_bsa_trtcolors",
                          treatment_results = pc_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "mGFR (BSA) + treatment",
                          positive_text = "Positively associated with mGFR",
...
```{r echo = F}
plot_volcano_associations(subset(pc_tir_res_combined, logFC_tir_delta >-50), 
                          "logFC_tir_delta", 
                          "p_tir_delta",
                          "PC TIR", 
                          "logFC TIR", 
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_pc_tir, title = "PC Top 30 TIR Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_pc_tir, title = "PC Top 30  TIR Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_pc_tir, title = "PC Top 30  TIR Associations GO", xmin = 1.4, xmax = 5)
...
```{r echo = F}
plot_volcano_associations(subset(pc_hba1c_res_combined, logFC_hba1c_delta >-50), 
                          "logFC_hba1c_delta", 
                          "p_hba1c_delta",
                          "PC HbA1c", 
                          "logFC HbA1c", 
...
pc_avg_c_r2_res_combined<- subset(pc_avg_c_r2_res_combined, logFC_avg_c_r2_delta >-50)
...
```{r echo = F}
plot_volcano_associations(subset(pc_avg_k_r2_res_combined, logFC_avg_k_r2_delta >-50), 
                          "logFC_avg_k_r2_delta", 
                          "p_avg_k_r2_delta",
                          "PC avg kidney R2*", 
                          "logFC avg kidney R2*", 
...
```{r echo = F}
plot_volcano_associations(ic_mgfr_raw_res_combined, 
                          "logFC_gfr_raw_plasma_delta", 
                          "p_gfr_raw_plasma_delta",
                          "IC Raw mGFR", 
                          "logFC mGFR (Raw)", 
                          "-log10(p-value)",
                          "nebula/ic_mgfr_raw_trtcolors",
...
```{r echo = F}
plot_volcano_associations(ic_mgfr_bsa_res_combined, 
                          "logFC_gfr_bsa_plasma_delta", 
                          "p_gfr_bsa_plasma_delta",
                          "IC BSA mGFR", 
                          "logFC mGFR (BSA)", 
                          "-log10(p-value)",
                          "nebula/ic_mgfr_bsa_trtcolors",
                          treatment_results = ic_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "mGFR (BSA) + treatment",
                          positive_text = "Positively associated with mGFR",
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_ic_tir, title = "IC Top 30 TIR Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_ic_tir, title = "IC Top 30  TIR Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_ic_tir, title = "IC Top 30  TIR Associations GO", xmin = 1.4, xmax = 5)
...
ic_avg_c_r2_res_combined<- subset(ic_avg_c_r2_res_combined, logFC_avg_c_r2_delta >-50)
```
...
```{r echo = F}
plot_volcano_associations(subset(ic_avg_k_r2_res_combined, logFC_avg_k_r2_delta >-50), 
                          "logFC_avg_k_r2_delta", 
                          "p_avg_k_r2_delta",
                          "IC avg kidney R2*", 
                          "logFC avg kidney R2*", 
...
```{r echo = F}
plot_volcano_associations(ec_mgfr_raw_res_combined, 
                          "logFC_gfr_raw_plasma_delta", 
                          "p_gfr_raw_plasma_delta",
                          "EC Raw mGFR", 
                          "logFC mGFR (Raw)", 
                          "-log10(p-value)",
                          "nebula/ec_mgfr_raw_trtcolors",
...
```{r echo = F}
plot_volcano_associations(ec_mgfr_bsa_res_combined, 
                          "logFC_gfr_bsa_plasma_delta", 
                          "p_gfr_bsa_plasma_delta",
                          "EC BSA mGFR", 
                          "logFC mGFR (BSA)", 
                          "-log10(p-value)",
                          "nebula/ec_mgfr_bsa_trtcolors",
                          treatment_results = ec_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "mGFR (BSA) + treatment",
                          positive_text = "Positively associated with mGFR",
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_ec_tir, title = "EC Top 30 TIR Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_ec_tir, title = "EC Top 30  TIR Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_ec_tir, title = "EC Top 30  TIR Associations GO", xmin = 1.4, xmax = 5)
...
ec_avg_c_r2_res_combined<- subset(ec_avg_c_r2_res_combined, logFC_avg_c_r2_delta >-50)
```
...
```{r echo = F}
plot_volcano_associations(subset(ec_avg_k_r2_res_combined, logFC_avg_k_r2_delta >-50), 
                          "logFC_avg_k_r2_delta", 
                          "p_avg_k_r2_delta",
                          "EC avg kidney R2*", 
                          "logFC avg kidney R2*", 
...
```{r echo = F}
plot_volcano_associations(fibvsmc_mgfr_raw_res_combined, 
                          "logFC_gfr_raw_plasma_delta", 
                          "p_gfr_raw_plasma_delta",
                          "FIB, VSMC/P Raw mGFR", 
                          "logFC mGFR (Raw)", 
                          "-log10(p-value)",
                          "nebula/fibvsmc_mgfr_raw_trtcolors",
...
```{r echo = F}
plot_volcano_associations(fibvsmc_mgfr_bsa_res_combined, 
                          "logFC_gfr_bsa_plasma_delta", 
                          "p_gfr_bsa_plasma_delta",
                          "FIB, VSMC/P BSA mGFR", 
                          "logFC mGFR (BSA)", 
                          "-log10(p-value)",
                          "nebula/fibvsmc_mgfr_bsa_trtcolors",
                          treatment_results = fibvsmc_nebula_res_combined_reml_pooled,
                          treatment_p_col = "p_treatmentDapagliflozin:visitPOST",
                          formula = "mGFR (BSA) + treatment",
                          positive_text = "Positively associated with mGFR",
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_fibvsmc_tir, title = "FIB, VSMC/P Top 30 TIR Associations KEGG", xmin = 1, xmax = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_fibvsmc_tir, title = "FIB, VSMC/P Top 30  TIR Associations REACTOME", xmin = 1.1, xmax = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_fibvsmc_tir, title = "FIB, VSMC/P Top 30  TIR Associations GO", xmin = 1.4, xmax = 5)
...
fibvsmc_avg_c_r2_res_combined<- subset(fibvsmc_avg_c_r2_res_combined, logFC_avg_c_r2_delta >-50)
...
```{r echo = F}
plot_volcano_associations(subset(fibvsmc_avg_k_r2_res_combined, logFC_avg_k_r2_delta >-50), 
                          "logFC_avg_k_r2_delta", 
                          "p_avg_k_r2_delta",

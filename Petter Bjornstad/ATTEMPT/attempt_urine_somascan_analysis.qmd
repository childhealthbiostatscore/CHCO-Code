...
plot_fgsea_transpose(soma_DiD_fgsea$kegg, 
                     ...
                     xmax = 30)
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Pathways/urine_SOMA_DiD_KEGG.jpeg"),
       width = 27.5, height = 14, scale = 1)
# REACTOME
plot_fgsea_transpose(soma_DiD_fgsea$reactome, 
                     title = "SOMA DiD Top 30 REACTOME", 
                     xmax = 30)
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Pathways/urine_SOMA_DiD_REACTOME.jpeg"),
       width = 27.5, height = 14, scale = 1)
# GO
plot_fgsea_transpose(soma_DiD_fgsea$go, 
                     title = "SOMA DiD Top 30 GO", 
                     xmax = 30)
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Pathways/urine_SOMA_DiD_GO.jpeg"),
       width = 27.5, height = 14, scale = 1)
```
...
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_spearman_urine_mgfr.jpeg"),
...
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_spearman_urine_mgfr_gene.jpeg"),
...
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_spearman_urine_mgfr_bsa.jpeg"),
...
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_spearman_urine_hba1c.jpeg"),
...
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_spearman_urine_tir.jpeg"),
...
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_spearman_urine_weight.jpeg"),
...
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_spearman_urine_PWV.jpeg"),
...
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_spearman_urine_avg_c_r2.jpeg"),
...
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_spearman_urine_avg_k_r2.jpeg"),
...
plot_fgsea_transpose(soma_DiD_fgsea$kegg, 
                     title = "SOMA DiD Top 30 KEGG",
                     xmax = 30)
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Pathways/urine_creatinine_SOMA_DiD_KEGG.jpeg"),
       width = 27.5, height = 14, scale = 1)
# REACTOME
plot_fgsea_transpose(soma_DiD_fgsea$reactome, 
                     title = "SOMA DiD Top 30 REACTOME", 
                     xmax = 30)
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Pathways/urine_creatinine_SOMA_DiD_REACTOME.jpeg"),
       width = 27.5, height = 14, scale = 1)
# GO
plot_fgsea_transpose(soma_DiD_fgsea$go, 
                     title = "SOMA DiD Top 30 GO", 
                     xmax = 30)
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Pathways/urine_creatinine_SOMA_DiD_GO.jpeg"),
       width = 27.5, height = 14, scale = 1)
```
...
# plots
urine_soma_mgfr$plot_all
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_cr_spearman_urine_mgfr.jpeg"),
       urine_soma_mgfr$plot_all, width = 10, height = 7)
```
...
# plots
urine_soma_mgfr_adj$plot_all
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_cr_spearman_urine_mgfr_bsa.jpeg"),
       urine_soma_mgfr_adj$plot_all, width = 10, height = 7)
```
...
# plots
urine_soma_hba1c$plot_all
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_cr_spearman_urine_hba1c.jpeg"),
       urine_soma_hba1c$plot_all, width = 10, height = 7)
```
### TIR
...
# plots
urine_soma_tir$plot_all
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_cr_spearman_urine_tir.jpeg"),
       urine_soma_tir$plot_all, width = 10, height = 7)
```
...
# plots
urine_soma_weight$plot_all
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_cr_spearman_urine_weight.jpeg"),
       urine_soma_weight$plot_all, width = 10, height = 7)
```
...
# plots
urine_soma_PWV$plot_all
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_cr_spearman_urine_PWV.jpeg"),
       urine_soma_PWV$plot_all, width = 10, height = 7)
```
...
# plots
urine_soma_avg_c_r2$plot_all
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_cr_spearman_urine_avg_c_r2.jpeg"),
       urine_soma_avg_c_r2$plot_all, width = 10, height = 7)
```
...
# plots
urine_soma_avg_k_r2$plot_all
ggsave(file.path(root_path, "ATTEMPT/Results/Figures/Proteomics/Volcano Plots/Correlations/volcano_mixed_cr_spearman_urine_avg_k_r2.jpeg"),
       urine_soma_avg_k_r2$plot_all, width = 10, height = 7)
```
...
pt_urine <- process_nebula_results(pt_urine_raw$results, pval_col = "p_protein")$results
pt_urine <- pt_urine %>%
  mutate(Gene = sub("_.*", "", Gene))
```

```{r echo = F}
plot_volcano(pt_urine, fc = "logFC_protein", p_col = "p_protein", x_axis = "logFC protein", y_axis = "-log10(p.value)", file_suffix = "_kpmp_pt_urine",
             formula = "protein + treatment", cell_type = "PT") + 
...
tal_urine <- process_nebula_results(tal_urine_raw$results, pval_col = "p_protein")$results
tal_urine <- tal_urine %>%
  mutate(Gene = sub("_.*", "", Gene))
```

```{r echo = F}
plot_volcano(tal_urine, fc = "logFC_protein", p_col = "p_protein", x_axis = "logFC protein", y_axis = "-log10(p.value)", file_suffix = "_kpmp_tal_urine",
             formula = "protein + treatment", cell_type = "TAL") + 
  geom_vline(xintercept = 0, color = "grey", linetype = "dashed", size = 0.2)
...
dct_urine <- process_nebula_results(dct_urine_raw$results, pval_col = "p_protein")$results
dct_urine <- dct_urine %>%
  mutate(Gene = sub("_.*", "", Gene))
```

```{r echo = F}
plot_volcano(dct_urine, fc = "logFC_protein", p_col = "p_protein", x_axis = "logFC protein", y_axis = "-log10(p.value)", file_suffix = "_kpmp_dct_urine",
             formula = "protein + treatment", cell_type = "DCT") + 
  geom_vline(xintercept = 0, color = "grey", linetype = "dashed", size = 0.2)
```
...
```{r echo = F}
all_results <- batch_concordance_analysis(
  protein_data = did_res_urine_mixed$results_annotated,

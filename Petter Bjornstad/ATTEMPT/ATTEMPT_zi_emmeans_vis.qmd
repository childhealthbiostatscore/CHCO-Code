...
for (cell in celltypes)  {
  input_path <- paste0(cell,"/nebula/",tolower(cell),"_attempt_hvg_nebula_res_reml_pooled.rds")
  ...
  var_name <- paste0(tolower(cell), "_hvg_nebula_res_combined_reml_pooled")
...
for (cell in celltypes)  {
  ...
  # Assign to variable dynamically
  var_name <- paste0(tolower(cell), "_nebula_res_combined_reml_pooled")
  assign(var_name, annotated_df, envir = .GlobalEnv)
}
```
```{r echo = F, eval = F}
top20_wb <- createWorkbook()

# Loop through and extract top 20 genes per cell type
for (cell in celltypes) {
  var_name <- paste0(tolower(cell), "_hvg_nebula_res_combined_reml_pooled")
  df <- get(var_name)

  # Extract top 20 by lowest p-value
  top_genes <- df %>%
    arrange(`p_treatmentDapagliflozin:visitPOST`) %>%
    slice_head(n = 20)

  # Add a worksheet and write the top genes
  addWorksheet(top20_wb, sheetName = cell)
  writeData(top20_wb, sheet = cell, x = top_genes)
}

# Save the workbook
saveWorkbook(top20_wb, file = "//Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT//Results/top20_hvg_nebula_results_by_celltype.xlsx", overwrite = TRUE)

```


```{r}
celltypes <- c("frPT", "dPOD")

# Full gene set
for (cell in celltypes)  {
  input_path <- paste0(cell,"/nebula/",tolower(cell),"_attempt_nebula.rds")
  cell_df <- s3readRDS(input_path, bucket = "attempt", region = "")
  ...
  var_name <- paste0(tolower(cell), "_nebula_res_combined_reml_pooled")
  assign(var_name, annotated_df, envir = .GlobalEnv)
  write.csv(annotated_df, file.path(root_path, "ATTEMPT/Results/nebula", paste0(tolower(cell), "_kpmp_res.csv")))
}

frpt_nebula_res_combined_reml_pooled
dpod_nebula_res_combined_reml_pooled
```
...
```{r echo = F}
pt_hvg_nebula_res_combined_reml_pooled_sig <- pt_hvg_nebula_res_combined_reml_pooled[pt_hvg_nebula_res_combined_reml_pooled$fdr < 0.05,]
placebo_change <- pt_hvg_nebula_res_combined_reml_pooled_sig$logFC_visitPOST
dapa_change <- placebo_change + pt_hvg_nebula_res_combined_reml_pooled_sig$`logFC_treatmentDapagliflozin:visitPOST`
...
pt_treatment_df <- data.frame(placebo_change = placebo_change,
                              ...
                              Gene = pt_hvg_nebula_res_combined_reml_pooled_sig$Gene)
```


```{r echo = F}
pt_hvg_nebula_res_combined_reml_pooled_sig %>% left_join(pt_treatment_df) %>%
  arrange(fdr) %>%
...
```{r echo =F}
plot_volcano(pt_hvg_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL,
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/pt_hvg_placebo_pvalue_nebula_reml_pooled",
...
pt_hvg_nebula_res_combined_reml_pooled <- pt_hvg_nebula_res_combined_reml_pooled %>%
  rowwise() %>%
  mutate(
    # Derived logFCs
...
# pt_hvg_nebula_res_combined_reml_pooled
pt_hvg_nebula_res_combined_reml_pooled <- pt_hvg_nebula_res_combined_reml_pooled %>%
...
# save input for IPA
## Interaction or DiD
pt_nebula_pooled_ipa_DiD <- pt_hvg_nebula_res_combined_reml_pooled %>%
...
## Placebo (or Visit)
pt_nebula_pooled_ipa_placebo <- pt_hvg_nebula_res_combined_reml_pooled %>%
...
## Dapagliflozin
pt_nebula_pooled_ipa_dapa <- pt_hvg_nebula_res_combined_reml_pooled %>%
...
```{r echo = F}
pt1 <- s3readRDS('PT/PT-1/nebula/PT-1_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
pt1_nebula_processed <- process_nebula_results(pt1)
pt1_hvg_nebula_res_combined_reml_pooled <- pt1_nebula_processed$results

pt2 <- s3readRDS('PT/PT-2/nebula/PT-2_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
pt2_nebula_processed <- process_nebula_results(pt2)
pt2_hvg_nebula_res_combined_reml_pooled <- pt2_nebula_processed$results

pt3 <- s3readRDS('PT/PT-3/nebula/PT-3_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
pt3_nebula_processed <- process_nebula_results(pt3)
pt3_hvg_nebula_res_combined_reml_pooled <- pt3_nebula_processed$results

pt4 <- s3readRDS('PT/PT-4/nebula/PT-4_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
pt4_nebula_processed <- process_nebula_results(pt4)
pt4_hvg_nebula_res_combined_reml_pooled <- pt4_nebula_processed$results

pt5 <- s3readRDS('PT/PT-5/nebula/PT-5_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
pt5_nebula_processed <- process_nebula_results(pt5)
pt5_hvg_nebula_res_combined_reml_pooled <- pt5_nebula_processed$results
```

```{r echo = F}
pt_plots <- create_gene_expression_plots(
  main_results = pt_hvg_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "1" = pt1_hvg_nebula_res_combined_reml_pooled,
    "2" = pt2_hvg_nebula_res_combined_reml_pooled,
    "3" = pt3_hvg_nebula_res_combined_reml_pooled,
    "4" = pt4_hvg_nebula_res_combined_reml_pooled,
    "5" = pt5_hvg_nebula_res_combined_reml_pooled
  ),
  cell_type_prefix = "PT",
  cell_type_labels = c("PT-1", "PT-2", "PT-3", "PT-4", "PT-5"),
  output_prefix = "PT_hvg",
  full_formula = T,
...
```{r echo = F}
pt_nebula_res_combined_reml_pooled_sig <- pt_nebula_res_combined_reml_pooled[pt_nebula_res_combined_reml_pooled$fdr < 0.05,]
placebo_change <- pt_nebula_res_combined_reml_pooled_sig$logFC_visitPOST
dapa_change <- placebo_change + pt_nebula_res_combined_reml_pooled_sig$`logFC_treatmentDapagliflozin:visitPOST`
...
pt_treatment_df <- data.frame(placebo_change = placebo_change,
                              dapa_change = dapa_change,
                              response_type = response_type,
                              Gene = pt_nebula_res_combined_reml_pooled_sig$Gene)
```


```{r echo = F}
pt_nebula_res_combined_reml_pooled_sig %>% left_join(pt_treatment_df) %>%
  arrange(fdr) %>%
  filter(`logFC_treatmentDapagliflozin:visitPOST`>0) %>%
  head(20)
```
...
pt1_nebula_processed <- process_nebula_results(pt1)
pt1_nebula_res_combined_reml_pooled <- pt1_nebula_processed$results

pt2 <- s3readRDS('PT/PT-2/nebula/PT-2_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
pt2_nebula_processed <- process_nebula_results(pt2)
pt2_nebula_res_combined_reml_pooled <- pt2_nebula_processed$results

pt3 <- s3readRDS('PT/PT-3/nebula/PT-3_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
pt3_nebula_processed <- process_nebula_results(pt3)
pt3_nebula_res_combined_reml_pooled <- pt3_nebula_processed$results

pt4 <- s3readRDS('PT/PT-4/nebula/PT-4_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
pt4_nebula_processed <- process_nebula_results(pt4)
pt4_nebula_res_combined_reml_pooled <- pt4_nebula_processed$results

pt5 <- s3readRDS('PT/PT-5/nebula/PT-5_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
pt5_nebula_processed <- process_nebula_results(pt5)
pt5_nebula_res_combined_reml_pooled <- pt5_nebula_processed$results
```

```{r echo = F}
pt_plots <- create_gene_expression_plots(
  main_results = pt_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "1" = pt1_nebula_res_combined_reml_pooled,
    "2" = pt2_nebula_res_combined_reml_pooled,
    "3" = pt3_nebula_res_combined_reml_pooled,
    "4" = pt4_nebula_res_combined_reml_pooled,
    "5" = pt5_nebula_res_combined_reml_pooled
  ),
  cell_type_prefix = "PT",
  cell_type_labels = c("PT-1", "PT-2", "PT-3", "PT-4", "PT-5"),
  output_prefix = "PT",
...
```{r echo =F}
plot_volcano(tal_hvg_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL, 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/tal_hvg_placebo_pvalue_nebula_reml_pooled",
             formula = "treatment * visit", 
             cell_type = "TAL")
...
```{r echo = F, eval = F}
# pull covariance matrix for p-value calculations
tal_hvg_nebula_res_combined_reml_pooled <- tal_hvg_nebula_res_combined_reml_pooled %>%
  rowwise() %>%
  mutate(
    # Derived logFCs
    placebo_pre = logFC_Intercept,
...
# tal_hvg_nebula_res_combined_reml_pooled
tal_hvg_nebula_res_combined_reml_pooled <- tal_hvg_nebula_res_combined_reml_pooled %>%
  mutate(placebo_pre = logFC_Intercept,
         placebo_post = logFC_Intercept + logFC_visitPOST,
         dapa_pre = logFC_Intercept + logFC_treatmentDapagliflozin,
...
# save input for IPA
## Interaction or DiD
tal_nebula_pooled_ipa_DiD <- tal_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr)
...
## Placebo (or Visit)
tal_nebula_pooled_ipa_placebo <- tal_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
...
## Dapagliflozin
tal_nebula_pooled_ipa_dapa <- tal_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
...
```{r echo = F}
tal1 <- s3readRDS('TAL/TAL-1/nebula/TAL-1_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
tal1_nebula_processed <- process_nebula_results(tal1)
tal1_hvg_nebula_res_combined_reml_pooled <- tal1_nebula_processed$results

tal2 <- s3readRDS('TAL/TAL-2/nebula/TAL-2_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
tal2_nebula_processed <- process_nebula_results(tal2)
tal2_hvg_nebula_res_combined_reml_pooled <- tal2_nebula_processed$results

tal3 <- s3readRDS('TAL/TAL-3/nebula/TAL-3_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
tal3_nebula_processed <- process_nebula_results(tal3)
tal3_hvg_nebula_res_combined_reml_pooled <- tal3_nebula_processed$results
```

```{r echo = F}
tal_plots <- create_gene_expression_plots(
  main_results = tal_hvg_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "1" = tal1_hvg_nebula_res_combined_reml_pooled,
    "2" = tal2_hvg_nebula_res_combined_reml_pooled,
    "3" = tal3_hvg_nebula_res_combined_reml_pooled
  ),
  cell_type_labels = c("TAL-1", "TAL-2", "TAL-3"),
  cell_type_prefix = "TAL",
  output_prefix = "TAL_hvg",
  full_formula = T,
  volcano_text_size = 15,
  volcano_caption_size = 12,
  output_dir = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Dot Plots/"
...
tal1_nebula_processed <- process_nebula_results(tal1)
tal1_nebula_res_combined_reml_pooled <- tal1_nebula_processed$results

tal2 <- s3readRDS('TAL/TAL-2/nebula/TAL-2_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
tal2_nebula_processed <- process_nebula_results(tal2)
tal2_nebula_res_combined_reml_pooled <- tal2_nebula_processed$results

tal3 <- s3readRDS('TAL/TAL-3/nebula/TAL-3_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
tal3_nebula_processed <- process_nebula_results(tal3)
tal3_nebula_res_combined_reml_pooled <- tal3_nebula_processed$results
```

```{r echo = F}
tal_plots <- create_gene_expression_plots(
  main_results = tal_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "1" = tal1_nebula_res_combined_reml_pooled,
    "2" = tal2_nebula_res_combined_reml_pooled,
    "3" = tal3_nebula_res_combined_reml_pooled
  ),
  cell_type_labels = c("TAL-1", "TAL-2", "TAL-3"),
  cell_type_prefix = "TAL",
  formula = "treatment * visit",   
...
```{r echo =F}
plot_volcano(pc_hvg_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL, 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/pc_hvg_placebo_pvalue_nebula_reml_pooled",
             formula = "treatment * visit", 
             cell_type = "PC")
...
```{r echo = F, eval = F}
# pull covariance matrix for p-value calculations
pc_hvg_nebula_res_combined_reml_pooled <- pc_hvg_nebula_res_combined_reml_pooled %>%
  rowwise() %>%
  mutate(
    # Derived logFCs
    placebo_pre = logFC_Intercept,
...
# pc_hvg_nebula_res_combined_reml_pooled
pc_hvg_nebula_res_combined_reml_pooled <- pc_hvg_nebula_res_combined_reml_pooled %>%
  mutate(placebo_pre = logFC_Intercept,
         placebo_post = logFC_Intercept + logFC_visitPOST,
         dapa_pre = logFC_Intercept + logFC_treatmentDapagliflozin,
...
# save input for IPA
## Interaction or DiD
pc_nebula_pooled_ipa_DiD <- pc_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr)
...
## Placebo (or Visit)
pc_nebula_pooled_ipa_placebo <- pc_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
...
## Dapagliflozin
pc_nebula_pooled_ipa_dapa <- pc_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
...
```{r echo = F}
pc1 <- s3readRDS('PC/PC-1/nebula/PC-1_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
pc1_nebula_processed <- process_nebula_results(pc1)
pc1_hvg_nebula_res_combined_reml_pooled <- pc1_nebula_processed$results

pc2 <- s3readRDS('PC/PC-2/nebula/PC-2_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
pc2_nebula_processed <- process_nebula_results(pc2)
pc2_hvg_nebula_res_combined_reml_pooled <- pc2_nebula_processed$results

tpc_ic <- s3readRDS('PC/tPC-IC/nebula/tPC-IC_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
tpc_ic_nebula_processed <- process_nebula_results(tpc_ic)
tpc_ic_hvg_nebula_res_combined_reml_pooled <- tpc_ic_nebula_processed$results
```

```{r echo = F}
pc_plots <- create_gene_expression_plots(
  main_results = pc_hvg_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "1" = pc1_hvg_nebula_res_combined_reml_pooled,
    "2" = pc2_hvg_nebula_res_combined_reml_pooled,
    "tPC-IC" = tpc_ic_hvg_nebula_res_combined_reml_pooled
  ),
    formula = "treatment * visit",
  cell_type_labels = c("PC-1", "PC-2", "tPC-IC"),
  cell_type_prefix = "PC",
  output_prefix = "PC_hvg",
  output_dir = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Dot Plots/"
)
```
...
pc1_nebula_processed <- process_nebula_results(pc1)
pc1_nebula_res_combined_reml_pooled <- pc1_nebula_processed$results

pc2 <- s3readRDS('PC/PC-2/nebula/PC-2_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
pc2_nebula_processed <- process_nebula_results(pc2)
pc2_nebula_res_combined_reml_pooled <- pc2_nebula_processed$results

tpc_ic <- s3readRDS('PC/tPC-IC/nebula/tPC-IC_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
tpc_ic_nebula_processed <- process_nebula_results(tpc_ic)
tpc_ic_nebula_res_combined_reml_pooled <- tpc_ic_nebula_processed$results
```

```{r echo = F}
pc_plots <- create_gene_expression_plots(
  main_results = pc_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "1" = pc1_nebula_res_combined_reml_pooled,
    "2" = pc2_nebula_res_combined_reml_pooled,
    "tPC-IC" = tpc_ic_nebula_res_combined_reml_pooled
  ),
    formula = "treatment * visit",
  cell_type_labels = c("PC-1", "PC-2", "tPC-IC"),
  cell_type_prefix = "PC",
...
```{r echo =F}
plot_volcano(immune_hvg_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL, 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/immune_hvg_placebo_pvalue_nebula_reml_pooled",
             formula = "treatment * visit", 
             cell_type = "Immune")
...
```{r echo = F, eval = F}
# pull covariance matrix for p-value calculations
immune_hvg_nebula_res_combined_reml_pooled <- immune_hvg_nebula_res_combined_reml_pooled %>%
  rowwise() %>%
  mutate(
    # Derived logFCs
    placebo_pre = logFC_Intercept,
...
# immune_hvg_nebula_res_combined_reml_pooled
immune_hvg_nebula_res_combined_reml_pooled <- immune_hvg_nebula_res_combined_reml_pooled %>%
  mutate(placebo_pre = logFC_Intercept,
         placebo_post = logFC_Intercept + logFC_visitPOST,
         dapa_pre = logFC_Intercept + logFC_treatmentDapagliflozin,
...
# save input for IPA
## Interaction or DiD
immune_nebula_pooled_ipa_DiD <- immune_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr)
...
## Placebo (or Visit)
immune_nebula_pooled_ipa_placebo <- immune_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
...
## Dapagliflozin
immune_nebula_pooled_ipa_dapa <- immune_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
...
```{r echo = F}
mon <- s3readRDS('Immune_Myeloid/MON/nebula/MON_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
mon_nebula_processed <- process_nebula_results(mon)
mon_hvg_nebula_res_combined_reml_pooled <- mon_nebula_processed$results

mac <- s3readRDS('Immune_Myeloid/MAC/nebula/MAC_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
mac_nebula_processed <- process_nebula_results(mac)
mac_hvg_nebula_res_combined_reml_pooled <- mac_nebula_processed$results

t <- s3readRDS('Immune_Lymphoid/T/nebula/T_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
t_nebula_processed <- process_nebula_results(t)
t_hvg_nebula_res_combined_reml_pooled <- t_nebula_processed$results

nkt <- s3readRDS('Immune_Lymphoid/NKT/NKC/nebula/NKT/NKC_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
nkt_nebula_processed <- process_nebula_results(nkt)
nkt_hvg_nebula_res_combined_reml_pooled <- nkt_nebula_processed$results

b <- s3readRDS('Immune_Lymphoid/B/nebula/B_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
b_nebula_processed <- process_nebula_results(b)
b_hvg_nebula_res_combined_reml_pooled <- b_nebula_processed$results
```

```{r echo = F}
immune_plots <- create_gene_expression_plots(
  main_results = immune_hvg_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "MON" = mon_hvg_nebula_res_combined_reml_pooled,
    "MAC" = mac_hvg_nebula_res_combined_reml_pooled,
    "T" = t_hvg_nebula_res_combined_reml_pooled,
    "NKT/NKC" = nkt_hvg_nebula_res_combined_reml_pooled,
    "B" = b_hvg_nebula_res_combined_reml_pooled
  ),
  cell_type_labels = c("MON", "MAC", "T", "NKT/NKC", "B"),
  cell_type_prefix = "Immune",
  output_prefix = "Immune_hvg",
    formula = "treatment * visit",
  full_formula = T,
  volcano_text_size = 15,
  volcano_caption_size = 12,
...
```{r echo = F}
mon <- s3readRDS('Immune_Myeloid/MON/nebula/MON_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
mon_nebula_processed <- process_nebula_results(mon)
mon_nebula_res_combined_reml_pooled <- mon_nebula_processed$results

mac <- s3readRDS('Immune_Myeloid/MAC/nebula/MAC_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
mac_nebula_processed <- process_nebula_results(mac)
mac_nebula_res_combined_reml_pooled <- mac_nebula_processed$results

t <- s3readRDS('Immune_Lymphoid/T/nebula/T_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
t_nebula_processed <- process_nebula_results(t)
t_nebula_res_combined_reml_pooled <- t_nebula_processed$results

nkt <- s3readRDS('Immune_Lymphoid/NKT/NKC/nebula/NKT/NKC_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
nkt_nebula_processed <- process_nebula_results(nkt)
nkt_nebula_res_combined_reml_pooled <- nkt_nebula_processed$results

b <- s3readRDS('Immune_Lymphoid/B/nebula/B_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
b_nebula_processed <- process_nebula_results(b)
b_nebula_res_combined_reml_pooled <- b_nebula_processed$results
```

```{r echo = F}
immune_plots <- create_gene_expression_plots(
  main_results = immune_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "MON" = mon_nebula_res_combined_reml_pooled,
    "MAC" = mac_nebula_res_combined_reml_pooled,
    "T" = t_nebula_res_combined_reml_pooled,
    "NKT/NKC" = nkt_nebula_res_combined_reml_pooled,
    "B" = b_nebula_res_combined_reml_pooled
  ),
  cell_type_labels = c("MON", "MAC", "T", "NKT/NKC", "B"),
  cell_type_prefix = "Immune",
  output_prefix = "Immune",
    formula = "treatment * visit",
  full_formula = T,
  volcano_text_size = 15,
  volcano_caption_size = 12,
...
```{r echo =F}
plot_volcano(immune_myeloid_hvg_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL,
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/immune_myeloid_hvg_placebo_pvalue_nebula_reml_pooled",
             formula = "treatment * visit", 
...
```{r echo = F, eval = F}
# pull covariance matrix for p-value calculations
immune_myeloid_hvg_nebula_res_combined_reml_pooled <- immune_myeloid_hvg_nebula_res_combined_reml_pooled %>%
  rowwise() %>%
  mutate(
    # Derived logFCs
    placebo_pre = logFC_Intercept,
...
# immune_myeloid_hvg_nebula_res_combined_reml_pooled
immune_myeloid_hvg_nebula_res_combined_reml_pooled <- immune_myeloid_hvg_nebula_res_combined_reml_pooled %>%
  mutate(placebo_pre = logFC_Intercept,
         placebo_post = logFC_Intercept + logFC_visitPOST,
         dapa_pre = logFC_Intercept + logFC_treatmentDapagliflozin,
...
# save input for IPA
## Interaction or DiD
immune_myeloid_nebula_pooled_ipa_DiD <- immune_myeloid_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr)
...
## Placebo (or Visit)
immune_myeloid_nebula_pooled_ipa_placebo <- immune_myeloid_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
...
## Dapagliflozin
immune_myeloid_nebula_pooled_ipa_dapa <- immune_myeloid_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
...
immune_myeloid_plots <- create_gene_expression_plots(
  main_results = immune_myeloid_hvg_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "MON" = mon_hvg_nebula_res_combined_reml_pooled,
    "MAC" = mac_hvg_nebula_res_combined_reml_pooled
  ),
  ...
  output_prefix = "Immune_Myeloid_hvg",
  formula = "treatment * visit",
  full_formula = T,
  volcano_text_size = 15,
  volcano_caption_size = 12,
...
```{r echo = F}
immune_myeloid_plots <- create_gene_expression_plots(
  main_results = immune_myeloid_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "MON" = mon_nebula_res_combined_reml_pooled,
    "MAC" = mac_nebula_res_combined_reml_pooled
  ),
...
```{r echo =F}
plot_volcano(immune_lymphoid_hvg_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL,
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/immune_lymphoid_hvg_placebo_pvalue_nebula_reml_pooled",
             formula = "treatment * visit", 
...
```{r echo = F, eval = F}
# pull covariance matrix for p-value calculations
immune_lymphoid_hvg_nebula_res_combined_reml_pooled <- immune_lymphoid_hvg_nebula_res_combined_reml_pooled %>%
  rowwise() %>%
  mutate(
    # Derived logFCs
    placebo_pre = logFC_Intercept,
...
# immune_lymphoid_hvg_nebula_res_combined_reml_pooled
immune_lymphoid_hvg_nebula_res_combined_reml_pooled <- immune_lymphoid_hvg_nebula_res_combined_reml_pooled %>%
  mutate(placebo_pre = logFC_Intercept,
         placebo_post = logFC_Intercept + logFC_visitPOST,
         dapa_pre = logFC_Intercept + logFC_treatmentDapagliflozin,
...
# save input for IPA
## Interaction or DiD
immune_lymphoid_nebula_pooled_ipa_DiD <- immune_lymphoid_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr)
...
## Placebo (or Visit)
immune_lymphoid_nebula_pooled_ipa_placebo <- immune_lymphoid_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
...
## Dapagliflozin
immune_lymphoid_nebula_pooled_ipa_dapa <- immune_lymphoid_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
...
immune_lymphoid_plots <- create_gene_expression_plots(
  main_results = immune_lymphoid_hvg_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "T" = t_hvg_nebula_res_combined_reml_pooled,
    "NKT/NKC" = nkt_hvg_nebula_res_combined_reml_pooled,
    "B" = b_hvg_nebula_res_combined_reml_pooled
  ...
  output_prefix = "Immune_Lymphoid_hvg",
  formula = "treatment * visit",
  full_formula = T,
  volcano_text_size = 15,
  volcano_caption_size = 12,
...
```{r echo = F}
immune_lymphoid_plots <- create_gene_expression_plots(
  main_results = immune_lymphoid_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "T" = t_nebula_res_combined_reml_pooled,
    "NKT/NKC" = nkt_nebula_res_combined_reml_pooled,
    "B" = b_nebula_res_combined_reml_pooled
...
```{r echo =F}
plot_volcano(ic_hvg_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL,
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/ic_hvg_placebo_pvalue_nebula_reml_pooled",
             formula = "treatment * visit",
             cell_type = "IC")
...
```{r echo = F, eval = F}
# pull covariance matrix for p-value calculations
ic_hvg_nebula_res_combined_reml_pooled <- ic_hvg_nebula_res_combined_reml_pooled %>%
  rowwise() %>%
  mutate(
    # Derived logFCs
    placebo_pre = logFC_Intercept,
...
# ic_hvg_nebula_res_combined_reml_pooled
ic_hvg_nebula_res_combined_reml_pooled <- ic_hvg_nebula_res_combined_reml_pooled %>%
  mutate(placebo_pre = logFC_Intercept,
         placebo_post = logFC_Intercept + logFC_visitPOST,
         dapa_pre = logFC_Intercept + logFC_treatmentDapagliflozin,
...
# save input for IPA
## Interaction or DiD
ic_nebula_pooled_ipa_DiD <- ic_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr)
...
## Placebo (or Visit)
ic_nebula_pooled_ipa_placebo <- ic_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
...
## Dapagliflozin
ic_nebula_pooled_ipa_dapa <- ic_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
...
ic_a_hvg_nebula_res_combined_reml_pooled <- ic_a_nebula_processed$results
...
ic_b_hvg_nebula_res_combined_reml_pooled <- ic_b_nebula_processed$results
```

```{r echo = F}
ic_plots <- create_gene_expression_plots(
  main_results = ic_hvg_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "A" = ic_a_hvg_nebula_res_combined_reml_pooled,
    "B" = ic_b_hvg_nebula_res_combined_reml_pooled
  ),
    formula = "treatment * visit",
output_prefix = "IC_hvg",
  cell_type_prefix = "IC",
  full_formula = T,
  volcano_text_size = 15,
  volcano_caption_size = 12,
...
ic_a <- s3readRDS('IC/IC-A/nebula/IC-A_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
ic_a_nebula_processed <- process_nebula_results(ic_a)
ic_a_nebula_res_combined_reml_pooled <- ic_a_nebula_processed$results

ic_b <- s3readRDS('IC/IC-B/nebula/IC-B_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
ic_b_nebula_processed <- process_nebula_results(ic_b)
ic_b_nebula_res_combined_reml_pooled <- ic_b_nebula_processed$results
```

```{r echo = F}
ic_plots <- create_gene_expression_plots(
  main_results = ic_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "A" = ic_a_nebula_res_combined_reml_pooled,
    "B" = ic_b_nebula_res_combined_reml_pooled
  ),
    formula = "treatment * visit",
output_prefix = "IC",
  cell_type_prefix = "IC",
...
```{r echo =F}
plot_volcano(ec_hvg_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL,
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/ec_hvg_placebo_pvalue_nebula_reml_pooled",
             formula = "treatment * visit",
             cell_type = "EC")
...
```{r echo = F, eval = F}
# pull covariance matrix for p-value calculations
ec_hvg_nebula_res_combined_reml_pooled <- ec_hvg_nebula_res_combined_reml_pooled %>%
  rowwise() %>%
  mutate(
    # Derived logFCs
    placebo_pre = logFC_Intercept,
...
# ec_hvg_nebula_res_combined_reml_pooled
ec_hvg_nebula_res_combined_reml_pooled <- ec_hvg_nebula_res_combined_reml_pooled %>%
  mutate(placebo_pre = logFC_Intercept,
         placebo_post = logFC_Intercept + logFC_visitPOST,
         dapa_pre = logFC_Intercept + logFC_treatmentDapagliflozin,
...
# save input for IPA
## Interaction or DiD
ec_nebula_pooled_ipa_DiD <- ec_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr)
...
## Placebo (or Visit)
ec_nebula_pooled_ipa_placebo <- ec_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
...
## Dapagliflozin
ec_nebula_pooled_ipa_dapa <- ec_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
...
```{r echo = F}
ec_aea <- s3readRDS('EC/EC-AEA/nebula/EC-AEA_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
ec_aea_nebula_processed <- process_nebula_results(ec_aea)
ec_aea_hvg_nebula_res_combined_reml_pooled <- ec_aea_nebula_processed$results

ec_gc <- s3readRDS('EC/EC-GC/nebula/EC-GC_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
ec_gc_nebula_processed <- process_nebula_results(ec_gc)
ec_gc_hvg_nebula_res_combined_reml_pooled <- ec_gc_nebula_processed$results

ec_lym <- s3readRDS('EC/EC-LYM/nebula/EC-LYM_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
ec_lym_nebula_processed <- process_nebula_results(ec_lym)
ec_lym_hvg_nebula_res_combined_reml_pooled <- ec_lym_nebula_processed$results

ec_ptc <- s3readRDS('EC/EC-PTC/nebula/EC-PTC_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
ec_ptc_nebula_processed <- process_nebula_results(ec_ptc)
ec_ptc_hvg_nebula_res_combined_reml_pooled <- ec_ptc_nebula_processed$results
```

```{r echo = F}
ec_plots <- create_gene_expression_plots(
  main_results = ec_hvg_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "EC-AEA" = ec_aea_hvg_nebula_res_combined_reml_pooled,
    "EC-GC" = ec_gc_hvg_nebula_res_combined_reml_pooled,
    "EC-LYM" = ec_lym_hvg_nebula_res_combined_reml_pooled,
    "EC-PTC" = ec_ptc_hvg_nebula_res_combined_reml_pooled
  ),
  cell_type_labels = c("EC-AEA", "EC-GC", "EC-LYM", "EC-PTC"),
  cell_type_prefix = "EC",
  formula = "treatment * visit",
  output_prefix = "EC_hvg",
  full_formula = T,
  volcano_text_size = 15,
  volcano_caption_size = 12,
  output_dir = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Dot Plots/"
...
ec_aea_nebula_processed <- process_nebula_results(ec_aea)
ec_aea_nebula_res_combined_reml_pooled <- ec_aea_nebula_processed$results

ec_gc <- s3readRDS('EC/EC-GC/nebula/EC-GC_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
ec_gc_nebula_processed <- process_nebula_results(ec_gc)
ec_gc_nebula_res_combined_reml_pooled <- ec_gc_nebula_processed$results

ec_lym <- s3readRDS('EC/EC-LYM/nebula/EC-LYM_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
ec_lym_nebula_processed <- process_nebula_results(ec_lym)
ec_lym_nebula_res_combined_reml_pooled <- ec_lym_nebula_processed$results

ec_ptc <- s3readRDS('EC/EC-PTC/nebula/EC-PTC_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
ec_ptc_nebula_processed <- process_nebula_results(ec_ptc)
ec_ptc_nebula_res_combined_reml_pooled <- ec_ptc_nebula_processed$results
```

```{r echo = F}
ec_plots <- create_gene_expression_plots(
  main_results = ec_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "EC-AEA" = ec_aea_nebula_res_combined_reml_pooled,
    "EC-GC" = ec_gc_nebula_res_combined_reml_pooled,
    "EC-LYM" = ec_lym_nebula_res_combined_reml_pooled,
    "EC-PTC" = ec_ptc_nebula_res_combined_reml_pooled
  ),
  cell_type_labels = c("EC-AEA", "EC-GC", "EC-LYM", "EC-PTC"),
  cell_type_prefix = "EC",
  formula = "treatment * visit",
...
```{r echo =F}
plot_volcano(fibvsmcp_hvg_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL,
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/fibvsmc_hvg_placebo_pvalue_nebula_reml_pooled",
             formula = "treatment * visit",
...
```{r echo = F, eval = F}
# pull covariance matrix for p-value calculations
fibvsmcp_hvg_nebula_res_combined_reml_pooled <- fibvsmcp_hvg_nebula_res_combined_reml_pooled %>%
  rowwise() %>%
  mutate(
    # Derived logFCs
    placebo_pre = logFC_Intercept,
...
# fibvsmcp_hvg_nebula_res_combined_reml_pooled
fibvsmcp_hvg_nebula_res_combined_reml_pooled <- fibvsmcp_hvg_nebula_res_combined_reml_pooled %>%
  mutate(placebo_pre = logFC_Intercept,
         placebo_post = logFC_Intercept + logFC_visitPOST,
         dapa_pre = logFC_Intercept + logFC_treatmentDapagliflozin,
...
# save input for IPA
## Interaction or DiD
fibvsmc_nebula_pooled_ipa_DiD <- fibvsmcp_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr)
...
## Placebo (or Visit)
fibvsmc_nebula_pooled_ipa_placebo <- fibvsmcp_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
...
## Dapagliflozin
fibvsmc_nebula_pooled_ipa_dapa <- fibvsmcp_hvg_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
...
```{r echo = F}
fib <- s3readRDS('FIBVSMCP/FIB/nebula/FIB_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
fib_nebula_processed <- process_nebula_results(fib)
fib_hvg_nebula_res_combined_reml_pooled <- fib_nebula_processed$results

p <- s3readRDS('FIBVSMCP/P/nebula/P_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
p_nebula_processed <- process_nebula_results(p)
p_hvg_nebula_res_combined_reml_pooled <- p_nebula_processed$results
```

```{r echo = F}
fibvsmcp_plots <- create_gene_expression_plots(
  main_results = fibvsmcp_hvg_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "FIB" = fib_hvg_nebula_res_combined_reml_pooled,
    "VSMC/P" = p_hvg_nebula_res_combined_reml_pooled
  ),
  cell_type_labels = c("FIB","VSMC/P"),
  cell_type_prefix = "FIBVSMCP",
  formula = "treatment * visit",
  output_prefix = "FIBVSMCP_hvg",
  full_formula = T,
  volcano_text_size = 15,
  volcano_caption_size = 12,
  output_dir = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Dot Plots/"
...
```{r echo =F}
plot_volcano(fibvsmcp_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL,
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
...
fib_nebula_processed <- process_nebula_results(fib)
fib_nebula_res_combined_reml_pooled <- fib_nebula_processed$results

p <- s3readRDS('FIBVSMCP/VSMC/P/nebula/VSMC/P_nebula_res_reml_pooled_full.rds', bucket = "attempt", region = "")
p_nebula_processed <- process_nebula_results(p)
p_nebula_res_combined_reml_pooled <- p_nebula_processed$results
```

```{r echo = F}
fibvsmcp_plots <- create_gene_expression_plots(
  main_results = fibvsmcp_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "FIB" = fib_nebula_res_combined_reml_pooled,
    "VSMC/P" = p_nebula_res_combined_reml_pooled
  ),
  cell_type_labels = c("FIB","VSMC/P"),
...
```{r podho =F}
plot_volcano(pod_hvg_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL,
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/pod_hvg_placebo_pvalue_nebula_reml_pooled",
             formula = "treatment * visit",
             cell_type = "POD")
...
pod_plots <- create_gene_expression_plots(
  main_results = pod_hvg_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "POD" = pod_hvg_nebula_res_combined_reml_pooled),
  cell_type_labels = c("POD"),
  cell_type_prefix = "POD",
  formula = "treatment * visit",
  output_prefix = "pod_hvg",
  full_formula = T,
  volcano_text_size = 15,
  volcano_caption_size = 12,
  output_dir = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Dot Plots/"
...
```{r podho =F}
plot_volcano(pod_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             NULL,
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
             "nebula/pod_placebo_pvalue_nebula_reml_pooled",
             formula = "treatment * visit",
             cell_type = "POD")
...
```{r echo = F}
pod_plots <- create_gene_expression_plots(
  main_results = pod_nebula_res_combined_reml_pooled,
  subtype_results_list = list(
    "POD" = pod_nebula_res_combined_reml_pooled),
  cell_type_labels = c("POD"),
  cell_type_prefix = "POD",
  formula = "treatment * visit",
  output_prefix = "pod",
...
combined_nebula_reml_pooled <- 
  rbind(pt_hvg_nebula_res_combined_reml_pooled %>%
          mutate(celltype = "PT"), 
        tal_hvg_nebula_res_combined_reml_pooled %>%
          mutate(celltype = "TAL"),
        pc_hvg_nebula_res_combined_reml_pooled %>%
...
names_hvg_nebula_res_combined_reml_pooled <- paste0(celltype_list, "_hvg_nebula_res_combined_reml_pooled")

# Create a named list of data frames
df_list <- mget(names_hvg_nebula_res_combined_reml_pooled)

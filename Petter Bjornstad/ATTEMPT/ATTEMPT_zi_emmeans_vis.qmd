...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_myeloid_nebula_reml_pooled, title = "Immune - Myeloid (Myeloid) nebula Top 30 KEGG (REML & Library size offset)", xmin = 1.2, xmax = 2.5)
...
```{r echo = FALSE}
# Positive NES
kegg_legacy_res_immune_myeloid_nebula_reml_pooled_pos <- kegg_legacy_res_immune_myeloid_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
kegg_legacy_res_immune_myeloid_nebula_reml_pooled_neg <- kegg_legacy_res_immune_myeloid_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_myeloid_nebula_reml_pooled, title = "Immune - Myeloid (Myeloid) nebula Top 30 REACTOME (REML & Library size offset)", xmin = 1.5, xmax = 3.5)
...
```{r echo = FALSE}
# Positive NES
reactome_res_immune_myeloid_nebula_reml_pooled_pos <- reactome_res_immune_myeloid_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
reactome_res_immune_myeloid_nebula_reml_pooled_neg <- reactome_res_immune_myeloid_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_myeloid_nebula_reml_pooled, title = "Immune - Myeloid (Myeloid) nebula Top 30 GO (REML & Library size offset)", xmin = 1.4, xmax = 5)
...
```{r echo = FALSE}
# Positive NES
go_res_immune_myeloid_nebula_reml_pooled_pos <- go_res_immune_myeloid_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
go_res_immune_myeloid_nebula_reml_pooled_neg <- go_res_immune_myeloid_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_lymphoid_nebula_reml_pooled, title = "Immune - Lymphoid (Lymphoid) nebula Top 30 KEGG (REML & Library size offset)", xmin = 1.2, xmax = 2.5)
...
```{r echo = FALSE}
# Positive NES
kegg_legacy_res_immune_lymphoid_nebula_reml_pooled_pos <- kegg_legacy_res_immune_lymphoid_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
kegg_legacy_res_immune_lymphoid_nebula_reml_pooled_neg <- kegg_legacy_res_immune_lymphoid_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_lymphoid_nebula_reml_pooled, title = "Immune - Lymphoid (Lymphoid) nebula Top 30 REACTOME (REML & Library size offset)", xmin = 1.5, xmax = 3.5)
...
```{r echo = FALSE}
# Positive NES
reactome_res_immune_lymphoid_nebula_reml_pooled_pos <- reactome_res_immune_lymphoid_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
reactome_res_immune_lymphoid_nebula_reml_pooled_neg <- reactome_res_immune_lymphoid_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_lymphoid_nebula_reml_pooled, title = "Immune - Lymphoid (Lymphoid) nebula Top 30 GO (REML & Library size offset)", xmin = 1.4, xmax = 5)
...
```{r echo = FALSE}
# Positive NES
go_res_immune_lymphoid_nebula_reml_pooled_pos <- go_res_immune_lymphoid_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
go_res_immune_lymphoid_nebula_reml_pooled_neg <- go_res_immune_lymphoid_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)

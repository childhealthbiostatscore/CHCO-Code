...
pt_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/nebula/pt_attempt_hvg_nebula_res.rds")
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
tal_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kopah/1 Nested visit and zero inflation/tal_attempt_hvg_nebula_res.rds")
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
pc_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kopah/1 Nested visit and zero inflation/pc_attempt_hvg_nebula_res.rds")
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
immune_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kopah/1 Nested visit and zero inflation/immune_attempt_hvg_nebula_res.rds")
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
ic_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kopah/1 Nested visit and zero inflation/ic_attempt_hvg_nebula_res.rds")
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
ec_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kopah/1 Nested visit and zero inflation/ec_attempt_hvg_nebula_res.rds")
...
```{r echo = F, eval = F}
## read mixed model results dataframe (rendered in Hyak)
dtl_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kopah/1 Nested visit and zero inflation/dtl_attempt_hvg_nebula_res.rds")
...
```{r echo = F}
## read mixed model results dataframe (rendered in Hyak)
fibvsmcp_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kopah/1 Nested visit and zero inflation/fibvsmcp_attempt_hvg_nebula_res.rds")
...
plot_volcano(pt_nebula_res_combined_reml_offset, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             "nebula PT (REML & Library size offset)", 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
...
colnames(pt_nebula_pooled_ipa_DiD) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
colnames(pt_nebula_pooled_ipa_placebo) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
colnames(pt_nebula_pooled_ipa_dapa) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_pt_nebula_reml_pooled, title = "PT nebula Top 30 KEGG (REML & Library size offset)", xmin = 1.2, xmax = 2.5)
...
```{r echo = FALSE}
# Positive NES
kegg_legacy_res_pt_nebula_reml_pooled_pos <- kegg_legacy_res_pt_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
kegg_legacy_res_pt_nebula_reml_pooled_neg <- kegg_legacy_res_pt_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_pt_nebula_reml_pooled, title = "PT nebula Top 30 REACTOME (REML & Library size offset)", xmin = 1.5, xmax = 3.5)
...
```{r echo = FALSE}
# Positive NES
reactome_res_pt_nebula_reml_pooled_pos <- reactome_res_pt_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
reactome_res_pt_nebula_reml_pooled_neg <- reactome_res_pt_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_pt_nebula_reml_pooled, title = "PT nebula Top 30 GO (REML & Library size offset)", xmin = 1.4, xmax = 5)
...
```{r echo = FALSE}
# Positive NES
go_res_pt_nebula_reml_pooled_pos <- go_res_pt_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
go_res_pt_nebula_reml_pooled_neg <- go_res_pt_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
plot_volcano(tal_nebula_res_combined_reml_offset, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             "nebula TAL (REML & Library size offset)", 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
...
tal_nebula_pooled_ipa_DiD <- tal_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr_interaction)
colnames(tal_nebula_pooled_ipa_DiD) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
tal_nebula_pooled_ipa_placebo <- tal_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
colnames(tal_nebula_pooled_ipa_placebo) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
tal_nebula_pooled_ipa_dapa <- tal_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
colnames(tal_nebula_pooled_ipa_dapa) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_tal_nebula_reml_pooled, title = "TAL nebula Top 30 KEGG (REML & Library size offset)", xmin = 1.2, xmax = 2.5)
...
```{r echo = FALSE}
# Positive NES
kegg_legacy_res_tal_nebula_reml_pooled_pos <- kegg_legacy_res_tal_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
kegg_legacy_res_tal_nebula_reml_pooled_neg <- kegg_legacy_res_tal_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_tal_nebula_reml_pooled, title = "TAL nebula Top 30 REACTOME (REML & Library size offset)", xmin = 1.5, xmax = 3.5)
...
```{r echo = FALSE}
# Positive NES
reactome_res_tal_nebula_reml_pooled_pos <- reactome_res_tal_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
reactome_res_tal_nebula_reml_pooled_neg <- reactome_res_tal_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_tal_nebula_reml_pooled, title = "TAL nebula Top 30 GO (REML & Library size offset)", xmin = 1.4, xmax = 5)
...
```{r echo = FALSE}
# Positive NES
go_res_tal_nebula_reml_pooled_pos <- go_res_tal_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
go_res_tal_nebula_reml_pooled_neg <- go_res_tal_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
plot_volcano(pc_nebula_res_combined_reml_offset, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             "nebula PC (REML & Library size offset)", 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
...
pc_nebula_pooled_ipa_DiD <- pc_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr_interaction)
colnames(pc_nebula_pooled_ipa_DiD) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
pc_nebula_pooled_ipa_placebo <- pc_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
colnames(pc_nebula_pooled_ipa_placebo) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
pc_nebula_pooled_ipa_dapa <- pc_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
colnames(pc_nebula_pooled_ipa_dapa) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_pc_nebula_reml_pooled, title = "TAL nebula Top 30 KEGG (REML & Library size offset)", xmin = 1.2, xmax = 2.5)
...
```{r echo = FALSE}
# Positive NES
kegg_legacy_res_pc_nebula_reml_pooled_pos <- kegg_legacy_res_pc_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
kegg_legacy_res_pc_nebula_reml_pooled_neg <- kegg_legacy_res_pc_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_pc_nebula_reml_pooled, title = "TAL nebula Top 30 REACTOME (REML & Library size offset)", xmin = 1.5, xmax = 3.5)
...
```{r echo = FALSE}
# Positive NES
reactome_res_pc_nebula_reml_pooled_pos <- reactome_res_pc_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
reactome_res_pc_nebula_reml_pooled_neg <- reactome_res_pc_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_pc_nebula_reml_pooled, title = "TAL nebula Top 30 GO (REML & Library size offset)", xmin = 1.4, xmax = 5)
...
```{r echo = FALSE}
# Positive NES
go_res_pc_nebula_reml_pooled_pos <- go_res_pc_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
go_res_pc_nebula_reml_pooled_neg <- go_res_pc_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
plot_volcano(immune_nebula_res_combined_reml_offset, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             "nebula Immune (REML & Library size offset)", 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
...
plot_volcano(immune_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             "nebula Immune (REML & pooled Offset)", 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
...
immune_nebula_pooled_ipa_DiD <- immune_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr_interaction)
colnames(immune_nebula_pooled_ipa_DiD) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
immune_nebula_pooled_ipa_placebo <- immune_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
colnames(immune_nebula_pooled_ipa_placebo) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
immune_nebula_pooled_ipa_dapa <- immune_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
colnames(immune_nebula_pooled_ipa_dapa) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_nebula_reml_pooled, title = "TAL nebula Top 30 KEGG (REML & Library size offset)", xmin = 1.2, xmax = 2.5)
...
```{r echo = FALSE}
# Positive NES
kegg_legacy_res_immune_nebula_reml_pooled_pos <- kegg_legacy_res_immune_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
kegg_legacy_res_immune_nebula_reml_pooled_neg <- kegg_legacy_res_immune_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_nebula_reml_pooled, title = "TAL nebula Top 30 REACTOME (REML & Library size offset)", xmin = 1.5, xmax = 3.5)
...
```{r echo = FALSE}
# Positive NES
reactome_res_immune_nebula_reml_pooled_pos <- reactome_res_immune_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
reactome_res_immune_nebula_reml_pooled_neg <- reactome_res_immune_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_nebula_reml_pooled, title = "TAL nebula Top 30 GO (REML & Library size offset)", xmin = 1.4, xmax = 5)
...
```{r echo = FALSE}
# Positive NES
go_res_immune_nebula_reml_pooled_pos <- go_res_immune_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
go_res_immune_nebula_reml_pooled_neg <- go_res_immune_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
plot_volcano(ic_nebula_res_combined_reml_offset, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             "nebula IC (REML & Library size offset)", 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
...
ic_nebula_pooled_ipa_DiD <- ic_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr_interaction)
colnames(ic_nebula_pooled_ipa_DiD) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
ic_nebula_pooled_ipa_placebo <- ic_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
colnames(ic_nebula_pooled_ipa_placebo) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
ic_nebula_pooled_ipa_dapa <- ic_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
colnames(ic_nebula_pooled_ipa_dapa) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_ic_nebula_reml_pooled, title = "TAL nebula Top 30 KEGG (REML & Library size offset)", xmin = 1.2, xmax = 2.5)
...
```{r echo = FALSE}
# Positive NES
kegg_legacy_res_ic_nebula_reml_pooled_pos <- kegg_legacy_res_ic_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
kegg_legacy_res_ic_nebula_reml_pooled_neg <- kegg_legacy_res_ic_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_ic_nebula_reml_pooled, title = "TAL nebula Top 30 REACTOME (REML & Library size offset)", xmin = 1.5, xmax = 3.5)
...
```{r echo = FALSE}
# Positive NES
reactome_res_ic_nebula_reml_pooled_pos <- reactome_res_ic_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
reactome_res_ic_nebula_reml_pooled_neg <- reactome_res_ic_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_ic_nebula_reml_pooled, title = "TAL nebula Top 30 GO (REML & Library size offset)", xmin = 1.4, xmax = 5)
...
```{r echo = FALSE}
# Positive NES
go_res_ic_nebula_reml_pooled_pos <- go_res_ic_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
go_res_ic_nebula_reml_pooled_neg <- go_res_ic_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
plot_volcano(ec_nebula_res_combined_reml_offset, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             "nebula EC (REML & Library size offset)", 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
...
ec_nebula_pooled_ipa_DiD <- ec_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr_interaction)
colnames(ec_nebula_pooled_ipa_DiD) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
ec_nebula_pooled_ipa_placebo <- ec_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
colnames(ec_nebula_pooled_ipa_placebo) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
ec_nebula_pooled_ipa_dapa <- ec_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
colnames(ec_nebula_pooled_ipa_dapa) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_ec_nebula_reml_pooled, title = "TAL nebula Top 30 KEGG (REML & Library size offset)", xmin = 1.2, xmax = 2.5)
...
```{r echo = FALSE}
# Positive NES
kegg_legacy_res_ec_nebula_reml_pooled_pos <- kegg_legacy_res_ec_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
kegg_legacy_res_ec_nebula_reml_pooled_neg <- kegg_legacy_res_ec_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_ec_nebula_reml_pooled, title = "TAL nebula Top 30 REACTOME (REML & Library size offset)", xmin = 1.5, xmax = 3.5)
...
```{r echo = FALSE}
# Positive NES
reactome_res_ec_nebula_reml_pooled_pos <- reactome_res_ec_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
reactome_res_ec_nebula_reml_pooled_neg <- reactome_res_ec_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_ec_nebula_reml_pooled, title = "TAL nebula Top 30 GO (REML & Library size offset)", xmin = 1.4, xmax = 5)
...
```{r echo = FALSE}
# Positive NES
go_res_ec_nebula_reml_pooled_pos <- go_res_ec_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
go_res_ec_nebula_reml_pooled_neg <- go_res_ec_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
plot_volcano(fibvsmc_nebula_res_combined_reml_offset, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             "nebula FIB/VSMC/P (REML & Library size offset)", 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
...
plot_volcano(fibvsmc_nebula_res_combined_reml_tmm, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             "nebula FIB/VSMC/P (REML & TMM Offset)", 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
...
plot_volcano(fibvsmc_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             "nebula FIB/VSMC/P (REML & pooled pooled)", 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
...
fibvsmc_nebula_pooled_ipa_DiD <- fibvsmc_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, `logFC_treatmentDapagliflozin:visitPOST`, `p_treatmentDapagliflozin:visitPOST`, fdr_interaction)
colnames(fibvsmc_nebula_pooled_ipa_DiD) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
fibvsmc_nebula_pooled_ipa_placebo <- fibvsmc_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, placebo_post_pre, p_placebo_post_pre) %>%
  mutate(fdr_placebo_post_pre = p.adjust(p_placebo_post_pre, method = "fdr"))
colnames(fibvsmc_nebula_pooled_ipa_placebo) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
fibvsmc_nebula_pooled_ipa_dapa <- fibvsmc_nebula_res_combined_reml_pooled %>%
  dplyr::select(Gene, dapa_post_pre, p_dapa_post_pre) %>%
  mutate(fdr_dapa_post_pre = p.adjust(p_dapa_post_pre, method = "fdr"))
colnames(fibvsmc_nebula_pooled_ipa_dapa) <- c("Gene", "Expr Fold Change", "Expr p-value", "Expr False Discovery Rate")
...
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_fibvsmc_nebula_reml_pooled, title = "TAL nebula Top 30 KEGG (REML & Library size offset)", xmin = 1.2, xmax = 2.5)
...
```{r echo = FALSE}
# Positive NES
kegg_legacy_res_fibvsmc_nebula_reml_pooled_pos <- kegg_legacy_res_fibvsmc_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
kegg_legacy_res_fibvsmc_nebula_reml_pooled_neg <- kegg_legacy_res_fibvsmc_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_fibvsmc_nebula_reml_pooled, title = "TAL nebula Top 30 REACTOME (REML & Library size offset)", xmin = 1.5, xmax = 3.5)
...
```{r echo = FALSE}
# Positive NES
reactome_res_fibvsmc_nebula_reml_pooled_pos <- reactome_res_fibvsmc_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
reactome_res_fibvsmc_nebula_reml_pooled_neg <- reactome_res_fibvsmc_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_fibvsmc_nebula_reml_pooled, title = "TAL nebula Top 30 GO (REML & Library size offset)", xmin = 1.4, xmax = 5)
...
```{r echo = FALSE}
# Positive NES
go_res_fibvsmc_nebula_reml_pooled_pos <- go_res_fibvsmc_nebula_reml_pooled %>%
  filter(NES > 0) %>%
  arrange(padj)
...
```{r echo = FALSE}
# Negative NES
go_res_fibvsmc_nebula_reml_pooled_neg <- go_res_fibvsmc_nebula_reml_pooled %>%
  filter(NES < 0) %>%
  arrange(padj)
...
combined_nebula_reml_pooled %>%
  ...
  labs(x = NULL, 
       y = "Interaction logFC") +
  scale_color_manual(values = c("#0077b6", "#dad7cd", "#e76f51"))
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/pt_top30_kegg_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/pt_top30_reactome_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### GO
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/pt_top30_go_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# #### TAL
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/tal_top30_kegg_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/tal_top30_reactome_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/tal_top30_go_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# 
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/pc_top30_kegg_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/pc_top30_reactome_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/pc_top30_go_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ### Immune (very few cells)
# ##### KEGG Legacy
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/immune_top30_kegg_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/immune_top30_reactome_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/immune_top30_go_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ### IC
# ##### KEGG Legacy
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/ic_top30_kegg_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/ic_top30_reactome_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/ic_top30_go_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ### EC
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/ec_top30_kegg_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/ec_top30_reactome_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/ec_top30_go_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ### FIB/VSMC/P
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/fibvsmcp_top30_kegg_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/fibvsmcp_top30_reactome_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/1 Nested visit and zero inflation/gsea/fibvsmcp_top30_go_pathways_mod1.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ### model 2
# #### PT
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/pt_top30_kegg_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/pt_top30_reactome_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/pt_top30_go_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ### TAL
# ##### KEGG Legacy
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/tal_top30_kegg_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/tal_top30_reactome_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/tal_top30_go_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ### PC
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/pc_top30_kegg_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/pc_top30_reactome_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/pc_top30_go_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ### Immune (very few cells)
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/immune_top30_kegg_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/immune_top30_reactome_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/immune_top30_go_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ### IC
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/ic_top30_kegg_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/ic_top30_reactome_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/ic_top30_go_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# 
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/ec_top30_kegg_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/ec_top30_reactome_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/ec_top30_go_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# 
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/fibvsmcp_top30_kegg_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# 
# ##### REACTOME
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/fibvsmcp_top30_reactome_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```
# ##### GO
# ```{r echo = F}
...
# 
# ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Pathways/2 Zero inflation and no nested visit/gsea/fibvsmcp_top30_go_pathways_mod2.jpeg",
#        width = 27.5, height = 14, scale = 1)
# ```

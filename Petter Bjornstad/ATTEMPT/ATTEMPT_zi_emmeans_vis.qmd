...
for (cell in celltypes)  {
  ...
  var_name <- paste0(lower_cell, "hvg_nebula_res_combined_reml_pooled")
...
pt_plots <- create_gene_expression_plots(
  ...
  cell_type_prefix = "PT",
  output_prefix = "PT",
  output_dir = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Dot Plots/hvg_"
)
pt_plots
```
...
nkt <- s3readRDS('Immune_Lymphoid/NKT/nebula/NKC_nebula_res_reml_pooled.rds', bucket = "attempt", region = "")
...
immune_myeloid_plots <- create_gene_expression_plots(
  ...
  cell_type_prefix = "Immune_Myeloid",
  output_dir = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Dot Plots/hvg_"
)
```
...
immune_lymphoid_plots <- create_gene_expression_plots(
  ...
  subtype_results_list = list(
    "T" = t_hvg_nebula_res_combined_reml_pooled,
    # "NKT" = nkt_hvg_nebula_res_combined_reml_pooled,
    "B" = b_hvg_nebula_res_combined_reml_pooled
  ),
  cell_type_labels = c("T", "B"),
  cell_type_prefix = "Immune_Lymphoid",
  output_dir = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/Figures/Dot Plots/hvg_"
)
```

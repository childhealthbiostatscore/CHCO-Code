...
# Export results
write.csv(qr_all_results, "/Users/netio/Documents/UofW/Rockies/Rockies_updates_9.26.25/module_scores/quantile_regression_all_results.csv", row.names = FALSE)
write.csv(qr_summary, "/Users/netio/Documents/UofW/Rockies/Rockies_updates_9.26.25/module_scores/quantile_regression_summary.csv", row.names = FALSE)
...
print(p1)
ggsave("qr_heatmap_pvalues.pdf", p1, width = 10, height = 12)
...
if (length(sig_pathways) > 0) {
  ...
  print(p2)
  ggsave("/Users/netio/Documents/UofW/Rockies/Rockies_updates_9.26.25/module_scores/qr_effect_sizes_significant.pdf", p2, width = 14, height = 10)
}
...
if (sum(qr_summary$sig_at_any_quantile) > 0) {
  ...
  print(p4)
  ggsave("/Users/netio/Documents/UofW/Rockies/Rockies_updates_9.26.25/module_scores/qr_summary_barplot.pdf", p4, width = 10, height = 8)
}
...
print(p5)
ggsave("/Users/netio/Documents/UofW/Rockies/Rockies_updates_9.26.25/module_scores/qr_combined_heatmap.pdf", p5, width = 11, height = 13)

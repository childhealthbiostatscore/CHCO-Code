...
table1::table1(~age + sex + bmi+epic_mfm_1+epic_insulin_1+epic_sglti2_1+epic_glp1ra_1| group,data=dat)
dat$record_id
...
# table1::table1(~age + sex + bmi+epic_mfm_1+epic_insulin_1+group+epic_glp1ra_1| epic_sglti2_1,data=dat2)
# dat2$record_id
...
# table1::table1(~ age + sex + race_ethnicity  + bmi + triglycerides + hba1c + medication| study, data=dat)
table1::table1(~ age + sex + race_ethnicity  + bmi + triglycerides + hba1c + epic_sglti2_1+ medication| group, data=dat)

...
# full_results <- read.csv(fs::path(dir.results,"NEBULA_TCA_cycle_PT_S1_S2_cells_SGLT2_unadjusted_pooled_offset.csv"))
full_results$color <- ifelse(full_results$fdr < 0.05 & full_results$`logFC_SGLT2SGLT2i` > 0, "lightcoral",
                             ifelse(full_results$fdr < 0.05 & full_results$`logFC_SGLT2SGLT2i` < 0, "lightblue", "gray"))
...
png(fs::path(dir.results, "Plot_TCA_cycle_NEBULA_PT_S1_S2_SGLT2_unadjusted_pooled_offset_T2D_fdr.png"), 
    width = 2500, height = 2000, res = 300)
print(dot_plot)
dev.off()
```
...
png(fs::path(dir.results, "Plot_Ox_Phos_NEBULA_PT_S1_S2_SGLT2_unadjusted_pooled_offset_T2D_fdr.png"), 
    width = 2500, height = 2000, res = 300)
print(dot_plot)
dev.off()
...
png(fs::path(dir.results, "Plot_TCA_cycle_NEBULA_PT_S3_SGLT2_unadjusted_pooled_offset_T2D_fdr.png"), 
    width = 2500, height = 2000, res = 300)
print(dot_plot)
dev.off()
```
...
#### TCA Cycle
```{r}
so_celltype <- subset(so_kpmp_sc,KPMP_celltype=="DCT")
so_celltype <- subset(so_celltype,group=="Type_2_Diabetes")
DefaultAssay(so_celltype) <- "RNA" 
...
write.csv(full_results,fs::path(dir.results,"NEBULA_TCA_cycle_DCT1_cells_SGLT2_unadjusted_pooled_offset.csv"))
...
dot_plot <- ggplot(full_results, aes(
  ...
  labs(
    title = "Differentially Expressed TCA Cycle Genes among Youth with Type 2 Diabetes",
    subtitle = "SGLT2i vs. No SGLT2i in DCT-1 Cells, Unadjusted (Pooled Offset)",
    x = "Log Fold Change",
    y = "Gene",
    caption = paste0(
      "FDR < 0.05, Genes = ", Genes,
...
png(fs::path(dir.results, "Plot_TCA_cycle_NEBULA_DCT1_SGLT2_unadjusted_pooled_offset_T2D_fdr.png"), 
    width = 2500, height = 2000, res = 300)
print(dot_plot)
dev.off()
```
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Ox_Phos_DCT1_cells_SGLT2_unadjusted_pooled_offset.csv"))
...
png(fs::path(dir.results, "Plot_Ox_Phos_NEBULA_DCT1_SGLT2_unadjusted_pooled_offset_T2D_fdr.png"), 
    width = 2500, height = 2000, res = 300)
print(dot_plot)
dev.off()

...
ggplot(dat_results %>% filter(!is.na(group2)), aes(x=group2, y=avg_c_k2, fill = group2))+
  geom_boxplot(alpha = 0.6, width = 0.4, size = 1.5)+geom_violin(alpha=0.6, size = 1.5)+
  geom_boxplot(data = dat_results_combined, aes(x=2.5, y=avg_c_k2), alpha=0.2, width = 0.6, size = 1.5)+
  geom_violin(data = dat_results_combined, aes(x=2.5, y=avg_c_k2), alpha=0.2, width = 2, size = 1.5)+
...
tmp2 <- tmp2 %>% filter(!is.na(index_var)) %>% mutate(check_col = paste0(record_id, group, group2, 
  ...
  geom_boxplot(alpha = 0.6, width = 0.4, size = 1.5)+geom_violin(alpha=0.4, size = 1.5)+
  geom_boxplot(data = tmp2, aes(x=2.5, y=index_var), alpha=0.2, width = 0.4, size = 1.5)+
  geom_violin(data = tmp2, aes(x=2.5, y=index_var), alpha=0.2, width = 2, size = 1.5)+

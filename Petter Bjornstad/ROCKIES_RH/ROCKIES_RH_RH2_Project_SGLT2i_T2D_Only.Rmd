...
ids[which(!ids %in% biopsy)] #"KL-0030913" "KL-0031453" "KL-0031460" "KL-0032459"
...
length(unique(so_kpmp_sc$kit_id))#30
...
#Table 1
table1(~age + sex + bmi + triglycerides + hba1c+pah_clear_bsa + eGFR_CKD_epi+gfr_bsa_plasma +acr_u +epic_mfm_1+epic_insulin_1| SGLT2,sglt2i,data=dat)

...
pfas_imputed <- read_rds(file = file.path(root_path, "Savanah Leidholt", "PFAS", "Data", "pfas_imputed.rds"))
baseline_acru <- read_rds(file = file.path(root_path, "Savanah Leidholt", "PFAS", "Data", "baseline_acru.rds"))
meta_nopfas <- read_rds(file = file.path(root_path, "Savanah Leidholt", "PFAS", "Data", "meta_nopfas.rds"))
dat_baseline <- read_rds(file = file.path(root_path, "Savanah Leidholt", "PFAS", "Data", "dat_baseline.rds"))
dat_long <- read_rds(file = file.path(root_path, "Savanah Leidholt", "PFAS", "Data", "dat_long.rds"))
```
#------------------------------------------

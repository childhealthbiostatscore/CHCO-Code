...
pdf(file = file.path(dir.results, "total_plasma_volume_adjusted_results","pfas_correlation_plot.pdf"))
...
```{r}
pdf(file = file.path(dir.results, "total_plasma_volume_adjusted_results", "total_plasma_pfas_by_group.pdf"), width = 8, height = 6)
...
```{r fig.width=16}
pdf(file = file.path(dir.results, "total_plasma_volume_adjusted_results", "longitudinal_outcomes_hm.pdf"), width = 16, height = 12)

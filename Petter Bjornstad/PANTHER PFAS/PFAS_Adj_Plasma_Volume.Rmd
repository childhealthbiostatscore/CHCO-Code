...
#-------------------------------------------------------------------------------
# Model 3: baseline PFAS predicting longitudinal outcomes (from hailey's code)
# a) base model
# b) adjusted for uACR
...
run_baseline_pfas_lmm_base <- function(data, outcome, exposure) {
  ...
  # ----------------------------------------------------------------------------
  # Outlier removal per outcome-not sure about this with such small sample sizes
  # ----------------------------------------------------------------------------
  ...
  # --------------------------------------
  # Tidy output for removal of outliers
  # --------------------------------------
...
```{r}
#Model 3B:  adjusting for baseline uacr
run_baseline_pfas_lmm <- function(data, outcome, exposure, adjust_acr = TRUE) {
  ...
  # -----------------------------
  # Formula: numeric visit + exposure:visit_num

...
mod2a_results 
#WriteXLS(mod2a_results,file.path(dir.results, "csv", "plasma_pfas_unadjusted","longitudinal_group_outcomes", "model_2a_results.xlsx"))
...
#mod2a_plot
#pdf(file.path(dir.results, "figures", "plasma_pfas_unadjusted", "longitudinal_group_outcomes", "model_2a_plots.pdf"), width = 22, height = 20)
...
mod2b_results 
#WriteXLS(mod2b_results,file.path(dir.results, "csv", "plasma_pfas_unadjusted","longitudinal_group_outcomes", "model_2b_results.xlsx"))

mod2b_plot <- plot_model_2b(data = dat_long)
#mod2b_plot

#pdf(file.path(dir.results, "figures", "plasma_pfas_unadjusted", "longitudinal_group_outcomes", "model_2b_plots.pdf"), width = 22, height = 20)
...
mod2c_results
#WriteXLS(mod2c_results,file.path(dir.results, "csv", "plasma_pfas_unadjusted","longitudinal_group_outcomes", "model_2c_results.xlsx"))


mod2c_plots <- plot_model_2c(data = dat_long)

#pdf(file.path(dir.results, "figures", "plasma_pfas_unadjusted", "longitudinal_group_outcomes", "model_2c_plots.pdf"), width = 22, height = 20)
...
mod2d_results
#WriteXLS(mod2d_results,file.path(dir.results, "csv", "plasma_pfas_unadjusted","longitudinal_group_outcomes", "model_2d_results.xlsx"))

mod2d_plots <- plot_model_2d(data = dat_long)

#pdf(file.path(dir.results, "figures", "plasma_pfas_unadjusted", "longitudinal_group_outcomes", "model_2d_plots.pdf"), width = 22, height = 20)
...
```
```{r}
dat_long %>% select(record_id, bmi, group) %>%
...
```
```{r}
harm <- read.csv(file = file.path("/Users/savanahleidholt/OneDrive - UW/Laura Pyle's files - Biostatistics Core Shared Drive/Data Harmonization/Data Clean/harmonized_dataset.csv"))

harm %>% select(record_id, bmi, group, study, visit) %>%
  filter(study == "PANTHER") %>%
  filter(record_id == "PAN-46-C")
```
...
plot_influential_trajectories(
  data = dat_long,
  outcome = "bl_dheas",
  ids = c("PAN-08-T", "PAN-01-T", "PAN-75-O", "PAN-48-C")
)

plot_influential_trajectories(
  data = dat_long,
  outcome = "bmi",
  ids = c("PAN-08-T", "PAN-46-C")
)

plot_influential_trajectories(
  data = dat_long,
  outcome = "dexa_fat_kg",
  ids = c("PAN-08-T", "PAN-60-O")
)
```

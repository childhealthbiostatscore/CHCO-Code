...
# c) tanner stage adjustement
#--------------------------------------------
```{r}
#--------------Model 2A-----------------------------------
run_group_time_lmm_unadjusted <- function(data, outcome) {
  
  rhs <- c("visit_f", "group", "visit_f:group")
...
```
#-------------------------------------------------------------------------------
# Model 3B: baseline PFAS predicting longitudinal outcomes, baseline ACR-adjusted
#-------------------------------------------------------------------------------
```{r}

...
load("/Users/kristenmiller/Library/CloudStorage/OneDrive-UW/Laura Pyle's files - Biostatistics Core Shared Drive/TODAY subaward/Proteomics HTN/copy_of_old_analysis_dataset_for_HTN_response.RData")
df <- df[!is.na(df$htn),]
...
colnames_M <- top_htn_df %>%
  ...
  pull(Target)
#colnames_M <- paste0(colnames_M,"_",prot_heatmap)
png(height = 3000, width = 2500, file = "/Users/kristenmiller/Library/CloudStorage/OneDrive-UW/Laura Pyle's files - Biostatistics Core Shared Drive/TODAY subaward/TODAY HTN and DKD output/local_T2D_BP_heatmap.png", res = 170)
...
p_seq.15487.164 <- panel_in_boxplot(data = df_t2d, seq = "seq.15487.164")
p_seq.5307.12 <- panel_in_boxplot(data = df_t2d, seq = "seq.5307.12")
p_seq.18896.23 <- panel_in_boxplot(data = df_t2d, seq = "seq.18896.23")
p_seq.7735.17 <- panel_in_boxplot(data = df_t2d, seq = "seq.7735.17")
p_seq.23569.53 <- panel_in_boxplot(data = df_t2d, seq = "seq.23569.53")
p_seq.6506.54<- panel_in_boxplot(data = df_t2d, seq = "seq.6506.54")
p_seq.17755.5<- panel_in_boxplot(data = df_t2d, seq = "seq.17755.5")
p_seq.13408.23<- panel_in_boxplot(data = df_t2d, seq = "seq.13408.23")
p_seq.3235.50<- panel_in_boxplot(data = df_t2d, seq = "seq.3235.50")

# arrange in same format as Teen-LABS:
grpbox <- ggarrange(p_seq.3343.1,p_seq.15487.164,p_seq.8958.51,
                    p_seq.5307.12,p_seq.24957.6,p_seq.2948.58,
                    p_seq.18896.23,p_seq.2999.6,p_seq.4498.62,
                    p_seq.20161.41,#p_seq.5634.39,
                    p_seq.7735.17,
                    p_seq.13998.26,p_seq.7957.2,p_seq.24681.2,
                    p_seq.19563.3,p_seq.23569.53,p_seq.6506.54,
                    p_seq.17755.5,p_seq.13408.23,p_seq.3235.50,
                    nrow = 4, ncol = 5,
                    common.legend = T)
png(height = 3000, width = 2500, file = "/Users/kristenmiller/Library/CloudStorage/OneDrive-UW/Laura Pyle's files - Biostatistics Core Shared Drive/TODAY subaward/TODAY HTN and DKD output/local_T2D_HTN_boxplot_top20.png", res = 170)
grpbox
dev.off()
...
#separate into positive vs. negative association with hypertension: 
grpbox_protective <- ggarrange(p_seq.19563.3,p_seq.13408.23,
                               p_seq.4498.62,p_seq.7957.2,
                               p_seq.18896.23,p_seq.6506.54,
                               p_seq.3235.50,p_seq.8958.51,
                                p_seq.20161.41,p_seq.2999.6,
                    nrow = 2, ncol = 5,
                    common.legend = T)
png(height = 2000, width = 2500, file = "/Users/kristenmiller/Library/CloudStorage/OneDrive-UW/Laura Pyle's files - Biostatistics Core Shared Drive/TODAY subaward/TODAY HTN and DKD output/local_T2D_HTN_boxplot_top20_protective.png", res = 170)
grpbox_protective
dev.off()

#separate into positive vs. negative association with hypertension: 
grpbox_risk <- ggarrange(p_seq.24681.2,p_seq.15487.164,p_seq.13998.26,
                         p_seq.2948.58,p_seq.23569.53,p_seq.17755.5,
                         p_seq.3343.1,p_seq.7735.17,p_seq.24957.6,p_seq.5307.12,
                    nrow = 2, ncol = 5,
                    common.legend = T)
png(height = 2000, width = 2500, file = "/Users/kristenmiller/Library/CloudStorage/OneDrive-UW/Laura Pyle's files - Biostatistics Core Shared Drive/TODAY subaward/TODAY HTN and DKD output/local_T2D_HTN_boxplot_top20_risk.png", res = 170)
grpbox_risk
dev.off()

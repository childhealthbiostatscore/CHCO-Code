...
user <- Sys.info()[["user"]]
if (user == "laurapyle") {
  data_path <- '/Users/laurapyle/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Proteomics and HTN/Data_Cleaned'
} else if (user == "lpyle") {
  data_path <- "/Users/lpyle/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Proteomics and HTN/Data_Cleaned"
} else if (user == "pylell") {
  data_path <- "/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Proteomics and HTN/Data_Cleaned"
} else if (user == "kristenmiller") {
  data_path <- "/Users/kristenmiller/Library/CloudStorage/OneDrive-UW/Laura Pyle's files - Biostatistics Core Shared Drive/Proteomics and HTN/Data_Cleaned"
} else {
...
t <- df %>% mutate(
  ...
  select(
    ...
    eGFR_fas_cr, gfr_bsa_plasma, gfr_raw_plasma, creatinine_s, cystatin_c_s, eis, elevated_albuminuria, htn, soma, olink_plasma, olink_urine
  ) %>% 

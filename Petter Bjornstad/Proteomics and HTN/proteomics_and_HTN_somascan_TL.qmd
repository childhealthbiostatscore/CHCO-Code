...
load("/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Proteomics and HTN/Data_Cleaned/analysis_dataset.RData")
top_htn <- top_htn_df %>%
...
load("/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Teen Labs/Data_Cleaned/analysis_dataset.RData")
...
load("/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/TODAY subaward/Somalogic data raw/analytes.Rdata")
...
colnames_M <- top_htn_df %>%
  ...
  pull(Target)
#colnames_M <- paste0(colnames_M,"_",prot_heatmap)
png(height = 3000, width = 2500, file = "/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/TODAY subaward/TODAY HTN and DKD output/local_T2D_BP_heatmap_TL_baseline.png", res = 170)
...
colnames_M <- top_htn_df %>%
  ...
  pull(Target)
#colnames_M <- paste0(colnames_M,"_",prot_heatmap)
png(height = 3000, width = 2500, file = "/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/TODAY subaward/TODAY HTN and DKD output/local_T2D_BP_heatmap_TL_deltas.png", res = 170)
...
png('/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/TODAY subaward/TODAY HTN and DKD output/Teen-LABS_BP.png', res = 300, width = 14, height = 6, units = "in")
panel_p
dev.off()
...
```{r}
# write file
write.csv(lmm_res,"/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/TODAY subaward/TODAY HTN and DKD output/TeenLABS_mixed_models_HTN_proteins_BP.csv", row.names = F)
```
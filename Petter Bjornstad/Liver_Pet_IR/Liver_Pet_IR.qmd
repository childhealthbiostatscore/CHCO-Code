...
if (user == "shivaniramesh") {
  ...
  dat.results <- "/Users/shivaniramesh/Library/CloudStorage/OneDrive-UW/CHCO-Code/Petter Bjornstad/Liver Pet IR/Results"
  ...
  dat.results <- c("/Users/hhampson/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Biostatistics Core Shared Drive/Liver Pet IR/Results")
}
...
dat_ir <- dat %>% 
  dplyr::select(c("record_id","coenroll","study","procedure","visit","group","age","sex","bmi","hba1c","liver_k1","liver_k2","liver_k3","m_i_gir_190","m_i_p2_raw_lean")) 

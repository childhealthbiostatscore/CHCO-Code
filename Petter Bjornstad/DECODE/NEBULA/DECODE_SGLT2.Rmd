...
```{r}
# AIM 1: T2D vs. LC (No Medications), evaluate top 2000 highly variable genes 
# Using Nebula
# Determine if covariate adjustment is appropriate
# AIM 2: Among individuals with T2D, evaluate top 2000 highly variable genes between SGLT2i Yes vs. SGLT2i No. 
# Use Nebula method
# Determine if covariate adjustment is appropriate

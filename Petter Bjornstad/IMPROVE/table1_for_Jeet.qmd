...
# Import and filter
df <- read.csv(file.path(root_path, "Data Harmonization/Data Clean/harmonized_dataset.csv"), na.strings = "")
df <- df %>% filter(study == "IMPROVE", visit %in% c("baseline", "3_months_post_surgery", "12_months_post_surgery"))

load(file.path(root_path, "IMPROVE T2D/Olink Data/improve_olink_plasma.Rdata"))

full_vars <- read.csv(file.path(root_path, "/IMPROVE T2D/Data_Raw/IMPROVE_data_dump_dict.csv"), na.strings = "")
...
kv_dat <- read.csv(file.path(root_path, "/Renal HEIR/Data_Cleaned/RENALHEIR_IMPROVE_kidney volume.csv"), na.strings = "")
...
# Get names
dict <- read.csv(file.path(root_path, "/Data Harmonization/data_dictionary_master.csv"), na.strings = "")
...
df_biopsy_baseline_m12 <- df_biopsy_baseline_m12 %>% filter(record_id %nin% "IT_14") %>% ungroup() # manually removing IT_14 w/o baseline scRNA
t1_biopsy <- paired(visit ~ sex + 
                      notest(age,"Nmiss", "median", "q1q3", "range")  + 
                      race + 
                      ethnicity + 
                      notest(eGFR_CKD_epi,"Nmiss", "median", "q1q3", "range")  + 
                      notest(eGFR_fas_cr_cysc,"Nmiss", "median", "q1q3", "range")  + 
                      notest(eGFR_CKiD_U25_avg,"Nmiss", "median", "q1q3", "range")  + 
                      notest(eGFR_CKiD_U25_Creat,"Nmiss", "median", "q1q3", "range") + 
                      notest(eGFR_CKiD_U25_CystatinC,"Nmiss", "median", "q1q3", "range")  + 
                      notest(eGFR_fas_cr,"Nmiss", "median", "q1q3", "range")  + 
                      notest(weight,"Nmiss", "median", "q1q3", "range")  + 
                      notest(bmi,"Nmiss", "median", "q1q3", "range")  + 
                      notest(bod_pod_body_fat,"Nmiss", "median", "q1q3", "range")  + 
                      notest(gfr_raw_plasma,"Nmiss", "median", "q1q3", "range")  + 
                      notest(gfr_bsa_plasma,"Nmiss", "median", "q1q3", "range")  + 
                      notest(ff,"Nmiss", "median", "q1q3", "range")  + 
                      notest(acr_u,"Nmiss", "median", "q1q3", "range") + 
                      notest(fasting_insulin,"Nmiss", "median", "q1q3", "range") + 
                      diabetes +
                      albuminuria_cat + 
                      elevated_albuminuria +
                      notest(fsoc_l_cortex,"Nmiss", "median", "q1q3", "range")  + 
                      notest(fsoc_l_kidney,"Nmiss", "median", "q1q3", "range")  + 
                      notest(fsoc_l_medulla,"Nmiss", "median", "q1q3", "range")  + 
                      notest(fsoc_r_cortex,"Nmiss", "median", "q1q3", "range")  + 
                      notest(fsoc_r_kidney,"Nmiss", "median", "q1q3", "range")  + 
                      notest(fsoc_r_medulla,"Nmiss", "median", "q1q3", "range")  + 
                      notest(map,"Nmiss", "median", "q1q3", "range")  + 
                      notest(sbp,"Nmiss", "median", "q1q3", "range")  + 
                      notest(dbp,"Nmiss", "median", "q1q3", "range")  + 
                      notest(fbg,"Nmiss", "median", "q1q3", "range")  + 
                      notest(hba1c,"Nmiss", "median", "q1q3", "range")  + 
                      notest(airg,"Nmiss", "median", "q1q3", "range")  + 
                      notest(acprg,"Nmiss", "median", "q1q3", "range")  + 
                      notest(gir_190,"Nmiss", "median", "q1q3", "range")  + 
                      notest(m_i,"Nmiss", "median", "q1q3", "range")  + 
                      notest(glom_volume_con,"Nmiss", "median", "q1q3", "range")  + 
                      notest(glom_volume_weibel,"Nmiss", "median", "q1q3", "range")  + 
                      notest(glom_volume_wiggins,"Nmiss", "median", "q1q3", "range")  + 
                      notest(mes_matrix_area,"Nmiss", "median", "q1q3", "range")  + 
                      notest(mes_index,"Nmiss", "median", "q1q3", "range")  + 
                      notest(mes_volume_con,"Nmiss", "median", "q1q3", "range")  + 
                      notest(mes_volume_weibel,"Nmiss", "median", "q1q3", "range")  + 
                      notest(mes_volume_wiggins,"Nmiss", "median", "q1q3", "range")  + 
                      notest(glom_nuc_count,"Nmiss", "median", "q1q3", "range")  + 
                      notest(volume_left_comb,"Nmiss", "median", "q1q3", "range")  + 
                      notest(volume_right_comb,"Nmiss", "median", "q1q3", "range")  + 
                      notest(tkv_comb,"Nmiss", "median", "q1q3", "range") , 
                    data = df_biopsy_baseline_m12, id = record_id)
summary(t1_biopsy, labelTranslations = labels,pfootnote = T)

# write datafile that will be uploaded to repository
repo <- df_biopsy_baseline_m12 %>% select(age, sex, race, weight, bmi, map, fasting_insulin, hba1c, 
                                          fbg, gir_190, m_i, airg, acprg, eGFR_CKiD_U25_Creat, gfr_raw_plasma,
                                          gfr_bsa_plasma, acr_u, tkv_comb, glom_volume_wiggins, glom_nuc_count,
                                          mes_volume_wiggins, mes_matrix_area, mes_index)
write.csv(repo, file.path(root_path, "/IMPROVE T2D/Data_Cleaned/JCI_VSG_Naik_table1_repository.csv"), row.names = F)

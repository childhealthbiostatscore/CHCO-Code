...
t1 <- paired(visit ~ sex + age + race + ethnicity + eGFR_CKD_epi + eGFR_fas_cr_cysc + eGFR_CKiD_U25_avg +
               eGFR_CKiD_U25_Creat + eGFR_CKiD_U25_CystatinC + eGFR_fas_cr +
               weight + bmi + bod_pod_body_fat + gfr_raw_plasma + gfr_bsa_plasma + 
               ff + signed.rank(acr_u,"Nmiss", "median", "q1q3", "range") +
               signed.rank(fasting_insulin,"Nmiss", "median", "q1q3", "range") +
               diabetes +
               ...
               dbp + fbg + hba1c + airg + acprg + gir_190 + m_i + glom_volume_con + glom_volume_weibel + 
...
t1_biopsy <- paired(visit ~ sex + age + race + ethnicity + eGFR_CKD_epi + eGFR_fas_cr_cysc + eGFR_CKiD_U25_avg +
                      eGFR_CKiD_U25_Creat + eGFR_CKiD_U25_CystatinC + eGFR_fas_cr +
                      ...
                      gir_190 + m_i + glom_volume_con + glom_volume_weibel + 
                      glom_volume_wiggins + mes_matrix_area + mes_index + mes_volume_con + 
                      mes_volume_weibel + mes_volume_wiggins + glom_nuc_count +
                      volume_left_comb + volume_right_comb + tkv_comb, 
...
t1_no_biopsy <- paired(visit ~ sex + age + race + ethnicity + eGFR_CKD_epi + eGFR_fas_cr_cysc + eGFR_CKiD_U25_avg +
                         eGFR_CKiD_U25_Creat + eGFR_CKiD_U25_CystatinC + eGFR_fas_cr +
                      weight + bmi + bod_pod_body_fat +
                      gfr_raw_plasma + gfr_bsa_plasma +
                      ff + signed.rank(acr_u,"Nmiss", "median", "q1q3", "range") + 
...
t1 <- tableby(visit ~ sex + age + race + ethnicity + eGFR_CKD_epi + eGFR_fas_cr_cysc + eGFR_CKiD_U25_avg +
                eGFR_CKiD_U25_Creat + eGFR_CKiD_U25_CystatinC + eGFR_fas_cr +
               weight + bmi + bod_pod_body_fat + gfr_raw_plasma + gfr_bsa_plasma + 
               ff + kwt(acr_u,"Nmiss", "median", "q1q3", "range") + 
               kwt(fasting_insulin,"Nmiss", "median", "q1q3", "range") +
               diabetes +
               albuminuria_cat + elevated_albuminuria +
               fsoc_l_cortex + fsoc_l_kidney + fsoc_l_medulla + 
               fsoc_r_cortex + fsoc_r_kidney + fsoc_r_medulla + map + sbp + 

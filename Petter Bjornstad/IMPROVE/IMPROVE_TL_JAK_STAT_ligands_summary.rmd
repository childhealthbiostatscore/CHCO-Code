...
# proteins to keep
filename <- "/Data Harmonization/Combined SomaScan/analytes.Rdata"
...
filename <- "IMPROVE T2D/Results/IMPROVE emmeans.xlsx"
full_path <- file.path(data_path, filename)
improve_means <- read_xlsx(full_path)
filename <- "IMPROVE T2D/Results/IMPROVE Somalogic results.xlsx"
full_path <- file.path(data_path, filename)
improve_sig <- read_xlsx(full_path, sheet = "Month 12 - Baseline")
...
filename <- "IMPROVE T2D/Results/IMPROVE emmeans transcriptomics cohort.xlsx"
full_path <- file.path(data_path, filename)
improve_means_t <- read_xlsx(full_path)
improve_means_t$AptName <- improve_means_t$AptName...1
improve_means_t$AptName...1 <- NULL
filename <- "IMPROVE T2D/Results/IMPROVE Somalogic results transcriptomics cohort.xlsx"
full_path <- file.path(data_path, filename)
improve_sig_t <- read_xlsx(full_path, sheet = "Month 12 - Baseline")
# keep only the proteins we need
...
filename <- "Teen Labs/Results/Teen LABS emmeans.xlsx"
full_path <- file.path(data_path, filename)
tl_means <- read_xlsx(full_path)
filename <- "Teen Labs/Results/Teen LABS change_from_m1.xlsx"
full_path <- file.path(data_path, filename)
tl_sig <- read_xlsx(full_path, sheet = "visitYear 1")
# keep only the proteins we need
...
filename <- "IMPROVE T2D/Results/TL_IMPROVE_FC_Jeet.csv"
full_path <- file.path(data_path, filename)
write.csv(summary, full_path, row.names = F)

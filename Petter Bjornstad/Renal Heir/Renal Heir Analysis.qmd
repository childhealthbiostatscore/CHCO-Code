...
# 
# dat %>%
#   dplyr::select(dexa_lean_kg, dexa_fat_kg, dexa_body_fat, dexa_trunk_kg, fasting_ffa, ffa_suppression, fasting_insulin, steady_state_insulin, steady_state_cpeptide, gir_190, m_i, di, airg, acprg) %>% 
#   gather() %>% 
#   ggplot(aes(value)) +
#     facet_wrap(~ key, scales = "free") +
#     geom_histogram()
...
```{r, include = F}
table_two <- tableby(group ~ dexa_lean_kg + dexa_fat_kg + dexa_body_fat + dexa_trunk_kg + fasting_ffa + kwt(ffa_suppression, "Nmiss", "median", "q1q3", "range") + kwt(fasting_insulin, "Nmiss", "median", "q1q3", "range") + kwt(steady_state_insulin, "Nmiss", "median", "q1q3", "range") + steady_state_cpeptide + gir_190 + kwt(m_i, "Nmiss", "median", "q1q3", "range") + kwt(di, "Nmiss", "median", "q1q3", "range") + kwt(airg, "Nmiss", "median", "q1q3", "range") + kwt(acprg, "Nmiss", "median", "q1q3", "range") + total_kidney_volume_ml_manual + ht_adj_tkv_manual, data = dat)
```
...
```{r, include=F}
table_two_lim <- tableby(group ~ dexa_lean_kg + dexa_fat_kg + dexa_body_fat + dexa_trunk_kg + fasting_ffa + kwt(ffa_suppression, "Nmiss", "median", "q1q3", "range") + kwt(fasting_insulin, "Nmiss", "median", "q1q3", "range") + kwt(steady_state_insulin, "Nmiss", "median", "q1q3", "range") + steady_state_cpeptide + gir_190 + kwt(m_i, "Nmiss", "median", "q1q3", "range") + kwt(di, "Nmiss", "median", "q1q3", "range") + kwt(airg, "Nmiss", "median", "q1q3", "range") + kwt(acprg, "Nmiss", "median", "q1q3", "range") + kwt(insulin_cpep, "Nmiss", "median", "q1q3", "range")+ total_kidney_volume_ml_manual + ht_adj_tkv_manual, data = dat_obese_t2d)
```
...
```{r, include=F}
table_two_raas_sglt <- tableby(group ~ dexa_lean_kg + dexa_fat_kg + dexa_body_fat + dexa_trunk_kg + fasting_ffa + kwt(ffa_suppression, "Nmiss", "median", "q1q3", "range") + kwt(fasting_insulin, "Nmiss", "median", "q1q3", "range") + kwt(steady_state_insulin, "Nmiss", "median", "q1q3", "range") + steady_state_cpeptide + gir_190 + kwt(m_i, "Nmiss", "median", "q1q3", "range") + kwt(di, "Nmiss", "median", "q1q3", "range") + kwt(airg, "Nmiss", "median", "q1q3", "range") + kwt(acprg, "Nmiss", "median", "q1q3", "range") + kwt(insulin_cpep, "Nmiss", "median", "q1q3", "range"), data = subset(dat_obese_t2d, raasi_timepoint == "No" & sglti_timepoint == "No"))
```
...
correlation_table_minimal(subset(dat, group != "Lean Control"), 
                          c("gfr_raw_plasma","erpf_raw_plasma","glomerular_pressure","rvr",
                            ...
                            "steady_state_cpeptide", "gir_190","m_i","di", "airg","acprg",
...
# Sensitivity analysis - excluding near zero AIRg and ACPRg
correlation_table_minimal(subset(dat, group = "Type 2 Diabetes" & airg != 0.01 & acprg != 0.01), 
                          c("gfr_raw_plasma","erpf_raw_plasma","glomerular_pressure","rvr",
                            "avg_bl_cortex", "avg_bl_medulla", "avg_fsoc_medulla",
                            "dexa_lean_mass", "dexa_fat_kg","dexa_body_fat","dexa_trunk_kg",
                            "fasting_ffa", "ffa_suppression","fasting_insulin", "steady_state_insulin",
...
pcor.plot(subset(dat, group != "Lean Control"), 
          X = c("dexa_lean_mass","dexa_fat_kg","dexa_body_fat", "dexa_trunk_kg", "fasting_ffa",
                ...
                "gir_190", "m_i",  "di",  "airg", "acprg","hba1c",
                "avg_bl_cortex", "avg_bl_medulla", "avg_fsoc_medulla"),
          Y = c("gfr_raw_plasma",  "erpf_raw_plasma",  "glomerular_pressure", "rvr",
                "avg_bl_cortex_row", "avg_bl_medulla_row",  "avg_fsoc_medulla_row"), 
          Z = "bmi", dict = dict)
...
corr_plot_modified(subset(dat, group != "Lean Control"), 
                   X = c( "ffa_suppression",
                          "fasting_insulin", 
                          "steady_state_insulin", 
                          "m_i", 
...
```{r, include = F}
table_five <- tableby(elevated_albuminuria ~ bmi + weight + height + gfr_raw_plasma +  gfr_bsa_plasma +  erpf_raw_plasma +  erpf_bsa_plasma +  ff +  glomerular_pressure +  ra +  kwt(re, "Nmiss", "median", "q1q3", "range") +  rvr +  total_kidney_volume_ml + ht_adj_tkv +  pcasl3d_left + pcasl3d_right + adc_left + adc_right + bold_l_bl_cortex + bold_r_bl_cortex +  bold_l_bl_medulla + bold_r_bl_medulla + fsoc_l_medulla + fsoc_r_medulla + fsoc_l_medulla + fsoc_r_medulla,  data = dat)
```
...
```{r, include=F}
table_five_lim <- tableby(elevated_albuminuria ~ bmi + weight + height + gfr_raw_plasma +  gfr_bsa_plasma +  erpf_raw_plasma +  erpf_bsa_plasma +  ff +  glomerular_pressure +  ra +  kwt(re, "Nmiss", "median", "q1q3", "range") +  rvr +  total_kidney_volume_ml + ht_adj_tkv +  pcasl3d_left + pcasl3d_right + adc_left + adc_right + bold_l_bl_cortex + bold_r_bl_cortex +  bold_l_bl_medulla + bold_r_bl_medulla + fsoc_l_medulla + fsoc_r_medulla + avg_pcasl3d +  avg_bl_cortex + avg_bl_medulla + avg_fsoc_medulla,  data = subset(dat, group == "Type 2 Diabetes"))
```
...
```{r, include = F}
table_six <- tableby(elevated_albuminuria ~ dexa_lean_kg + dexa_fat_kg + dexa_body_fat + dexa_trunk_kg + fasting_ffa + kwt(ffa_suppression, "Nmiss", "median", "q1q3", "range") + kwt(fasting_insulin, "Nmiss", "median", "q1q3", "range") + kwt(steady_state_insulin, "Nmiss", "median", "q1q3", "range") + steady_state_cpeptide + gir_190 + kwt(m_i, "Nmiss", "median", "q1q3", "range") + kwt(di, "Nmiss", "median", "q1q3", "range") + kwt(airg, "Nmiss", "median", "q1q3", "range") + kwt(acprg, "Nmiss", "median", "q1q3", "range"), data = dat)
```
...
```{r, include=F}
table_six_lim <- tableby(elevated_albuminuria ~ dexa_lean_kg + dexa_fat_kg + dexa_body_fat + dexa_trunk_kg + fasting_ffa + kwt(ffa_suppression, "Nmiss", "median", "q1q3", "range") + kwt(fasting_insulin, "Nmiss", "median", "q1q3", "range") + kwt(steady_state_insulin, "Nmiss", "median", "q1q3", "range") + steady_state_cpeptide + gir_190 + kwt(m_i, "Nmiss", "median", "q1q3", "range") + kwt(di, "Nmiss", "median", "q1q3", "range") + kwt(airg, "Nmiss", "median", "q1q3", "range") + kwt(acprg, "Nmiss", "median", "q1q3", "range"), data = subset(dat, group == "Type 2 Diabetes"))
```
...
```{r, include=F}
table_six_lim_hyper <- tableby(mgfr_hyper ~ bmi + weight + height + dexa_lean_kg + dexa_fat_kg + dexa_body_fat + dexa_trunk_kg + fasting_ffa + kwt(ffa_suppression, "Nmiss", "median", "q1q3", "range") + kwt(fasting_insulin, "Nmiss", "median", "q1q3", "range") + kwt(steady_state_insulin, "Nmiss", "median", "q1q3", "range") + steady_state_cpeptide + gir_190 + kwt(m_i, "Nmiss", "median", "q1q3", "range") + kwt(di, "Nmiss", "median", "q1q3", "range") + kwt(airg, "Nmiss", "median", "q1q3", "range") + kwt(acprg, "Nmiss", "median", "q1q3", "range"), data = subset(dat, group == "Type 2 Diabetes"))
```
...
TukeyHSD(aov(total_kidney_volume_ml_manual ~ group, data = dat), "group")
TukeyHSD(aov(ht_adj_tkv_manual ~ group, data = dat), "group")
# Table 2
...
# M-value
summary(lm(glomerular_pressure ~ gir_190 + group + gir_190*group, data = dat_obese_t2d))
...
# Group name change
dat <- dat %>%
  mutate(group = case_when(group == "Lean Control" ~ "Controls in normal weight category",
                           group == "Obese Control" ~ "Controls with obesity",
                           group == "Type 2 Diabetes" ~ "Youth with type 2 diabetes"))
...
```{r warning = F}
# GFR vs. Fat mass (kg)
gfr1 <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(dexa_fat_kg, gfr_raw_plasma)) +
  labs(x = Hmisc::label(dat$dexa_fat_kg),
...
gfr2 <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(dexa_trunk_kg, gfr_raw_plasma)) +
  labs(x = Hmisc::label(dat$dexa_trunk_kg),
       y = Hmisc::label(dat$gfr_raw_plasma),
       color  = "Group") +
  geom_point(aes(color=group)) +
...
# RPF vs. Fat mass (kg)
rpf1 <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(dexa_fat_kg, erpf_raw_plasma)) +
  labs(x = Hmisc::label(dat$dexa_fat_kg),
...
rpf2 <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(dexa_trunk_kg, erpf_raw_plasma)) +
  labs(x = Hmisc::label(dat$dexa_trunk_kg),
       y = Hmisc::label(dat$erpf_raw_plasma),
       color  = "Group") +
  geom_point(aes(color=group)) +
...
# Pglo vs. trunk mass (kg)
pglo2_1 <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(dexa_trunk_kg, glomerular_pressure)) +
  labs(x = Hmisc::label(dat$dexa_trunk_kg),
       y = Hmisc::label(dat$glomerular_pressure),
       color  = "Group") +
  geom_point(aes(color=group)) +
...
# RPF vs. M/I
rpf_mi <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(m_i, erpf_raw_plasma)) +
  labs(x = Hmisc::label(dat$m_i),
       y = Hmisc::label(dat$erpf_raw_plasma),
       color  = "Group") +
  geom_point(aes(color=group)) +
  scale_color_manual(values=c('#20a39e', "#ef5b5b")) +
...
# Pglo vs. DI
pglo2_di <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(di, glomerular_pressure)) +
  labs(x = Hmisc::label(dat$di),
       y = Hmisc::label(dat$glomerular_pressure),
       color  = "Group") +
  geom_point(aes(color=group)) +
  scale_color_manual(values=c('#20a39e', "#ef5b5b")) +
...
fsoc2_1 <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(airg, fsoc_l_medulla)) +
...
fsoc2_2 <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(airg, fsoc_r_medulla)) +
  labs(x = Hmisc::label(dat$airg),
       y = Hmisc::label(dat$fsoc_r_medulla),
       color  = "Group") +
  geom_point(aes(color=group)) +
...
fsoc2_3 <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(acprg, fsoc_l_medulla)) +
...
fsoc2_4 <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(acprg, fsoc_r_medulla)) +
  labs(x = Hmisc::label(dat$acprg),
       y = Hmisc::label(dat$fsoc_r_medulla),
       color  = "Group") +
  geom_point(aes(color=group)) +
...
avg_plot_1 <- ggarrange(pglo1, pglo3, pglo2, 
                        avg2, avg1, avg3,
                        avg4, avg6, avg5,
                     ncol = 3, nrow = 3, common.legend = T) + plot_annotation(
  title = "Supplemental Figure 4",
  theme = theme(
    plot.title = element_text(hjust = 0, face = "bold")
  )
)
# ggsave("/Users/choiyej/GitHub/YC_CHCO/RH/avg_1.png", avg_plot_1, width = 2800, height = 2800, units = "px")
```
...
avg2_1 <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(airg, avg_m_fsoc)) +
  labs(x = Hmisc::label(dat$airg),
       y = Hmisc::label(dat$avg_m_fsoc),
       color  = "Group") +
  geom_point(aes(color=group)) +
...
avg2_2 <- ggplot(subset(dat, group != "Controls in normal weight category"), aes(acprg, avg_m_fsoc)) +
  labs(x = Hmisc::label(dat$acprg),
       y = Hmisc::label(dat$avg_m_fsoc),
       color  = "Group") +
  geom_point(aes(color=group)) +
...
# ggsave("/Users/choiyej/GitHub/YC_CHCO/RH/avg_2.png", avg_plot_2, width = 2800, height = 2800, units = "px")
...
dat_obese_t2d %<>%
  ...
  mutate(group = case_when(group == "Lean Control" ~ "Controls in normal weight category",
                           group == "Obese Control" ~ "Controls with obesity",
                           group == "Type 2 Diabetes" ~ "Youth with type 2 diabetes")) %>%
  mutate(bcell_airg = case_when(airg > 0.01 & group == "Youth with type 2 diabetes" ~ "Youth with type 2 diabetes**",
                                group == "Youth with type 2 diabetes" ~ "T2D + Glycemic failure",
                                group == "Controls with obesity" ~ "Controls with obesity"),
         bcell_acprg = case_when(airg > 0.01 & group == "Youth with type 2 diabetes" ~ "Youth with type 2 diabetes*",
                                group == "Youth with type 2 diabetes" ~ "T2D + Glycemic failure",
                                group == "Controls with obesity" ~ "Controls with obesity"),
...
acprg_plot <- ggplot(dat_obese_t2d, mapping = aes((gir_190), log(acprg))) +
  geom_point(aes(color = group,
                 shape = group),
             size = 3) +
  labs(color = "Group",
...
airg_plot <- ggplot(dat_obese_t2d, mapping = aes((gir_190), log(airg))) +
  geom_point(aes(color = group,
                 shape = group),
             size = 3)  +
  labs(color = "Group",
...
di_plot <- ggplot(dat_obese_t2d, mapping = aes((gir_190), log(di))) +
  geom_point(aes(color = group,
                 shape = group),
             size = 3) +
  labs(color = "Group",
...
arranged_m <- ggarrange(acprg_plot, airg_plot,
          common.legend = T,
          ncol = 2, nrow = 1) + plot_annotation(
  title = "Supplemental Figure 2",
  caption = "*Excluding participants with \u2264 0 AIRg and/or ACPRg.",
  theme = theme(
    plot.title = element_text(hjust = 0, face = "bold")
  )
)
...
# 
# acprg_plot <- ggplot(dat_obese_t2d, mapping = aes((gir_190), (acprg))) +
#   geom_point(aes(color = group,
#                  shape = group),
#              size = 3) +
#   labs(color = "Group",
...
#          color = guide_legend(nrow=3))
# 
# airg_plot <- ggplot(dat_obese_t2d, mapping = aes((gir_190), (airg))) +
#   geom_point(aes(color = group,
#                  shape = group),
#              size = 3)  +
#   labs(color = "Group",
...
#         legend.text = element_text(size = 14))
# 
# di_plot <- ggplot(dat_obese_t2d, mapping = aes((gir_190), (di))) +
#   geom_point(aes(color = group,
#                  shape = group),
#              size = 3) +
#   labs(color = "Group",

...
Volcano plot of the differences in differences for VSG compared to SMT. A positive logFC indicates that the change in VSG is greater than change in SMT (i.e., the metabolite increased more or decreased less in VSG).

...
```{r, include=FALSE}
filename <- "RPC2 targeted normalised data combined PN.csv"
full_path <- file.path(data_path, filename)
data <- read.csv(full_path)

'/Users/lpyle/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/AstraZeneca/RPC2 targeted normalised data combined PN.xlsx'

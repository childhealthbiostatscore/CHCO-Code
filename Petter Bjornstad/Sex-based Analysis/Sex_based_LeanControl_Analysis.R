...
# converted_files <- convert_all_pdfs(folder_path, dpi = 600)
 ...
 ########## Lineage Tracing (Slingshot) Analysis - Modified Version
 ...
 # ============================================================================
 # PANEL B: Stacked bar plot of PT cell subtypes by sex
 # ============================================================================
 ...
 # Create stacked bar plot using celltype colors
 p2 <- ggplot(celltype_composition, aes(x = sex, y = percentage, fill = celltype)) +
   geom_bar(stat = "identity", color = "black", size = 0.3) +
   scale_fill_manual(values = celltype_colors) +  # Use celltype colors
 ...
 # ============================================================================
 # PANEL C: Density plot by sex (using orange for Women, purple for Men)
 # ============================================================================
 
 p3 <- ggplot(plot_df_clean, aes(x = pseudotime, fill = sex, color = sex)) +
   geom_density(alpha = 0.3, size = 1) +
   scale_fill_manual(values = sex_colors) +   # Orange for Women, Purple for Men
 ...
 # Combine all plots (removed Panel G)
 combined_plot <- (p1_labeled | p2_labeled) / 
   (p3_labeled) / 
   (bar_charts[[1]] | bar_charts[[2]] | bar_charts[[3]])

...
I spoke with Petter yesterday about our EDNSG abstract submission, and he suggested I reach out to ask about the CROCODILE follow-up data, particularly measured GFR, RPF, and the multiparametric MRI outcomes. Would you be able to share the available follow-up dataset?
...
dat_subset <- dat %>%
  ...
  dplyr::select(record_id, visit, co_enroll_study, croc_id, panda_id, age, group, sex, 
                weight, height, bmi, gfr_raw_plasma, gfr_bsa_plasma,
                erpf_raw_plasma, erpf_bsa_plasma, avg_pcascl, avg_c_adc, avg_c_r2, avg_m_r2, avg_k_r2,

...
exclude = pd.read_csv("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Data_Cleaned/exclude_list.csv", low_memory=False)
...
# crc_dxa <- read.csv("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Data_Cleaned/CRC_extremities_lean_mass.csv")
...
# save(dat, file = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Data_Cleaned/croc_data.RData")

load(file = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Data_Cleaned/croc_data.RData")
...
# write.csv(t1_dat, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Data_Cleaned/CRC_t1_dat.csv", row.names = F)
# write.csv(t2_dat, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Data_Cleaned/CRC_t2_dat.csv", row.names = F)
# write.csv(t3_dat, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Data_Cleaned/CRC_t3_dat.csv", row.names = F)
# write.csv(fig1_dat, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Data_Cleaned/CRC_fig1_dat.csv", row.names = F)
...
```{r include = T}
pdf(height = 4000, width = 3000, file = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Dissemination/Figures/YC/Correlation_clinical.pdf")
...
png(height = 1200, width = 800, file = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Dissemination/Figures/YC/Correlation_clinical_age.png", res = 170)
pcor.plot(data = dat, 
          X = c("avg_c_f", "avg_m_f","avg_c_k2", "avg_m_k2"),
          Y = c("gbm_thick_artmean", "p2_gc_m"),
...
png(height = 1200, width = 800, file = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Dissemination/Figures/YC/Correlation_clinical_hba1c.png", res = 170)
pcor.plot(data = dat, 
          X = c("avg_c_f", "avg_m_f","avg_c_k2", "avg_m_k2"),
          Y = c("gbm_thick_artmean", "p2_gc_m"),
...
png(height = 1200, width = 800, file = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Dissemination/Figures/YC/Correlation_clinical_sex.png", res = 170)
corr_plot_modified(data = dat,
                   X = c("avg_c_f", "avg_m_f","avg_c_k2", "avg_m_k2"),
                   Y = c("gbm_thick_artmean", "p2_gc_m"),
                   adj_var = "sex",
...
png(height = 1200, width = 800, file = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Dissemination/Figures/YC/Correlation_clinical_gfr_bodyfat.png", res = 170)
pcor.plot(data = dat, 
          X = c("avg_c_f", "avg_m_f","avg_c_k2", "avg_m_k2"),
          Y = c("gbm_thick_artmean", "p2_gc_m"),
...
# PT morphometrics
```{r echo = F, message=F}
png(height = 1200, width = 800, file = "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Dissemination/Figures/YC/Correlation_clinical_w_pt.png", res = 170)
corr_plot_modified(data = dat,
                   X = c("avg_c_f", "avg_m_f","avg_c_k2", "avg_m_k2"),
...
```{r echo = F, message = F}
tissue_met <- read.csv("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Data_Cleaned/CRC_tissue_metabolomics_011624.csv", na.strings = c("NA", "")) %>% 
...
write.csv(dat_vb_hct, "/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Data_Cleaned/CRC_vb_hct.csv", row.names = F)
```

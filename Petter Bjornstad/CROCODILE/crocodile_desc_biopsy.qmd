...
```{r include = F}
load("//Users/choiyej/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/CROCODILE/Data_Cleaned/croc_data.RData")
dat <- dat %>%
...
# 
summary(arsenal::tableby(group ~ hba1c + bmi + eGFR_fas_cr + sex + age + race + ethnicity + kwt(acr_u, "medianq1q3") + sbp + dbp, data = dat, digits = 2))
```

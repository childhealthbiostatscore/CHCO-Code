...
summary(arsenal::tableby(bmi_cat ~ avg_c_t1, 
                         data=subset(rh_rh2_croc_panther_unique, study == "PANTHER" & bmi_cat != "Overweight")),
        total = F)

summary(arsenal::tableby(group_risk_lowyn ~ avg_c_t1, 
...
summary(arsenal::tableby(group ~ dexa_body_fat + dexa_fat_kg + dexa_lean_mass + dexa_lean_kg + dexa_trunk_mass + dexa_trunk_kg + dexa_bone_mineral_density, 
                         data = subset(rh_rh2_croc_panther_unique, study == "PANTHER" & is.na(group_risk) & !is.na(avg_c_t1))))

summary(arsenal::tableby(group_risk ~ dexa_body_fat + dexa_fat_kg + dexa_lean_mass + dexa_lean_kg + dexa_trunk_mass + dexa_trunk_kg + dexa_bone_mineral_density, 

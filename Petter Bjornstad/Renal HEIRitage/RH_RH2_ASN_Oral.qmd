...
summary(arsenal::tableby(study_visit ~ age + sex + bmi + group + uacr_group + diabetes_duration + sbp + dbp + hba1c + gfr_bsa_plasma + erpf_bsa_plasma + date_diff_years + htadjtkv_combined + avg_c_r2 + avg_k_r2 + avg_c_adc + avg_pcascl, data = rh_rh2_unique_follow_up, digits = 1))
```

...
for (cell in names(celltype_groups)) {
  print(kable(meta_df_compiled[meta_df_compiled$analysis_type == reverse_folders[[folder]] & 
                                 meta_df_compiled$celltype == cell,]))
  
  cat("\n::: {layout-ncol=2}\n\n")
  
  cat(paste0("![p-value < 0.05](", file.path(root_path, 
                                             paste0("Renal HERITAGE/Results/Figures/Volcano Plots/pval/", folder, "_", 
                                                    tolower(gsub("/", "_", cell)), ".png")), ")\n\n"))
  
  cat(paste0("![FDR < 0.05](", file.path(root_path, 
                                         paste0("Renal HERITAGE/Results/Figures/Volcano Plots/fdr/", folder, "_", 
                                                tolower(gsub("/", "_", cell)), "_fdr.png")), ")\n\n"))
  
  cat(paste0("![](", file.path(root_path, paste0("Renal HERITAGE/Results/Figures/Pathways/hallmark_", folder, "_", tolower(gsub("/", "_", cell)), "_gsea.png")),
             ")\n\n"))
  
  cat(paste0("![](", file.path(root_path, paste0("Renal HERITAGE/Results/Figures/Pathways/Underlying genes/Combined/hallmark_", folder, "_", tolower(gsub("/", "_", cell)), "_combined.png")),
             ")\n\n"))
...
for (cell in names(celltype_groups)) {
  meta_df_compiled[meta_df_compiled$analysis_type == reverse_folders[[folder]] & meta_df_compiled$celltype == cell,]
...
for (cell in names(celltype_groups)[names(celltype_groups) %nin% c("MC", "Schwann")]) {
  print(kable(meta_df_compiled[meta_df_compiled$analysis_type == reverse_folders[[folder]] & 
                                 meta_df_compiled$celltype == cell,]))
...
for (cell in names(celltype_groups)[names(celltype_groups) %nin% c("aPT")]) {
  cat("::: {layout-ncol=2}\n\n")

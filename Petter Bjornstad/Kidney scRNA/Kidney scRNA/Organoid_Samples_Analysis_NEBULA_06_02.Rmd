...
# # Find neighbors and clusters (again using integrated data)
so_15_annotated <- FindNeighbors(so_15_annotated, assay = "RNA", dims = 1:15)
so_15_annotated <- FindClusters(so_15_annotated, resolution = 0.5)

# Perform UMAP and tSNE
#so_15_annotated <- RunTSNE(so_15_annotated, dims = 1:20)
so_15_annotated <- RunUMAP(so_15_annotated, dims = 1:15) #20 to 50 
so_15_annotated@reductions
p <- DimPlot(so_15_annotated, reduction = "umap", raster = F)
# png(fs::path(dir.results,"Unlabeled_UMAP_Organoid_15.png"),width=3000,height=3000,res=300)
plot(p,asp = 1)
# dev.off()

p <- DimPlot(so_15_annotated, reduction = "umap", group.by = "celltype_annotation", label = T,raster = T)+
  ggtitle(label="Organoid Markers (15 Glucose Conc.)")
# png(fs::path(dir.results,"Beno_UMAP_Organoid_15.png"),width=3000,height=3000,res=300)
# png("Beno_UMAP_Organoid_15.png",width=3000,height=3000,res=300)
plot(p,asp = 1)
# dev.off()
...
# # Find neighbors and clusters (again using integrated data)
so_15_annotated <- FindNeighbors(so_15_annotated, assay = "RNA", dims = 1:50)
so_15_annotated <- FindClusters(so_15_annotated, resolution = 0.5)

# Perform UMAP and tSNE
#so_15_annotated <- RunTSNE(so_15_annotated, dims = 1:20)
so_15_annotated <- RunUMAP(so_15_annotated, dims = 1:50) #20 to 50
so_15_annotated@reductions
DimPlot(so_15_annotated, reduction = "umap", raster = T)

p <- DimPlot(so_15_annotated, reduction = "umap", group.by = "celltype_annotation", label = T,raster = T)+
  ggtitle(label="Low-Resolution KPMP Celltypes (15 Glucose Conc.)")
# png(fs::path(dir.results,"Raji_UMAP_Organoid_15.png"),width=3000,height=3000,res=300)
plot(p,asp = 1)
# dev.off()
...
####III. Low resolution from KPMP Atlas
```{r}
###############################################################################################################
#2. Low resolution from KPMP Atlas - https://www.nature.com/articles/s41586-023-05769-3
gc()
...
marker_df <- read.csv(temp_file)
marker_df <- marker_df[-15,]
# marker_df <- read.csv("/Users/hhampson/Library/CloudStorage/OneDrive-UW/Biostatistics Core Shared Drive/Kidney scRNAseq Project/Data/KPMP_Celltype_Markers_Low_Res.csv")
# marker_df <- marker_df[-15,]
...
# so_15_annotated <- RunUMAP(so_15_annotated, dims = 1:50) #20 to 50
so_15_annotated <- RunUMAP(so_15_annotated, 
                           dims = 1:50,           # or 1:30
                           n.neighbors = 15,
                           min.dist = 0.1,
                           seed.use = 42)
...
p <- DimPlot(so_15_annotated, reduction = "umap", group.by = "celltype_annotation", label=T,raster=T)+
  ggtitle(label="Low Resolution KPMP Celltypes (15 Glucose Conc.)")
# png(fs::path(dir.results,"KPMP_LR_UMAP_Organoid_15.png"),width=3000,height=3000,res=300)
png("/home/hhampson/Results/KPMP_LR_UMAP_Organoid_15.png",res=300,width=3000,height=3000)
plot(p,asp = 1)
dev.off()
...
####IV. High resolution from KPMP Atlas
```{r}
###############################################################################
#3. High resolution from KPMP Atlas - https://www.nature.com/articles/s41586-023-05769-3
gc()
...
s3$download_file(bucket, "KPMP_Celltype_Markers_High_Res.csv", temp_file)
marker_df <- read.csv(temp_file)
# marker_df <- read.csv("/Users/hhampson/Library/CloudStorage/OneDrive-UW/Biostatistics Core Shared Drive/Kidney scRNAseq Project/Data/KPMP_Celltype_Markers_High_Res.csv")
# marker_df <- marker_df[-15,]
...
# Perform UMAP and tSNE
# so_liver_sc <- RunTSNE(so_15_annotated, dims = 1:20)
so_15_annotated <- RunUMAP(so_15_annotated, dims = 1:30) #20 to 50 
so_15_annotated@reductions
DimPlot(so_15_annotated, reduction = "umap", raster = T)

p <- DimPlot(so_15_annotated, reduction = "umap", group.by = "celltype_annotation_dual", label=T,raster = T)+
  ggtitle(label="High-Resolution KPMP Celltypes (15 Glucose Conc.)")
# png(fs::path(dir.results,"KPMP_HR_UMAP_Organoid_15.png"),width=3000,height=3000,res=300)
plot(p,asp = 1)
# dev.off()
...
# Annotate cell types (adjust min_score_diff as needed)
so_30_annotated <- annotate_celltypes(so_30, marker_genes, min_score_diff = 0.05)
...
p <- DimPlot(so_30_annotated, reduction = "umap", raster = F)
png(fs::path(dir.results,"Unlabeled_UMAP_Organoid_30.png"),width=3000,height=3000,res=300)
plot(p,asp = 1)
dev.off()

p <- DimPlot(so_30_annotated, reduction = "umap", group.by = "celltype_annotation", label = T,raster = T)+
  ggtitle(label="Organoid Markers (30 Glucose Conc.)")
png(fs::path(dir.results,"Beno_UMAP_Organoid_30.png"),width=3000,height=3000,res=300)
plot(p,asp = 1)
dev.off()
...
p <- DimPlot(so_30_annotated, reduction = "umap", group.by = "celltype_annotation", label = T,raster = T)+
  ggtitle(label="Low-Resolution KPMP Celltypes (30 Glucose Conc.)")
png(fs::path(dir.results,"Raji_UMAP_Organoid_30.png"),width=3000,height=3000,res=300)
plot(p,asp = 1)
dev.off()
...
p <- DimPlot(so_30_annotated, reduction = "umap", group.by = "celltype_annotation", label=T,raster=T)+
  ggtitle(label="Low Resolution KPMP Celltypes (30 Glucose Conc.)")
png(fs::path(dir.results,"KPMP_LR_UMAP_Organoid_30.png"),width=3000,height=3000,res=300)
plot(p,asp = 1)
dev.off()
...
p <- DimPlot(so_30_annotated, reduction = "umap", group.by = "celltype_annotation_dual", label=T,raster = T)+
  ggtitle(label="High-Resolution KPMP Celltypes (30 Glucose Conc.)")
png(fs::path(dir.results,"KPMP_HR_UMAP_Organoid_30.png"),width=3000,height=3000,res=300)
plot(p,asp = 1)
dev.off()
# DimPlot(so_30_annotated, reduction = "pca", group.by = "celltype_annotation", label=T,raster = T)+
#   ggtitle(label="High-Resolution KPMP Celltypes (30 Glucose Conc.)")
...
# Perform UMAP and tSNE
# so_liver_sc <- RunTSNE(so_30_annotated, dims = 1:20)
# so_30_annotated <- RunUMAP(so_30_annotated, dims = 1:50) #20 to 50
so_30_annotated <- RunUMAP(so_30_annotated, 
                           dims = 1:30,           # or 1:30
                           n.neighbors = 30,
                           min.dist = 0.1,
                           seed.use = 42)
...
p <- DimPlot(so_30_annotated, reduction = "umap", group.by = "celltype_annotation", label=T,raster=T)+
  ggtitle(label="Low Resolution KPMP Celltypes (30 Glucose Conc.)")
# png(fs::path(dir.results,"KPMP_LR_UMAP_Organoid_30.png"),width=3000,height=3000,res=300)
png("/home/hhampson/Results/KPMP_LR_UMAP_Organoid_30.png",res=300,width=3000,height=3000)
plot(p,asp = 1)
dev.off()
```
...
# write.csv(top_20_markers,"/home/hhampson/Results/top_20_markers_15.csv")
...
top_5_markers <- get_top_markers(all_markers, top_n = 1)
...
# print(dotplot_20)
# dev.off()
png("/home/hhampson/Results/dotplot_avg_exp_top20_15.png",res=300,width=5000,height=2500)
print(dotplot_20)
dev.off()
...
heatmap_result <- fix_scaling_and_create_heatmap(so_15, all_markers, top_n = 20)
...
# Mapping clusters 0-16 to cell types
cell_type_annotations <- c(
  "Cluster 0" = "proliferative nephron progenitor",
  "Cluster 1" = "Stromal/Interstitial Cells",
  "Cluster 2" = "podocytes",
  "Cluster 3" = "Earlier/immature Proximal Tubule",
  "Cluster 4" = "Collecting Duct Principal Cells",
  "Cluster 5" = "thick ascending limb (TAL)",
  "Cluster 6" = "Distal convoluted tubule (DCT)",
  "Cluster 7" = "Type A intercalated cells",
  "Cluster 8" = "endothelial cells",
  "Cluster 9" = "off-target neural/neuronal cells",
  "Cluster 10" = "More mature/differentiated Proximal Tubule",
  "Cluster 11" = "Parietal Epithelial Cells (PECs)",
  "Cluster 12" = "Mesangial Cells/Pericytes",
  "Cluster 13" = "Stromal/Interstitial Progenitor Cells",
  "Cluster 14" = "Nephron Progenitor Cells (Cap Mesenchyme)",
  "Cluster 15" = "Proximal Tubule Progenitor/Precursor Cells",
  "Cluster 16" = "Off-target Melanocyte/Neural Crest-like Cells"
)
...
# Perform UMAP and tSNE
so_15 <- RunUMAP(so_15, dims = 1:30) #20 to 50 
so_15@reductions
DimPlot(so_15, reduction = "umap", raster = T)

#Save umap 15
png("/home/hhampson/Results/UMAP_15.png",width = 3000, height = 3000, res=300)
DimPlot(so_15, reduction = "umap", raster = T)
dev.off()
...
# Perform UMAP and tSNE
so_30 <- RunUMAP(so_30, dims = 1:30) #20 to 50 
so_30@reductions
DimPlot(so_30, reduction = "umap", raster = F)

#Save umap 30
png("/home/hhampson/Results/UMAP_30.png",width = 3000, height = 3000, res=300)
DimPlot(so_30, reduction = "umap", raster = T)
dev.off()

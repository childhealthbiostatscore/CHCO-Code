...
sc_org$ScType_Kidney_human <- sc_org$`ScType-Kidney-human`

DimPlot(sc_org, reduction = "umap", group.by = "ScType_Kidney_human", raster = T)
DimPlot(sc_org, reduction = "umap", group.by = "ScType_Kidney_human", raster = T,label=T)

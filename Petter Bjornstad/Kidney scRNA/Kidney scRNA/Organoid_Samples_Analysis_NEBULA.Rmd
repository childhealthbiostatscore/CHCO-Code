...
dir.dat2 <- c("/Users/haileyhampson/Library/CloudStorage/OneDrive-UW/Biostatistics Core Shared Drive/scRNA")
# dir.code <- c("/Users/hhampson/Documents/CHCO-Code/Petter Bjornstad/Liver analysis/Liver scRNAseq")
dir.results <- c("/Users/haileyhampson/Library/CloudStorage/OneDrive-UW/Biostatistics Core Shared DriveKidney scRNAseq Project/NEBULA")
...
ncol(sc_org) #194063 cells
nrow(sc_org) # 14369 genes
...
# so_liver_sc <- RunUMAP(so_liver_sc, dims = 1:15)
sc_org@reductions
DimPlot(sc_org, reduction = "harmony", raster = F)
DimPlot(sc_org, reduction = "harmony", group.by = "seurat_clusters", raster = FALSE)
plot1 <- DimPlot(sc_org, reduction = "harmony", group.by = "seurat_clusters",raster = FALSE, label = TRUE, label.size = 4)+
  ggtitle("Harmony UMAP Plot with Cell Type Labels")
# pdf(plot1,fs::path(dir.results,"UMAP_Celltypes_Organoid_Samples.pdf"),width=10,height=10)
# plot(plot1)
# dev.off()
...
DimPlot(sc_org, reduction = "umap.harmony",group.by = "group",label=F,raster=F) +
  ggtitle(paste0("UMAP by Disease Category"))
...
sc_org$group <- factor(sc_org$group)
DimPlot(sc_org, reduction = "umap.rpca",group.by = "group",label=F,raster=F) +
  ggtitle(paste0("rpca UMAP by Disease Category"))

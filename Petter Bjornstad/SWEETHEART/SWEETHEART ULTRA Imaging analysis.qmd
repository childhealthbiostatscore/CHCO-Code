...
summary(arsenal::tableby(group ~ imaging_visit_id + age + sex + bmi + kwt(acr_u, "Nmiss", "medianq1q3") + hba1c + eGFR_CKD_epi +
                           acr_u_cat3 + dkd_group_30 + dkd_group_100, data = subset(harm_dat_subset, imaging_visit_id != "ultra_follow_up")))
...
summary(arsenal::tableby(sex ~ lvedv + lvedv_bsa + lvesv + kwt(lvesv_bsa, "Nmiss", "medianq1q3") + lvsv + lvsv_bsa + lvef + kwt(lv_myo_mass_dias, "Nmiss", "medianq1q3") + kwt(lv_myo_mass_dias_bsa, "Nmiss", "medianq1q3") + lv_myo_mass_syst + lv_myo_mass_syst_bsa, data = subset(harm_dat_subset, imaging_visit_id != "ultra_follow_up" & group != "Lean Control")))

summary(arsenal::tableby(sex ~ rvedv + rvedv_bsa + kwt(rvesv, "Nmiss", "medianq1q3") + kwt(rvesv_bsa, "Nmiss", "medianq1q3") + kwt(rvsv, "Nmiss", "medianq1q3") + kwt(rvsv_bsa, "Nmiss", "medianq1q3") + rvef, data = subset(harm_dat_subset, imaging_visit_id != "ultra_follow_up" & group != "Lean Control")))
...
table(subset(harm_dat_subset, group != "Lean Control" & imaging_visit_id != "ultra_follow_up")$acr_u_cat300)

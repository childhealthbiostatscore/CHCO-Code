...
# =====================================================================
# WHAT THIS FILE DOES
# Cleans the COFFEE REDCap project into a harmonized, semi-long
# DataFrame (one row per procedure, with a visit column).
# Called by: data_harmonization.py via clean_coffee()
#
...
# clamp, outcomes, then missingness filtering and merge.
# =====================================================================

...
# This file lives in exports/. rpc2.py now lives in studies/ and the helper
# it imports (harmonization_functions) lives in calculations/, so resolve the
# repo root from this file and add both folders.

...
labs <- rpc2 %>%
  dplyr::select(record_id, visit, mrn, hemoglobin, hematocrit, pltct,
       ...
       eag, chol_base, hdl, ldl, triglycerides, cystatin_c_s,
...
bx <- rpc2 %>%
  dplyr::select(record_id, visit, mrn, baseline_bx, followup_bx, kit_id, glut_id, form_id,
       ...
       kidney_side, kidney_location, passes_attempt,
       pass1_time, pass1_core_cm, pass1_core_spec,
       pass2_time, pass2_core_cm, pass2_core_spec,
       pass3_time, pass3_core_cm, pass3_core_spec,
       pass4_time, pass4_core_cm, pass4_core_spec,
...
missing_df <- rbind(demo_missing, vitals_missing, screen_labs_missing, labs_missing, bx_missing, rct_missing)
missing_df$value = NA
missing_df$notes = NA
...
write.csv(missing_df, file.path(root_path, "RPC2/Data Clean/rpc2_missing_data_052026.csv"), na = "", row.names = F)
```

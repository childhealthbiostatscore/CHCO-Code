...
load("/Users/kristenmiller/Library/CloudStorage/OneDrive-UW/Laura Pyle's files - Biostatistics Core Shared Drive/Proteomics and DKD/Data_Cleaned/analysis_dataset.RData")
tldata <- df
...
emmdf <- read_xlsx("/Users/kristenmiller/Library/CloudStorage/OneDrive-UW/Laura Pyle's files - Biostatistics Core Shared Drive/Teen Labs/Results/Teen LABS emmeans.xlsx")
...
tiff("/Users/kristenmiller/Library/CloudStorage/OneDrive-SharedLibraries-UW/bjornstad_pyle_tommerdahl_lab - Documents/Dissemination/Manuscripts/P028_TODAY_glycemia_km/02_Submitted/01_JCEM_r2/sfig6.tif",
     res = 300, units = "in", width = 8, height = 12)  # ~7*3 + a little for labels
panel_p
dev.off()
```
...
png('/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Teen Labs/Results/Figures/Teen-LABS_clinical_vars.png', res = 300, width = 8, height = 10, units = "in")
panel_pclin
dev.off()

...
#1. Set Directories ----
# dir.dat <- c("/Users/hhampson/Library/CloudStorage/OneDrive-UW/Biostatistics Core Shared Drive/Hailey Hampson/1_Ongoing Projects/Microbiome Manuscript/Simulation Data 01_08/HPC Data")
# dir.code <- c("/Users/hhampson/CHCO-Code/Petter Bjornstad/Simulation Analysis")
# dir.results <- c("/Users/hhampson/Library/CloudStorage/OneDrive-UW/Biostatistics Core Shared Drive/Simulation Analysis/Microbiome Results/Results New")


#2. Load Libraries ----
#Load Libraries
# source("Simulation Code/Libraries.R")
...
# simulation.parameters <- readRDS(fs::path(dir.dat,"Simulation_Scenarios_03_12_25.rds"))
...
# sim.par.all <- read.csv(fs::path(dir.dat,"Simulation_Parameters.csv"))
...
# dir.sim.data <- c("/Users/hhampson/Library/CloudStorage/OneDrive-UW/Biostatistics Core Shared Drive/Hailey Hampson/1_Ongoing Projects/Microbiome Manuscript/Simulation Data 01_08/Simularion Results Data/Final")
...
# for (scenario in 1:9) {
  ...
  # results <- readRDS(fs::path(dir.sim.data,paste0("scn",scenario,"_iters1_to_1000.RDS")))
...
# saveRDS(all_formatted_results,fs::path(dir.dat,"Formatted_Simulation_Results.rds"))

#Load formatted results
all_formatted_results <- readRDS(fs::path(dir.dat,"Formatted_Simulation_Results.rds"))
...
prep.plot.data <- function(scen.num, expected.all){
  expected.all %>%
    ...
    mutate(
      dot.color = ifelse(ExpVal > 0, "causal", "noncausal"),
      dot.color = factor(dot.color, levels = c("noncausal", "causal"))
    )
}

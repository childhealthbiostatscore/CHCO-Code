...
colnames(base_log_scale)[seq] <- temp
temp <- str_replace_all(colnames(base_log_scale[,seq]),"\\(","")
colnames(base_log_scale)[seq] <- temp
...
jpeg("./Results/Metabolomics linear and Cox models/Plots/plsCox_plasma_metabolomics_MAC.jpg", pointsize = 24, quality = 100, res=600,

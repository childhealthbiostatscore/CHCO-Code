...
# glycemic failure
glyc_contrast <- model.matrix(~GLYC+hba1c+log_trig+sbp+si_1_ins0,fup_a1c)
# moderated t-tests with and without FDR adjustment
y <- fup_log_a1c %>% filter(!is.na(fup_log_a1c$GLYC))
ymat <- t(y[,seq])
...
# CKM progression
ckm_contrast <- model.matrix(~progress_CKM+hba1c+log_trig+sbp+si_1_ins0,fup)
# moderated t-tests with and without FDR adjustment
...
ckm3_contrast <- model.matrix(~progress_CKM_stage3+hba1c+log_trig+sbp+si_1_ins0,fup)
# moderated t-tests with and without FDR adjustment
...
ckm4_contrast <- model.matrix(~progress_CKM_stage4+hba1c+log_trig+sbp+si_1_ins0,fup)
# moderated t-tests with and without FDR adjustment

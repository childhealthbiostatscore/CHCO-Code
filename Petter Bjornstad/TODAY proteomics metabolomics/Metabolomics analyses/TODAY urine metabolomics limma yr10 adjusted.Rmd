---
title: "TODAY urine metabolomics 10 year cross-sectional analyses - adjusted models"
...
# glycemic failure
glyc_contrast <- model.matrix(~GLYC+hba1c+log_trig+sbp+si_1_ins0+sex,fup_a1c)
# moderated t-tests with and without FDR adjustment
y <- fup_log_a1c %>% filter(!is.na(fup_log_a1c$GLYC))
ymat <- t(y[,seq])
...
saveWorkbook(wb,"./Results/Metabolomics Linear and Cox models/TODAY urine metabolomics limma yr10 adjusted_march2026.xlsx",overwrite = TRUE)

...
# take only base plasma ceramides
...
names(base_ceramides) <- c("releaseid","Date.Drawn","C14.uM","C16.uM","C18.uM","C20.uM","C22.uM","C24.uM")
base<- merge(base, base_ceramides,by="releaseid",all.x=T,all.y=F)
...
all_na_cols <- names(base)[colSums(is.na(base)) == nrow(base)]
base <- base[,-which(colnames(base)%in%all_na_cols)]
...
saveWorkbook(wb,"./Results/Metabolomics Linear and Cox models/TODAY plasma metabolomics Cox models scaled baseline adjusted_testKM.xlsx",overwrite = TRUE)

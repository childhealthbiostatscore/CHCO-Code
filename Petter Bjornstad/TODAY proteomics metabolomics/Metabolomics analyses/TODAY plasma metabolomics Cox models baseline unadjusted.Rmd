...
# KM fixing this part - the indices were off because the no_var list refers to the index of metabolite list (base[,seq]), so it wasn't selecting the correct variables from base
...
saveWorkbook(wb,"./Results/Metabolomics Linear and Cox models/TODAY plasma metabolomics Cox models scaled baseline unadjusted.xlsx",overwrite = TRUE)

...
addWorksheet(wb,"CKM_moderated_FDR")
writeData(wb,"CKM_moderated_FDR",results_CKM,rowNames = T)

addWorksheet(wb,"CKM3_moderated_FDR")
writeData(wb,"CKM3_moderated_FDR",results_CKM3,rowNames = T)

addWorksheet(wb,"CKM4_moderated_FDR")
writeData(wb,"CKM4_moderated_FDR",results_CKM4,rowNames = T)


saveWorkbook(wb,"./Results/Metabolomics Linear and Cox models/TODAY plasma metabolomics limma baseline adjusted_march2026.xlsx",overwrite = TRUE)
...
t1 <- CreateTableOne(data=t1data, vars=c("MIC.OR.MAC","MAC","MIC","HYP","RAPID","NEURO","RETINO","GLYC",
                                         "HbA1c","trig","sbp","si_1_ins0","AGEBASE","sex","tg","progress_CKM","progress_CKM_stage3","progress_CKM_stage4"))
t1 <- print(t1)
```

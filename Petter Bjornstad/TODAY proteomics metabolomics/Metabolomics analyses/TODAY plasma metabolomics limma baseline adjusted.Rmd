...
# MAC alone
# Make design matrix
MAC_contrast <- model.matrix(~MAC+HbA1c+log_trig+sbp+si_1_ins0+sex,base)
...
# MIC alone
# Make design matrix
MIC_contrast <- model.matrix(~MIC+HbA1c+log_trig+sbp+si_1_ins0+sex,base)
# moderated t-tests with and without FDR adjustment
ymat <- t(base_log[,seq])
...
# hyperfiltration
hyperfilt_contrast <- model.matrix(~HYP+HbA1c+log_trig+sbp+si_1_ins0+sex,base)
# moderated t-tests with and without FDR adjustment
...
# rapid eGFR decline
rapid_contrast <- model.matrix(~RAPID+HbA1c+log_trig+sbp+si_1_ins0+sex,base)
# moderated t-tests with and without FDR adjustment
...
htn_bp_contrast <- model.matrix(~HTN+HbA1c+log_trig+sbp+si_1_ins0+sex,base)
# moderated t-tests with and without FDR adjustment
...
# hypertension
# omit SBP
htn_contrast <- model.matrix(~HTN+HbA1c+log_trig+si_1_ins0+sex,base)
# moderated t-tests with and without FDR adjustment
y <- base_log %>% filter(!is.na(base_log$HTN))
ymat <- t(y[,seq])
...
# neuropathy
neuro_contrast <- model.matrix(~NEURO+HbA1c+log_trig+sbp+si_1_ins0+sex,base)
# moderated t-tests with and without FDR adjustment
...
# retinopathy
retino_contrast <- model.matrix(~RETINO+HbA1c+log_trig+sbp+si_1_ins0+sex,base)
# moderated t-tests with and without FDR adjustment
...
# glycemic failure
# omit A1c
glyc_contrast <- model.matrix(~GLYC+bmi+si_1_ins0+sex,base)
# moderated t-tests with and without FDR adjustment
...
# glycemic failure
# with A1c
glyc_a1c_contrast <- model.matrix(~GLYC+HbA1c+bmi+si_1_ins0+sex,base)
# moderated t-tests with and without FDR adjustment
y <- base_log %>% filter(!is.na(base_log$GLYC))
ymat <- t(y[,seq])
...
# CKM progression
# Make design matrix
CKM_contrast <- model.matrix(~progress_CKM+sex,base)
# moderated t-tests with and without FDR adjustment
ymat <- t(base_log[,seq])
...
# Make design matrix
CKM3_contrast <- model.matrix(~progress_CKM_stage3+sex,base)
# moderated t-tests with and without FDR adjustment
ymat <- t(base_log[,seq])
...
# Make design matrix
CKM4_contrast <- model.matrix(~progress_CKM_stage4+sex,base)
# moderated t-tests with and without FDR adjustment
ymat <- t(base_log[,seq])

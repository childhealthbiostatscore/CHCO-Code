...
# Save
save(comorb, file="./Clinical data/comorb_CKM.Rdata")
...
# Save
save(baserisk, file="./Clinical data/TODAY/baserisk_CKM.Rdata")
...
# Save
save(yr10risk, file="./Clinical data/TODAY/yr10risk_CKM.Rdata")
...
CBL_TODAY2_KEEP <- CBL_TODAY2 %>%
  select(releaseid, visit, ins0min, codi, trig, hba1c, alt, ast, glu0min)
...
# Save
save(long, file="./Clinical data/TODAY/clinical_data_long_CKM.Rdata")
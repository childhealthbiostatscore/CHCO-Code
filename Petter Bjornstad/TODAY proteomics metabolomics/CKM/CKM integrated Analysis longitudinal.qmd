...
if (user == "laurapyle") {
  ...
  root_path <- "/Users/lpyle/Library/CloudStorage/OneDrive-SharedLibraries-UW/Bjornstad/Biostatistics Core Shared Drive"
} else if (user == "pylell") {
...
soma_fgsea <- run_fgsea_analysis(bg_path = bg_path,
                                     results_annotated = ckm_without_bmi_keep,
                                     stat_col = "statistic")
soma_fgsea$summary
```
...
soma_fgsea_stage3 <- run_fgsea_analysis(bg_path = bg_path,
                                     results_annotated = ckm_stage3_keep,
                                     stat_col = "statistic")
...
soma_fgsea_stage4 <- run_fgsea_analysis(bg_path = bg_path,
                                     results_annotated = ckm_stage4_keep,
                                     stat_col = "statistic")

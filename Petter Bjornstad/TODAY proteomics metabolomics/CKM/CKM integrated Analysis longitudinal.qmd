...
ckm_prog_time <- comorb_ckm2 %>% select(RELEASEID, days, CKM_syn, CKM_syn_num, progress_CKM, progress_CKM2, fup_time)
...
ckm_prog_time1 <- ckm_prog_time1 %>% select(RELEASEID, days_to_ckm_prog, CKM_syn_first_progression, CKM_syn_num_first_progression)
...
prog_summary <- comorb_ckm2 %>% select(RELEASEID, fup_time, CKM_syn_base, CKM_max, progress_CKM,days_to_ckm_prog, num_prog, CKM_syn_first_progression, CKM_syn_num_first_progression) %>%

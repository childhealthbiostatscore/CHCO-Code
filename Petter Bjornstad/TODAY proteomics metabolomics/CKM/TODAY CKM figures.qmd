...
ggsave(
  ...
  width = 1000, height = 700, units = "px", scale = 2
)
```
...
```{r include = F}
v <- volcano(ckm_proteins_4, log_t = T) + xlim(0, 2.0)
...
ggsave(
  ...
  width = 1200, height = 900, units = "px", scale = 2
)
```

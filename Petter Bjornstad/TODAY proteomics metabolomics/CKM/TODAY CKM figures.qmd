...
volcano <- function(data, lab = "Target", xcol = "estimate", ycol = "p.value", zcol = "adj.p.value",
                    ...
                    xlabel = "HR", pCutoff = 0.2, overlaps = 50,
                    log_t = F) {
...
Proteins significant at FDR = 0.2 are labeled. Nominally significant proteins are colored in blue.
...
```{r include = F}
v <- volcano(ckm_proteins_delta, xcol = "logFC", ycol = "P.Value", zcol = "adj.P.Val", log_t = F, xlabel = "logFC")

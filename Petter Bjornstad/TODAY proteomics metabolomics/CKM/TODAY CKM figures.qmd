...
# Volcano plot
volcano <- function(data, lab = "Target", xcol = "estimate", ycol = "p.value", zcol = "p.value",
                    top = 30, 
...
Nominally significant proteins are colored in blue. Top 30 proteins by p-value are labeled.

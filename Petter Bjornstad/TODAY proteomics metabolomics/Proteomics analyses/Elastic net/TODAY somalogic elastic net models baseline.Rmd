...
```{r, include=FALSE, comment=""}
mod_bmi <- coxph(data = base_log_scale, Surv(DAYSTOHTN, HTN)~bmi)
```
...
```{r, include=FALSE, comment=""}
mod_bmip <- coxph(data = base_log_scale, Surv(DAYSTOHTN, HTN)~bmipct)
```
...
```{r, include=FALSE, comment=""}
mod_waist <- coxph(data = base_log_scale, Surv(DAYSTOHTN, HTN)~wastcirc)
```
...
```{r, include=FALSE, comment=""}
mod_relative_fat_mass <- coxph(data = base_log_scale, Surv(DAYSTOHTN, HTN)~relative_fat_mass)
```

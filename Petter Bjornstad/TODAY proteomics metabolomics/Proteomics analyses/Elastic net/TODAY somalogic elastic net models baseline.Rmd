...
f = "/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx"
...
```{r, include=TRUE, comment=""}
kbl(moddf, row.names = FALSE) %>%
  kable_styling() %>%  # Add this for better HTML rendering
...
```{r, include=TRUE, comment=""}
kbl(moddf, row.names = FALSE) %>%  
  kable_styling() %>%  column_spec(1, width = "5cm") %>%   column_spec(2, width = "4cm") %>%   column_spec(3, width = "4cm") %>%   column_spec(4, width = "4cm")
```
...
```{r, include=TRUE, comment=""}
kbl(moddf, row.names = FALSE) %>%   kable_styling() %>%  column_spec(1, width = "5cm") %>%   column_spec(2, width = "4cm") %>%   column_spec(3, width = "4cm") %>%   column_spec(4, width = "4cm")
```
...
## Are BMI, waist circumference, relative fat mass associated with HTN?

### BMI

```{r, include=FALSE, comment=""}
mod_bmi <- coxph(data = base_log_scale, Surv(DAYSTOMIC.OR.MAC, MIC.OR.MAC)~bmi)
```
...
```{r, include=FALSE, comment=""}
mod_bmip <- coxph(data = base_log_scale, Surv(DAYSTOMIC.OR.MAC, MIC.OR.MAC)~bmipct)
```
...
```{r, include=FALSE, comment=""}
mod_waist <- coxph(data = base_log_scale, Surv(DAYSTOMIC.OR.MAC, MIC.OR.MAC)~wastcirc)
```
...
```{r, include=FALSE, comment=""}
mod_relative_fat_mass <- coxph(data = base_log_scale, Surv(DAYSTOMIC.OR.MAC, MIC.OR.MAC)~relative_fat_mass)
```

```{r, comment=""}
summary(mod_relative_fat_mass) 
```

## Add BMI, BMI percentile, waist circumference, relative fat mass to covariates in elastic net

### BMI

#### Proteins plus covariates

```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~",paste0(htn_select,collapse = "+"),paste0("+HbA1c+log_trig+si_1_ins0+bmi")))
mod = coxph(formula = form,data = htn_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~HbA1c+log_trig+si_1_ins0+bmi"))
mod = coxph(formula = form,data = htn_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~",paste0(htn_select,collapse = "+"),paste0("+HbA1c+log_trig+si_1_ins0+bmipct")))
mod = coxph(formula = form,data = htn_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~HbA1c+log_trig+si_1_ins0+bmipct"))
mod = coxph(formula = form,data = htn_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~",paste0(htn_select,collapse = "+"),paste0("+HbA1c+log_trig+si_1_ins0+wastcirc")))
mod = coxph(formula = form,data = htn_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~HbA1c+log_trig+si_1_ins0+wastcirc"))
mod = coxph(formula = form,data = htn_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~",paste0(htn_select,collapse = "+"),paste0("+HbA1c+log_trig+si_1_ins0+relative_fat_mass")))
mod = coxph(formula = form,data = htn_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~HbA1c+log_trig+si_1_ins0+relative_fat_mass"))
mod = coxph(formula = form,data = htn_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
png('/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Proteomics and DKD/Figures/forest_plot_elastic_net_DKD.png', res = 300, width = 9, height = 3, units = "in")
p
dev.off()
...
p$widths <- unit(c(1,100,50,50), "mm")
png('/Users/pylell/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Proteomics and DKD/Figures/forest_plot_elastic_net_htn.png', res = 300, width = 9, height = 3, units = "in")
p
dev.off()
```

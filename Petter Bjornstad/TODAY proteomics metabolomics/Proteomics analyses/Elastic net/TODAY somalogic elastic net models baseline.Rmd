...
f = "/Users/lpyle/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx"
...
set.seed(3654)
source('/Users/lpyle/Documents/GitHub/CHCO-Code/Petter Bjornstad/TODAY proteomics metabolomics/Proteomics analyses/Elastic net/easy_elasticnet.R')
```
...
png('/Users/lpyle/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Proteomics and DKD/Figures/forest_plot_elastic_net_DKD.png', res = 300, width = 9, height = 3, units = "in")
p
dev.off()
...
p$widths <- unit(c(1,100,50,50), "mm")
png('/Users/lpyle/Library/CloudStorage/OneDrive-UW/Bjornstad/Biostatistics Core Shared Drive/Proteomics and DKD/Figures/forest_plot_elastic_net_htn.png', res = 300, width = 9, height = 3, units = "in")
p
dev.off()
```

...
aim1_vars <- c(
  ...
  "cv_ft_above_uln", "cv_tt", "cv_tt_perc", "cv_tt_above_uln", "cv_dheas",
  "cv_dheas_perc", "cv_dheas_above_uln", "cv_androstendione",
  "cv_androstendione_perc", "cv_androstendione_above_uln", "cv_lh", "cv_fsh",
  "lh_fsh_ratio", "lh_fsh_ratio_above_2", "lh_fsh_ratio_under_1",
  "cv_amh", "cv_amh_above_uln", "cv_a1c", "cv_a1c_cat", "cv_tg", "cv_tg_cat",
  "cv_hdl", "cv_hdl_under_45", "cv_shbg", "cv_shbg_under_20", "cv_alt",
  "cv_alt_above_35", "cv_fbg", "cv_fbg_cat", "cv_fastinsulin",
  "cv_2hrglucoseogtt", "cv_2hrglucoseogtt_cat", "cv_acanthosisneck", "cv_waist",
  "cv_osa_sx", "cv_medications___1", "cv_medications___2", "cv_medications___3",
